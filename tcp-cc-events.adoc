...
[.lead]
tcp.cc events are reported when the system is configured to use the TCP NewReno congestion control algorithm, and corrective actions typically involve following the documented corrective action guidance.
