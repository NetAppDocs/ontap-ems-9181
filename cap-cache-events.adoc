...
[.lead]
cap.cache events are reported when a corrupt Central Access Policy (CAP) is encountered during access checks, and corrective actions typically involve following the documented corrective action guidance.
