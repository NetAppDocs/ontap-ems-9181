...
[.lead]
monitor.brokendisk events are reported when a node is in a degraded state because of a broken disk, and corrective actions typically involve following the documented corrective action guidance.
