...
[.lead]
nvme.card events are reported when the NVMe caching module has gone into a degraded state due to a warning reported by the drive, and corrective actions typically involve following the documented corrective action guidance.
