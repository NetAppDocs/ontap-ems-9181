...
[.lead]
api.output events are reported when an invalid character was detected while checking the output for a Data ONTAP(R) API, and corrective actions typically involve following the documented corrective action guidance.
