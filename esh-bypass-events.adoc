...
[.lead]
esh.bypass events are reported when there is a disk bypass event, and corrective actions typically involve following the documented corrective action guidance.
