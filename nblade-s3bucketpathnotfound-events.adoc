...
[.lead]
nblade.s3bucketpathnotfound events are reported when the path of the NAS directory corresponding to an S3 NAS Bucket was not found, and corrective actions typically involve checking the reported configuration and connectivity.
