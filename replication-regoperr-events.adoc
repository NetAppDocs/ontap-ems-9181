...
[.lead]
replication.regoperr events are reported when the system encounters an error during a registry operation related to SnapMirror(R) or SnapVault(R), and corrective actions typically involve following the documented corrective action guidance.
