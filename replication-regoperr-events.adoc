...
[.lead]
Learn about replication.regoperr EMS events, which report when the system encounters an error during a registry operation related to SnapMirror(R) or SnapVault(R).
