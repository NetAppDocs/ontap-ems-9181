...
[.lead]
cluster.port events are reported when the cluster ports are operating at an unsupported speed, and corrective actions typically involve ensuring the required configuration and resources are in place.
