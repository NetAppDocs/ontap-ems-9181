...
[.lead]
raid.mcc events are reported when this message reports the summary information for the MetroCluster(tm) switchover operation, and corrective actions typically involve following the documented corrective action guidance.
