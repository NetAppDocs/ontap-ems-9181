...
[.lead]
Learn about nblade.vscannopolicyenabled EMS events, which report when a file access is not considered for virus scanning because none of the configured On-Access policies are enabled for the Vserver.
