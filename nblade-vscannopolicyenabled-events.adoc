...
[.lead]
nblade.vscannopolicyenabled events are reported when a file access is not considered for virus scanning because none of the configured On-Access policies are enabled for the Vserver, and corrective actions typically involve following the documented corrective action guidance.
