...
[.lead]
coredump.save events are reported when the savecore operation is aborted while saving a kernel core, and corrective actions typically involve following the documented corrective action guidance.
