...
[.lead]
clus.reboot events are reported when the cluster reboot detection feature detects an internal software error due to insufficient system resources, and corrective actions typically involve rebooting the node or cluster component.
