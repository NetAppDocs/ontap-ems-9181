...
[.lead]
mgmtgwd.mixed events are reported when not all nodes are running the same version of ONTAP, and corrective actions typically involve following the documented corrective action guidance.
