...
[.lead]
sis.undo events are reported when this messages occurs when a SIS volume 'undo' operation is aborted due to unexpected conditions, and corrective actions typically involve following the documented corrective action guidance.
