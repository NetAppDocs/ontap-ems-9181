...
[.lead]
storage.cmd events are reported when indicates a user request to balance I/O across initiator ports has been issued, and corrective actions typically involve following the documented corrective action guidance.
