...
[.lead]
config.bridge events are reported when an FC-to-SAS bridge is attached to an unsupported FC adapter port, and corrective actions typically involve following the documented corrective action guidance.
