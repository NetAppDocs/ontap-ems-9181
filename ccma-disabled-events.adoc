...
[.lead]
ccma.disabled events are reported when the Performance Archive has been disabled for more than an hour, and corrective actions typically involve following the documented corrective action guidance.
