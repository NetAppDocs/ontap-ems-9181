...
[.lead]
aps.rebal events are reported when the performance rebalancing service detects that a node is at risk in an advisory mode, and corrective actions typically involve following the documented corrective action guidance.
