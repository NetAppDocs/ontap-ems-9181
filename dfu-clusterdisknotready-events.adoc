...
[.lead]
Learn about dfu.clusterdisknotready EMS events, which report when the controller failover partner reports that a disk selected for download is in the NOT READY state.
