...
[.lead]
dfu.clusterdisknotready events are reported when the controller failover partner reports that a disk selected for download is in the NOT READY state, and corrective actions typically involve following the documented corrective action guidance.
