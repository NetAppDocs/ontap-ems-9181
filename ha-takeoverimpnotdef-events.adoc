...
[.lead]
ha.takeoverimpnotdef events are reported when the partner node is down and it is currently impossible to perform a takeover, and corrective actions typically involve checking the reported configuration and connectivity.
