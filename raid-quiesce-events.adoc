...
[.lead]
Learn about raid.quiesce EMS events, which report when This message occurs during the ownership change of a disk to indicate the time taken by RAID to quiesce disk active I/O's.
