...
[.lead]
sis.c2c events are reported when this event is issued when dense scanner could not start on c2c restore volume during restore operation, and corrective actions typically involve following the documented corrective action guidance.
