...
[.lead]
Learn about sis.c2c EMS events, which report when This event is issued when dense scanner could not start on c2c restore volume during restore operation.
