...
[.lead]
san.novlanport events are reported when a clustered Data ONTAP(R) system is in a MetroCluster(TM) configuration, and corrective actions typically involve ensuring the required configuration and resources are in place.
