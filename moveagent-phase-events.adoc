...
[.lead]
moveagent.phase events are reported when an active volume move operation cannot access the volume move phase information, and corrective actions typically involve following the documented corrective action guidance.
