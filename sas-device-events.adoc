...
[.lead]
sas.device events are reported when a disk's vmdisk header is bad, and corrective actions typically involve following the documented corrective action guidance.
