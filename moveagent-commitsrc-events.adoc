...
[.lead]
moveagent.commitsrc events are reported when an active volume move operation cannot commit the source volume, and corrective actions typically involve following the documented corrective action guidance.
