...
[.lead]
raid.spares events are reported when this event is issued when a media_scrub i/o detects a medium error on a spare disk, and corrective actions typically involve following the documented corrective action guidance.
