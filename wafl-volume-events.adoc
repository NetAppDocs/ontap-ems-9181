...
[.lead]
wafl.volume events are reported when a volume comes online with a corrupted or unavailable character mapping configuration, and corrective actions typically involve following the documented corrective action guidance.
