...
[.lead]
configbr.backupfailed events are reported when the configuration backup cannot be created, and corrective actions typically involve verifying the reported configuration and health state.
