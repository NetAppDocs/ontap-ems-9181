...
[.lead]
disk.releasefailed events are reported when a SCSI release reservation fails, and corrective actions typically involve following the documented corrective action guidance.
