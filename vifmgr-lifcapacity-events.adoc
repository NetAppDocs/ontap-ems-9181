...
[.lead]
Learn about vifmgr.lifcapacity EMS events, which report when the system informs the administrator of the number of Logical Interfaces (LIFs) supported by the node.
