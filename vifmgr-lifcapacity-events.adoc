...
[.lead]
vifmgr.lifcapacity events are reported when the system informs the administrator of the number of Logical Interfaces (LIFs) supported by the node, and corrective actions typically involve following the documented corrective action guidance.
