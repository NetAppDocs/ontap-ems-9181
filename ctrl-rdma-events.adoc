...
[.lead]
ctrl.rdma events are reported when an invalid system ID is found, and corrective actions typically involve following the documented corrective action guidance.
