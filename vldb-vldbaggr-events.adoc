...
[.lead]
vldb.vldbaggr events are reported when an aggregate is identified that does not exist in the Volume Location Database, and corrective actions typically involve following the documented corrective action guidance.
