...
[.lead]
Learn about cdpd.recv EMS events, which report when the CDP (Cisco Discovery Protocol) daemon running on the storage controller receives more unique neighbor advertisements than it can cache.
