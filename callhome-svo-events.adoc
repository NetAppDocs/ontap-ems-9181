...
[.lead]
callhome.svo events are reported when a write to a SnapValidator enabled volume failed to be validated and was rejected by the server, and corrective actions typically involve checking the reported configuration and connectivity.
