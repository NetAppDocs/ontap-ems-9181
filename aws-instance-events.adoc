...
[.lead]
aws.instance events are reported when instance metadata retrieval fails on a hypervisor hosting an Amazon Web Services (AWS) ONTAP instance, and corrective actions typically involve following the documented corrective action guidance.
