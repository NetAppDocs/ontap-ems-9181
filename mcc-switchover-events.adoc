...
[.lead]
Learn about mcc.switchover EMS events, which report when a MetroCluster switchover operation finds a system metadata volume, used by config replication applications, in the nvfailed state.
