...
[.lead]
cpeer.out events are reported when an outgoing cluster peer request authentication fails due to a passphrase mismatch, and corrective actions typically involve following the documented corrective action guidance.
