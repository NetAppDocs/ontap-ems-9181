...
[.lead]
rdb.ha events are reported when the management process goes online as the master under two-node 'cluster HA' failover, and corrective actions typically involve following the documented corrective action guidance.
