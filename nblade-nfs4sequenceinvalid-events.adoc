...
[.lead]
nblade.nfs4sequenceinvalid events are reported when an NFS server detects an unexpected value for an incoming sequence number from a client, and corrective actions typically involve following the documented corrective action guidance.
