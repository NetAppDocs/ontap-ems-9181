...
[.lead]
spm.avs events are reported when the antivirus service stops running due to repeated failures, and corrective actions typically involve following the documented corrective action guidance.
