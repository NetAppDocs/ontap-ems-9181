...
[.lead]
esh.xfer events are reported when an element is unreachable during an I/O request, and corrective actions typically involve checking the reported configuration and connectivity.
