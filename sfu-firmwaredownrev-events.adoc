...
[.lead]
sfu.firmwaredownrev events are reported when disk shelf firmware is downrev and therefore cannot be updated automatically, and corrective actions typically involve following the documented corrective action guidance.
