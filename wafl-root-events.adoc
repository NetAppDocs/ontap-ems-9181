...
[.lead]
wafl.root events are reported when the contents of the root volume are changed to those of a previous point in time, and corrective actions typically involve verifying the reported configuration and health state.
