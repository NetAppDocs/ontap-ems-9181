...
[.lead]
cmd.start events are reported when the Counter Manager daemon (cmd) fails to start, and corrective actions typically involve following the documented corrective action guidance.
