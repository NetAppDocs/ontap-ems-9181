...
[.lead]
raid.vldb events are reported when rAID fails to notify the M-host that the VLDB(volume location database) is online, and corrective actions typically involve following the documented corrective action guidance.
