...
[.lead]
snaplock.invalid events are reported when an invalid autocommit period value is found on a SnapLock(R) volume, and corrective actions typically involve following the documented corrective action guidance.
