...
[.lead]
wafl.encrypted events are reported when a NetApp(R) Aggregate Encryption (NAE) aggregate is created, and corrective actions typically involve following the documented corrective action guidance.
