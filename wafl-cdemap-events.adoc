...
[.lead]
wafl.cdemap events are reported when an inconsistency is discovered in one of the metafile blocks, and corrective actions typically involve following the documented corrective action guidance.
