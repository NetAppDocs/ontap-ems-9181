...
[.lead]
fci.set events are reported when the World-Wide Name (WWN) for this adapter is set to the value in the fci-wwn-"adapter_name" bootarg, and corrective actions typically involve following the documented corrective action guidance.
