...
[.lead]
raid.scrub events are reported when scrub cannot be scheduled as specified by the "raid, and corrective actions typically involve following the documented corrective action guidance.
