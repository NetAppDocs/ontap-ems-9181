...
[.lead]
spm.vldb events are reported when volume Location Database (VLDB) subsystem stops running, and corrective actions typically involve ensuring the required configuration and resources are in place.
