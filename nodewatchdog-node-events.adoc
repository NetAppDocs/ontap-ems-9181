...
[.lead]
nodewatchdog.node events are reported when data ONTAP(R) experiences a prolonged outage of internal services critical to continued data service, and corrective actions typically involve following the documented corrective action guidance.
