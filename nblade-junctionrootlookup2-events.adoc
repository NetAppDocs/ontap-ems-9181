...
[.lead]
Learn about nblade.junctionrootlookup2 EMS events, which report when the system cannot obtain the root file handle of the volume mounted on a junction path.
