...
[.lead]
nblade.junctionrootlookup2 events are reported when the system cannot obtain the root file handle of the volume mounted on a junction path, and corrective actions typically involve checking the reported configuration and connectivity.
