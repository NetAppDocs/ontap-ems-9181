...
[.lead]
api.engine events are reported when this event is posted when the ONTAPI(R) engine is unexpectedly terminated, and corrective actions typically involve rebooting the node or cluster component.
