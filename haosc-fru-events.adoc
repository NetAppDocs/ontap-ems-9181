...
[.lead]
Learn about haosc.fru EMS events, which report when the chassis or controller field-replaceable unit programmable read-only memory (FRU PROM) read/write fails.
