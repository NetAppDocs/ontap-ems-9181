...
[.lead]
haosc.config events are reported when the chassis and controller field-replaceable unit programmable read-only memories (FRU PROMs) have inconsistent data, and corrective actions typically involve following the documented corrective action guidance.
