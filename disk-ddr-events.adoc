...
[.lead]
disk.ddr events are reported when the Dynamic Drive Recognition (DDR) Scanner detects a disk that is not part of its qualification table, and corrective actions typically involve checking the reported configuration and connectivity.
