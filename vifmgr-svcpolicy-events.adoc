...
[.lead]
vifmgr.svcpolicy events are reported when a service is added to a network interface service policy, and corrective actions typically involve following the documented corrective action guidance.
