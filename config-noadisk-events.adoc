...
[.lead]
Learn about config.noadisk EMS events, which report when the local node in an HA configuration is connected to its disk shelves through the shelf B module instead of the shelf A module.
