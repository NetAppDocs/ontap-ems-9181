...
[.lead]
fci.device events are reported when the Fibre Channel port transmits a frame that is rejected, and corrective actions typically involve following the documented corrective action guidance.
