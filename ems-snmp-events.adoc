...
[.lead]
ems.snmp events are reported when sNMP parsing of an input packet fails, and corrective actions typically involve following the documented corrective action guidance.
