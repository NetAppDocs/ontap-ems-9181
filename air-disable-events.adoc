...
[.lead]
air.disable events are reported when any inconsistency is found with the async delete trashbin directory of a volume, and corrective actions typically involve following the documented corrective action guidance.
