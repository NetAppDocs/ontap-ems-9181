...
[.lead]
Learn about sp.dup EMS events, which report when another system has been detected to be using the same IP address as the one configured on the Service Processor (SP).
