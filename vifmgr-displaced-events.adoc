...
[.lead]
Learn about vifmgr.displaced EMS events, which report when the home port of a displaced logical interface (LIF) has been restored to its original home port.
