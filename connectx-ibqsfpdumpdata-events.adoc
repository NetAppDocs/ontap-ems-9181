...
[.lead]
Learn about connectx.ibqsfpdumpdata EMS events, which report when InfiniBand retimer programming fails due to a quad small form-factor pluggable (QSFP) transceiver parse error, and 128 bytes of QSFP data are dumped.
