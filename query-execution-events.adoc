...
[.lead]
query.execution events are reported when the dotsql command-line program processes an SQL query, and corrective actions typically involve following the documented corrective action guidance.
