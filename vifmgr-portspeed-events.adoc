...
[.lead]
vifmgr.portspeed events are reported when a port is connected to a switch utilizing a link speed that is not qualified, and corrective actions typically involve ensuring the required configuration and resources are in place.
