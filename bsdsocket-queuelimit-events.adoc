...
[.lead]
bsdsocket.queuelimit events are reported when the number of connection requests for a socket reaches the maximum number, and corrective actions typically involve following the documented corrective action guidance.
