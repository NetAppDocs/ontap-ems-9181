...
[.lead]
pac.access events are reported when the access is denied or unsuccessful for the specified source host, destination host, and network interface combination, and corrective actions typically involve following the documented corrective action guidance.
