...
[.lead]
Learn about pac.access EMS events, which report when the access is denied or unsuccessful for the specified source host, destination host, and network interface combination.
