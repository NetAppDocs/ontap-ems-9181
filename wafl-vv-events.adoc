...
[.lead]
wafl.vv events are reported when data ONTAP(R) cannot map a volume to serve a client request because of invalid data Set Identifiers, and corrective actions typically involve following the documented corrective action guidance.
