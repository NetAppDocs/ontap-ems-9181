...
[.lead]
callhome.ndo events are reported when the controller replacement operation has been canceled by the administrator, and corrective actions typically involve following the documented corrective action guidance.
