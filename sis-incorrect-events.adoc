...
[.lead]
sis.incorrect events are reported when a Single Instance Storage (SIS) volume repeatedly can not finish SIS operation within user-given 'duration' settings, and corrective actions typically involve following the documented corrective action guidance.
