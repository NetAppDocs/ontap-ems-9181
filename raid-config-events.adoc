...
[.lead]
raid.config events are reported when this message occurs during a mirror check, when the system discovers that all plexes have failed in an aggregate, and corrective actions typically involve following the documented corrective action guidance.
