...
[.lead]
wafl.lmgr events are reported when the appliance file lock state for a volume could not be moved during a file system check operation (wafliron), and corrective actions typically involve following the documented corrective action guidance.
