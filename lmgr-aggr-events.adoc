...
[.lead]
Learn about lmgr.aggr EMS events, which report when locks established through CIFS Continuously Available (CA) shares on an aggregate are dropped after takeover, giveback, or aggregate relocation.
