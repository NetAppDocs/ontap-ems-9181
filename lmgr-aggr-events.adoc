...
[.lead]
lmgr.aggr events are reported when locks established through CIFS Continuously Available (CA) shares on an aggregate are dropped after takeover, giveback, or aggregate relocation, and corrective actions typically involve following the documented corrective action guidance.
