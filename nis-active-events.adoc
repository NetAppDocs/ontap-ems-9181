...
[.lead]
nis.active events are reported when the last system to be upgraded in a cluster removes NIS configurations that were marked as inactive, and corrective actions typically involve following the documented corrective action guidance.
