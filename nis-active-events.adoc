...
[.lead]
Learn about nis.active EMS events, which report when the last system to be upgraded in a cluster removes NIS configurations that were marked as inactive.
