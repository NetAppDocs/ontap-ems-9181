...
[.lead]
Learn about sfu.firmwareuptodate EMS events, which report when a disk shelf firmware update is requested but all shelves are determined to be updated already to the latest version of firmware available on the system.
