...
[.lead]
fpolicy.pspath events are reported when the creation of the FPolicy persistent store active or backlog directories fails, and corrective actions typically involve checking the reported configuration and connectivity.
