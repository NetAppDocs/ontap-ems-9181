...
[.lead]
Learn about acp.invalid EMS events, which report when the Alternate Control Path (ACP) system detects that an Alternate Control Path Processor (ACPP) has invalid VPD (Vital Product Data) info.
