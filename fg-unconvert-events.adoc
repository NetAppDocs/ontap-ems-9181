...
[.lead]
fg.unconvert events are reported when a member of a FlexGroup fails to be converted into an independent FlexVol(R) volume, and corrective actions typically involve contacting NetApp technical support.
