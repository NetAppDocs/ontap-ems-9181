...
[.lead]
snapmirror_copy.updatetimeincreased events are reported when the update time taken by the latest transfer is 5 minutes more than the previous three transfer times, and corrective actions typically involve following the documented corrective action guidance.
