...
[.lead]
Learn about snapmirror_copy.updatetimeincreased EMS events, which report when the update time taken by the latest transfer is 5 minutes more than the previous three transfer times.
