...
[.lead]
vifmgr.dbase events are reported when the logical interface manager (VIFMgr) experiences an error while verifying cluster database consistency, and corrective actions typically involve contacting NetApp technical support.
