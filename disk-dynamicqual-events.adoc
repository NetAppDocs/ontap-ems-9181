...
[.lead]
disk.dynamicqual events are reported when dynamic device qualification fails due to an invalid /etc/qual_devices file, and corrective actions typically involve following the documented corrective action guidance.
