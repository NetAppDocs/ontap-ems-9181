...
[.lead]
sfu.suspendses events are reported when a disk shelf firmware update is requested in a high-availability (HA) environment, and corrective actions typically involve following the documented corrective action guidance.
