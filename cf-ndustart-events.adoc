...
[.lead]
cf.ndustart events are reported when a nondisruptive upgrade starts, and corrective actions typically involve following the documented corrective action guidance.
