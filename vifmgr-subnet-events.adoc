...
[.lead]
vifmgr.subnet events are reported when an address is successfully acquired from a subnet's available-ranges list, and corrective actions typically involve following the documented corrective action guidance.
