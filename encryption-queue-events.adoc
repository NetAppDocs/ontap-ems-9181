...
[.lead]
encryption.queue events are reported when an operation on the volume in the encryption queue failed, and corrective actions typically involve checking the reported configuration and connectivity.
