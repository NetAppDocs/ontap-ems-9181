...
[.lead]
snapmirror.sockstrwriteerr events are reported when this event is issued when SnapMirror tries to write a large string to the socket, and corrective actions typically involve following the documented corrective action guidance.
