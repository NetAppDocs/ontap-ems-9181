...
[.lead]
cf.reservation events are reported when the system does not halt on a disk reservation conflict and the reservation is not found on the disk, and corrective actions typically involve following the documented corrective action guidance.
