...
[.lead]
Learn about cf.reservation EMS events, which report when the system does not halt on a disk reservation conflict and the reservation is not found on the disk.
