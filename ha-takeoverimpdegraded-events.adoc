...
[.lead]
Learn about ha.takeoverimpdegraded EMS events, which report when the partner node is down and it is currently impossible to perform a takeover because the partner mailbox disks are not available.
