...
[.lead]
ccma.perfstatd events are reported when the Perfstat daemon (perfstatd) has been disabled for more than an hour, and corrective actions typically involve following the documented corrective action guidance.
