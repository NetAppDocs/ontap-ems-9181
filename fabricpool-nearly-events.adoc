...
[.lead]
Learn about fabricpool.nearly EMS events, which report when the total, cluster-wide FabricPool space usage of object stores from capacity-licensed providers has nearly reached the license limit.
