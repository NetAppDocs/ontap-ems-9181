...
[.lead]
mgmtgwd.sign events are reported when a digital certificate for a Vserver expires, and corrective actions typically involve following the documented corrective action guidance.
