...
[.lead]
Learn about rdb.internal EMS events, which report when the cluster management Data Replication Module encounters an internal error, possibly causing the process to exit.
