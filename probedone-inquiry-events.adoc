...
[.lead]
probedone.inquiry events are reported when the inquiry data fails the comparison at the domain validation (DV) step, and corrective actions typically involve checking the reported configuration and connectivity.
