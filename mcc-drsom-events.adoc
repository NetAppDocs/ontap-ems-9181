...
[.lead]
mcc.drsom events are reported when it cannot be determined whether a disk belongs to a root aggregate, and corrective actions typically involve following the documented corrective action guidance.
