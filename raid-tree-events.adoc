...
[.lead]
raid.tree events are reported when rAID I/Os are active while removing a disk from the RAID tree, and corrective actions typically involve following the documented corrective action guidance.
