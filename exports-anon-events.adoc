...
[.lead]
Learn about exports.anon EMS events, which report when we cannot get UNIX credentials for a user id when evaluating the "-anon" portion of an export-policy rule.
