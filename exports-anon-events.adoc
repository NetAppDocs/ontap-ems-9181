...
[.lead]
exports.anon events are reported when we cannot get UNIX credentials for a user id when evaluating the "-anon" portion of an export-policy rule, and corrective actions typically involve following the documented corrective action guidance.
