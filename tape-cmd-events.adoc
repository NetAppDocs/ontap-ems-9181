...
[.lead]
tape.cmd events are reported when a Check Condition status from the tape drive reports an informational condition or status to the controller, and corrective actions typically involve following the documented corrective action guidance.
