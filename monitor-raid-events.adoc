...
[.lead]
monitor.raid events are reported when the monitor detects a broken disk, and corrective actions typically involve following the documented corrective action guidance.
