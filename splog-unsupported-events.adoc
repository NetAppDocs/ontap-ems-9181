...
[.lead]
splog.unsupported events are reported when the current firmware of the Service Processor (SP) does not support the log collection function, and corrective actions typically involve checking the reported configuration and connectivity.
