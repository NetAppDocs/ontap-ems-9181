...
[.lead]
Learn about splog.unsupported EMS events, which report when the current firmware of the Service Processor (SP) does not support the log collection function.
