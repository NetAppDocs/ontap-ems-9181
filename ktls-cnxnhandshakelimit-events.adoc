...
[.lead]
ktls.cnxnhandshakelimit events are reported when the concurrent TLS connection handshake limit is reached, and corrective actions typically involve following the documented corrective action guidance.
