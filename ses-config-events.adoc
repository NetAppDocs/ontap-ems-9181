...
[.lead]
ses.config events are reported when a stack of shelves contains more disk bays than the maximum number that are allowed, and corrective actions typically involve following the documented corrective action guidance.
