...
[.lead]
arl.abort events are reported when a relocation of an aggregate is canceled due to activity in RAID, and corrective actions typically involve following the documented corrective action guidance.
