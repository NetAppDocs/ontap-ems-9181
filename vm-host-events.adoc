...
[.lead]
vm.host events are reported when a VM is paused by the hypervisor, and corrective actions typically involve checking the reported configuration and connectivity.
