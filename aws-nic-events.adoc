...
[.lead]
aws.nic events are reported when data ONTAP(R) is running in Amazon Web Services (AWS) and a network interface stops processing packets at the beginning of system boot, and corrective actions typically involve following the documented corrective action guidance.
