...
[.lead]
Learn about aws.nic EMS events, which report when Data ONTAP(R) is running in Amazon Web Services (AWS) and a network interface stops processing packets at the beginning of system boot.
