...
[.lead]
raid.labeledit events are reported when you run the 'label buildtree' command to create an aggregate from a collection of disks, and corrective actions typically involve following the documented corrective action guidance.
