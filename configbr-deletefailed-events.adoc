...
[.lead]
configbr.deletefailed events are reported when an old configuration backup cannot be deleted, and corrective actions typically involve ensuring the required configuration and resources are in place.
