...
[.lead]
Learn about fmmb.mmr EMS events, which report when This event is issued when the outbound FM payload area is found to be corrupted and the master mailbox record is missing.
