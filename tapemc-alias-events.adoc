...
[.lead]
tapemc.alias events are reported when the automatic addition of a tape or medium changer alias fails, and corrective actions typically involve checking the reported configuration and connectivity.
