...
[.lead]
http.cfg events are reported when the maximum number of Cross-Site Request Forgery (CSRF) tokens has been reached, and corrective actions typically involve following the documented corrective action guidance.
