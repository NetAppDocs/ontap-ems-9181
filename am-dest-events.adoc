...
[.lead]
Learn about am.dest EMS events, which report when Relocation of aggregates fails at the destination as we no longer accept aggregates from versions 8.2.0 or lower.
