...
[.lead]
am.dest events are reported when relocation of aggregates fails at the destination as we no longer accept aggregates from versions 8, and corrective actions typically involve following the documented corrective action guidance.
