...
[.lead]
scsiblade.lif events are reported when the SAN LIF fails to be configured during Vserver initialization, and corrective actions typically involve following the documented corrective action guidance.
