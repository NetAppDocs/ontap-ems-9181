...
[.lead]
osc.tcp events are reported when oNTAP is unable to connect to the IP address that the object store server hostname resolves to, and corrective actions typically involve checking the reported configuration and connectivity.
