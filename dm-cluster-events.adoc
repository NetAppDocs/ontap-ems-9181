...
[.lead]
dm.cluster events are reported when resynchronization of the cluster configuration failed in a MetroCluster(tm) configuration, and corrective actions typically involve following the documented corrective action guidance.
