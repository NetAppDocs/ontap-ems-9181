...
[.lead]
sas.unsupported events are reported when oNTAP detects that a cable is attached to an I/O module port that is permanently disabled and does not support attachment, and corrective actions typically involve following the documented corrective action guidance.
