...
[.lead]
Learn about sas.unsupported EMS events, which report when ONTAP detects that a cable is attached to an I/O module port that is permanently disabled and does not support attachment.
