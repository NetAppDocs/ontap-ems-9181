...
[.lead]
Learn about vifmgr.vs EMS events, which report when Logical Interface Manager (VIFMgr) is unable to retrieve the list of Vservers from the management gateway Vserver cache in the allotted time.
