...
[.lead]
vifmgr.vs events are reported when logical Interface Manager (VIFMgr) is unable to retrieve the list of Vservers from the management gateway Vserver cache in the allotted time, and corrective actions typically involve following the documented corrective action guidance.
