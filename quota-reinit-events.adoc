...
[.lead]
quota.reinit events are reported when an unplanned MetroCluster(tm) switchover happens, and corrective actions typically involve following the documented corrective action guidance.
