...
[.lead]
wafl.c2c events are reported when attempt to increase volume max size limit during c2c restore fails due to an error, and corrective actions typically involve following the documented corrective action guidance.
