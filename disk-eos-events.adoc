...
[.lead]
disk.eos events are reported when a disk is detected that is not supported in this version of Data ONTAP(R) or later, and corrective actions typically involve following the documented corrective action guidance.
