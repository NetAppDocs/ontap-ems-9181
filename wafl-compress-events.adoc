...
[.lead]
wafl.compress events are reported when compression is automatically disabled on a space guarantee volume because it is not supported on this platform, and corrective actions typically involve following the documented corrective action guidance.
