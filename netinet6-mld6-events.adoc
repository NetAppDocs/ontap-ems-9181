...
[.lead]
netinet6.mld6 events are reported when the system discovers an illegal Internet Control Message Protocol (ICMP) type field in a multicast listener discovery structure, and corrective actions typically involve following the documented corrective action guidance.
