...
[.lead]
mgmt.vopl events are reported when the system encounters an error trying to clean up after a failed 'volume move' operation, and corrective actions typically involve contacting NetApp technical support.
