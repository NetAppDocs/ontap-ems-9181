...
[.lead]
wafl.cp events are reported when a WAFL(R) consistency point (CP) takes longer than 30 seconds, and corrective actions typically involve following the documented corrective action guidance.
