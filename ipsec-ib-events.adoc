...
[.lead]
ipsec.ib events are reported when an inbound IPsec packet cannot be successfully decrypted, and corrective actions typically involve following the documented corrective action guidance.
