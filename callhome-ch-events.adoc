...
[.lead]
callhome.ch events are reported when a degraded chassis power supply unit (PSU) state exists, and corrective actions typically involve following the documented corrective action guidance.
