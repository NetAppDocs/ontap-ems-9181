...
[.lead]
bcomd.fcnvmelifremoved events are reported when an FC NVMe (Nonvolatile Memory Express) logical interface (LIF) is removed, and corrective actions typically involve following the documented corrective action guidance.
