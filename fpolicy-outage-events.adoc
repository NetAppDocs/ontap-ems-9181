...
[.lead]
fpolicy.outage events are reported when file creation fails under the configured resiliency directory path, and corrective actions typically involve checking the reported configuration and connectivity.
