...
[.lead]
Learn about sms.transition EMS events, which report when a SnapMirror(R) initialize or resynchronize operation takes a long time to bring the relationship "in-sync" due to intermittent failure.
