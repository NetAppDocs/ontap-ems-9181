...
[.lead]
dcn.service events are reported when a service has failed on the Data Compute Node (DCN), and corrective actions typically involve following the documented corrective action guidance.
