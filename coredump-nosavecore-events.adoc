...
[.lead]
coredump.nosavecore events are reported when the process that saves a coredump is not able to flush to the boot device at the end of coredump, and corrective actions typically involve following the documented corrective action guidance.
