...
[.lead]
ic.linkspeeddegraded events are reported when the high-availability (HA) interconnect detects a degraded link speed, and corrective actions typically involve following the documented corrective action guidance.
