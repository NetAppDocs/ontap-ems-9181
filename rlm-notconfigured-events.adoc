...
[.lead]
rlm.notconfigured events are reported when this message occurs weekly to remind you to configure the Remote LAN Module (RLM), and corrective actions typically involve following the documented corrective action guidance.
