...
[.lead]
snmp.fips events are reported when the system fails to delete SNMP traphosts and users that are not FIPS compliant, and corrective actions typically involve following the documented corrective action guidance.
