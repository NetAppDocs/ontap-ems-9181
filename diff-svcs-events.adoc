...
[.lead]
Learn about diff.svcs EMS events, which report when the system cannot automatically apply the Differentiated Services (diff-svcs) setting to the High Availability (HA) partner.
