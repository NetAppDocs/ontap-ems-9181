...
[.lead]
cmd.shelfchk events are reported when this event is generated while verifying disk shelf cabling and configuration, and corrective actions typically involve following the documented corrective action guidance.
