...
[.lead]
san.changedhomenode events are reported when the home node of an existing SAN LIF is modified during LIF placement, and corrective actions typically involve following the documented corrective action guidance.
