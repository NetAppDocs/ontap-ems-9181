...
[.lead]
dfu.fwdownloadfailedstatus events are reported when a firmware download failure occurs, and corrective actions typically involve following the documented corrective action guidance.
