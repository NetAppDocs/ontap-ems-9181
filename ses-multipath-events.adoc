...
[.lead]
ses.multipath events are reported when the AT-FCX disk shelf module does not support the multipath high-availability (Multipath HA) configuration, and corrective actions typically involve following the documented corrective action guidance.
