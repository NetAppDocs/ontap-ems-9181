...
[.lead]
ha.panicinforcvbadvrsn events are reported when the version of the panic information received from the high-availability (HA) partner is not equal to the expected version, and corrective actions typically involve following the documented corrective action guidance.
