...
[.lead]
Learn about fabricpool.tiering EMS events, which report when ONTAP has stopped tiering data to the cloud tier because it has lost contact with the Service Control Unit used for one or more cloud subscription licenses.
