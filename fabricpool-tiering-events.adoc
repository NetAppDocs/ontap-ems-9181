...
[.lead]
fabricpool.tiering events are reported when oNTAP has stopped tiering data to the cloud tier because it has lost contact with the Service Control Unit used for one or more cloud subscription licenses, and corrective actions typically involve ensuring the required configuration and resources are in place.
