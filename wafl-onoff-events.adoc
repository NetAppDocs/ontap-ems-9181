...
[.lead]
wafl.onoff events are reported when wAFL(R) attempts to bring online or take offline a mirror volume that does not have a valid mirror-type attribute, and corrective actions typically involve following the documented corrective action guidance.
