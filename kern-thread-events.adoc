...
[.lead]
kern.thread events are reported when a thread creation has the system close to the maximum limit for the number of threads, and corrective actions typically involve following the documented corrective action guidance.
