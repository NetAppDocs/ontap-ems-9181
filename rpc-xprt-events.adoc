...
[.lead]
rpc.xprt events are reported when the number of active connections to a side band Remote Procedure Call (RPC) reaches the limit, and corrective actions typically involve following the documented corrective action guidance.
