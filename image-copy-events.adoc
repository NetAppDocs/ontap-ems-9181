...
[.lead]
image.copy events are reported when oNTAP software installation was performed via the boot menu, which does not verify the digital signature of the software image, and corrective actions typically involve following the documented corrective action guidance.
