...
[.lead]
Learn about image.copy EMS events, which report when ONTAP software installation was performed via the boot menu, which does not verify the digital signature of the software image.
