...
[.lead]
wafl.svo events are reported when this event is generated if a write to a svo enabled volume fails to pass a check, and corrective actions typically involve following the documented corrective action guidance.
