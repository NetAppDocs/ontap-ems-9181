...
[.lead]
callhome.ext events are reported when a check of the external memory cache used for increasing system performance has failed and this cache has been disabled, and corrective actions typically involve following the documented corrective action guidance.
