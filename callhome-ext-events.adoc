...
[.lead]
Learn about callhome.ext EMS events, which report when a check of the external memory cache used for increasing system performance has failed and this cache has been disabled.
