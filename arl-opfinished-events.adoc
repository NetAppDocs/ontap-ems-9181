...
[.lead]
arl.opfinished events are reported when the aggregate relocation operation from the source node to the specified destination is finished, and corrective actions typically involve following the documented corrective action guidance.
