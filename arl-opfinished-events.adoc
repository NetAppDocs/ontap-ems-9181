...
[.lead]
Learn about arl.opfinished EMS events, which report when the aggregate relocation operation from the source node to the specified destination is finished.
