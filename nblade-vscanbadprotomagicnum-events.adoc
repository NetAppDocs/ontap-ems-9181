...
[.lead]
nblade.vscanbadprotomagicnum events are reported when an incorrectly formatted message is received from the AV Connector, and corrective actions typically involve ensuring the required configuration and resources are in place.
