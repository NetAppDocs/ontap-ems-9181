...
[.lead]
monitor.ioxmtemp events are reported when the I/O module is above the recommended operating temperature, and corrective actions typically involve following the documented corrective action guidance.
