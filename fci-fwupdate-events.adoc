...
[.lead]
fci.fwupdate events are reported when the Service Level Initiator Fibre Channel (SLIFC) Initiator driver successfully updates the firmware of the host bus adapter (HBA), and no corrective action is typically required.
