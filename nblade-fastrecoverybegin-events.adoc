...
[.lead]
Learn about nblade.fastrecoverybegin EMS events, which report when the NFSv4.x server enters the fast recovery mode as part of the LIF migration event, during which the NFS server will not be able to serve any data for NFSv4.x clients.
