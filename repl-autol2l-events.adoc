...
[.lead]
Learn about repl.autol2l EMS events, which report when the replication destination engine encounters an unsupported configuration during a transfer with storage efficiency.
