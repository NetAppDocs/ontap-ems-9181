...
[.lead]
repl.autol2l events are reported when the replication destination engine encounters an unsupported configuration during a transfer with storage efficiency, and corrective actions typically involve following the documented corrective action guidance.
