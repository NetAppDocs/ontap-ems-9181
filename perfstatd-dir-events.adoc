...
[.lead]
Learn about perfstatd.dir EMS events, which report when the perfstat daemon (perfstatd) startup fails due to improper permissions for the '/mroot/etc/log' directory.
