...
[.lead]
wafl.aggregate events are reported when an operation is run on an aggregate while the aggregate or any volume of the aggregate is busy, and corrective actions typically involve following the documented corrective action guidance.
