...
[.lead]
pac.if events are reported when the protocol access control fails to get the interface name with the address, and corrective actions typically involve following the documented corrective action guidance.
