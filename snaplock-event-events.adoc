...
[.lead]
snaplock.event events are reported when this message occurs on completion of a event based retention apply operation on a SnapLock(R) volume, and corrective actions typically involve following the documented corrective action guidance.
