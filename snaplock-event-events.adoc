...
[.lead]
Learn about snaplock.event EMS events, which report when This message occurs on completion of a event based retention apply operation on a SnapLock(R) volume.
