...
[.lead]
Learn about diskown.statusreadownership EMS events, which report when an event is logged to track that an error was encountered while reading all data ownership blocks at once.
