...
[.lead]
diskown.statusreadownership events are reported when an event is logged to track that an error was encountered while reading all data ownership blocks at once, and corrective actions typically involve following the documented corrective action guidance.
