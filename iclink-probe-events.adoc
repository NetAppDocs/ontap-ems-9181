...
[.lead]
Learn about iclink.probe EMS events, which report when the system cannot detect a High Availability (HA) interconnect card, making HA communication inoperable.
