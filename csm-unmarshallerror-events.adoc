...
[.lead]
csm.unmarshallerror events are reported when the message occurs when the Cluster Session Manager (CSM) fails to unmarshal a packet, and corrective actions typically involve following the documented corrective action guidance.
