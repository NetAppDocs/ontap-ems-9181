...
[.lead]
security.cluster events are reported when a digital certificate associated with a node for cluster-network security is already expired, and corrective actions typically involve following the documented corrective action guidance.
