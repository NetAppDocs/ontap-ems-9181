...
[.lead]
callhome.rtc events are reported when the voltage for the Real-Time Clock (RTC) battery is low, and corrective actions typically involve following the documented corrective action guidance.
