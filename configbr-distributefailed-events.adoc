...
[.lead]
configbr.distributefailed events are reported when a configuration backup cannot be distributed to another node in the cluster, and corrective actions typically involve ensuring the required configuration and resources are in place.
