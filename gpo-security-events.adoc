...
[.lead]
gpo.security events are reported when the GptTmpl, and corrective actions typically involve ensuring the required configuration and resources are in place.
