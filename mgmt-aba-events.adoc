...
[.lead]
mgmt.aba events are reported when auto Balance Aggregate initiates a move of a volume that was then changed to a FlexClone(R) parent, and corrective actions typically involve following the documented corrective action guidance.
