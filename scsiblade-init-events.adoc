...
[.lead]
scsiblade.init events are reported when the specified Vserver initialization was skipped due to a user-initiated abort, and corrective actions typically involve following the documented corrective action guidance.
