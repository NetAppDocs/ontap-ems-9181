...
[.lead]
asa.personality events are reported when the cluster personality has been changed to an All SAN Array, and corrective actions typically involve following the documented corrective action guidance.
