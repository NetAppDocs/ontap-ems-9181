...
[.lead]
spm.named events are reported when the Domain Name Service (DNS) name resolution daemon 'named' involuntarily exits, and corrective actions typically involve following the documented corrective action guidance.
