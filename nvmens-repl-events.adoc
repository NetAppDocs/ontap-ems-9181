...
[.lead]
Learn about nvmens.repl EMS events, which report when replication of a volume containing NVMe namespaces has failed because the destination does not support NVMe namespaces.
