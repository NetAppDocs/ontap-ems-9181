...
[.lead]
Learn about replication.givebackcancel EMS events, which report when a 'giveback' command is issued while a SnapMirror(R) or SnapVault(R) transfer is in progress.
