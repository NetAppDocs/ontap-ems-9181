...
[.lead]
sm.log events are reported when writing SnapMirror(R) data to a log file fails, and corrective actions typically involve following the documented corrective action guidance.
