...
[.lead]
vsdr.periodic events are reported when the Vserver DR subsystem periodic check detects issues with the Vserver DR components, and corrective actions typically involve contacting NetApp technical support.
