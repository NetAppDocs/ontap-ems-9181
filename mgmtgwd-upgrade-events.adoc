...
[.lead]
mgmtgwd.upgrade events are reported when an upgrade task is aborted, and corrective actions typically involve following the documented corrective action guidance.
