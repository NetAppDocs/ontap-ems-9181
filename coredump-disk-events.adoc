...
[.lead]
coredump.disk events are reported when a kernel core is written to disk, and corrective actions typically involve following the documented corrective action guidance.
