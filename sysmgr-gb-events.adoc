...
[.lead]
Learn about sysmgr.gb EMS events, which report when acquiring the desired Effective Cluster Version (ECV) of System Manager was not accomplished within the time limit during the first storage giveback phase.
