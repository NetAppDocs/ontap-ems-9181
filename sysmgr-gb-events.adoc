...
[.lead]
sysmgr.gb events are reported when acquiring the desired Effective Cluster Version (ECV) of System Manager was not accomplished within the time limit during the first storage giveback phase, and corrective actions typically involve following the documented corrective action guidance.
