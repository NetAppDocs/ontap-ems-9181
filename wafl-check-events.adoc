...
[.lead]
wafl.check events are reported when generic wafl check message, and corrective actions typically involve following the documented corrective action guidance.
