...
[.lead]
callhome.ondemand events are reported when this message normally occurs when NetApp technical support has remotely requested an AutoSupport or 'call home' message of type TEST, and corrective actions typically involve following the documented corrective action guidance.
