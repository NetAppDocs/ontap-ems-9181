...
[.lead]
snmp.snmpv3 events are reported when sNMPv3 is disabled due to a cluster in FIPS mode being upgraded to a version of ONTAP(R) software supporting the SNMPv3 FIPS feature, and corrective actions typically involve following the documented corrective action guidance.
