...
[.lead]
mlm.array events are reported when the system detects an array LUN from an unsupported array, and corrective actions typically involve following the documented corrective action guidance.
