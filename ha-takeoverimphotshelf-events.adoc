...
[.lead]
ha.takeoverimphotshelf events are reported when the partner node is down and it is currently impossible to perform a takeover due to disk shelves that are overheating, and corrective actions typically involve checking the reported configuration and connectivity.
