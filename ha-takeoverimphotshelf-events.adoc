...
[.lead]
Learn about ha.takeoverimphotshelf EMS events, which report when the partner node is down and it is currently impossible to perform a takeover due to disk shelves that are overheating.
