...
[.lead]
vifmgr.bgp events are reported when logical Interface Manager (VifMgr) connects to BGP daemon, and corrective actions typically involve following the documented corrective action guidance.
