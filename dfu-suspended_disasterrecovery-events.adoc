...
[.lead]
Learn about dfu.suspended_disasterrecovery EMS events, which report when This message occurs in a MetroCluster(TM) environment when firmware download to remote disks is suspended during disaster recovery.
