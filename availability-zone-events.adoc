...
[.lead]
availability.zone events are reported when the storage availability zone space usage has exceeded the full threshold value, and corrective actions typically involve following the documented corrective action guidance.
