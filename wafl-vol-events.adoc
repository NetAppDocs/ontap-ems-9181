...
[.lead]
wafl.vol events are reported when the system rejects client access to a volume, and corrective actions typically involve following the documented corrective action guidance.
