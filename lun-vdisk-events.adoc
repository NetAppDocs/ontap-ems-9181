...
[.lead]
lun.vdisk events are reported when a volume contains more than the supported limit of LUNs in the volume, and corrective actions typically involve following the documented corrective action guidance.
