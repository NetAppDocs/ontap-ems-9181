...
[.lead]
ctran.jpc events are reported when a Join Proposal Coordinator (JPC) node is assigned by Kernel Cluster Services (KCS) Cluster Transaction Manager (CTRAN), and corrective actions typically involve following the documented corrective action guidance.
