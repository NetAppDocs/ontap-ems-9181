...
[.lead]
s3.bucket events are reported when the access key is invalid and it has been used to access the S3 bucket/object, and corrective actions typically involve verifying the reported configuration and health state.
