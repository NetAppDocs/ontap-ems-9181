...
[.lead]
vol.duplicate events are reported when a duplicate master set ID (MSID) has been detected, and corrective actions typically involve contacting NetApp technical support.
