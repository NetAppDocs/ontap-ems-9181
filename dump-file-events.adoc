...
[.lead]
dump.file events are reported when the dump engine encounters an NFS security label during any type of dump operation, and corrective actions typically involve following the documented corrective action guidance.
