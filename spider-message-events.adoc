...
[.lead]
spider.message events are reported when a directory traversal task cannot finish because of an unexpected error, and corrective actions typically involve ensuring the required configuration and resources are in place.
