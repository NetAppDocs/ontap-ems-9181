...
[.lead]
sfo.ignoretakeover events are reported when the environment indicating that mailbox takeover state should be rewritten could not be removed, and corrective actions typically involve following the documented corrective action guidance.
