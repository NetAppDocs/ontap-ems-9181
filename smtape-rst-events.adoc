...
[.lead]
smtape.rst events are reported when an SMTape restore operation from tape is aborted due to checksum error, and corrective actions typically involve following the documented corrective action guidance.
