...
[.lead]
volume.transition events are reported when a volume transition plug-in is taking longer than expected, and corrective actions typically involve following the documented corrective action guidance.
