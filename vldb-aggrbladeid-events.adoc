...
[.lead]
vldb.aggrbladeid events are reported when the system discovers an inconsistency in the volume location database (VLDB), and corrective actions typically involve following the documented corrective action guidance.
