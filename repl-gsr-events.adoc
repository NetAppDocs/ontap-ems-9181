...
[.lead]
repl.gsr events are reported when snapMirror faces internal error while going Out-Of-Sync or source volume comes online, and corrective actions typically involve following the documented corrective action guidance.
