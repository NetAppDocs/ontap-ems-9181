...
[.lead]
mcc.fabricpool events are reported when a FabricPool license exists on only one of the two sites of a MetroCluster(tm) configuration, and corrective actions typically involve following the documented corrective action guidance.
