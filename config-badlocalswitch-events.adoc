...
[.lead]
Learn about config.badlocalswitch EMS events, which report when a disk is found to be attached to a switch, but there are also disks attached via local connections.
