...
[.lead]
pvif.lacp events are reported when a link is operationally up and cannot be aggregated into its configured ifgrp within the time limit, and corrective actions typically involve verifying the reported configuration and health state.
