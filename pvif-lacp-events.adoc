...
[.lead]
Learn about pvif.lacp EMS events, which report when a link is operationally up and cannot be aggregated into its configured ifgrp within the time limit.
