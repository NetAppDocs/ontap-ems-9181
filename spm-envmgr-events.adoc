...
[.lead]
spm.envmgr events are reported when the environmental monitoring daemon (env_mgr) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
