...
[.lead]
raid.cksum events are reported when this event is issued when WAFL accesses a block that was zeroed because it could not be recovered correctly, and corrective actions typically involve following the documented corrective action guidance.
