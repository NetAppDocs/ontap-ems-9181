...
[.lead]
Learn about fmmb.newdisksuggestion EMS events, which report when RAID sends to the high-availability (HA) mailbox code a list of disks to use for HA mailbox disks.
