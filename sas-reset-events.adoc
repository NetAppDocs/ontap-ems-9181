...
[.lead]
sas.reset events are reported when sAS adapter driver resets the expander because of failure status of discovery response, and corrective actions typically involve following the documented corrective action guidance.
