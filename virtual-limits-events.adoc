...
[.lead]
virtual.limits events are reported when the process virtual memory limit calculations are disabled on a given node, and corrective actions typically involve following the documented corrective action guidance.
