...
[.lead]
Learn about netif.toomanynics EMS events, which report when a network interface was not initialized because the number of interfaces of this type exceeds the maximum supported.
