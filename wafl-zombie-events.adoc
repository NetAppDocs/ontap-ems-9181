...
[.lead]
wafl.zombie events are reported when the aggregate encounters the zombie throttling limits during zombie delete processing for large number of file deletions, and corrective actions typically involve following the documented corrective action guidance.
