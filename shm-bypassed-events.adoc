...
[.lead]
shm.bypassed events are reported when the system recommends that a disk be failed because it has been bypassed, and corrective actions typically involve following the documented corrective action guidance.
