...
[.lead]
repl.extended events are reported when the replication engine encounters a destination that does not support extended time format, and corrective actions typically involve following the documented corrective action guidance.
