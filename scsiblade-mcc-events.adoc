...
[.lead]
scsiblade.mcc events are reported when the Vserver load during MCC switchover/switchback consumes majority of the 120 second MAX timeout, and corrective actions typically involve following the documented corrective action guidance.
