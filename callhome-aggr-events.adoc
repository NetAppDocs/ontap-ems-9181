...
[.lead]
callhome.aggr events are reported when this message occurs after WAFL(R) Iron (wafliron) detects and repairs corruption in an aggregate metafile, and corrective actions typically involve following the documented corrective action guidance.
