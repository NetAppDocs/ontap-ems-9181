...
[.lead]
scsi.sim events are reported when a Check Condition is the mechanism whereby a target device reports an informational condition or error status to the requesting host, and corrective actions typically involve following the documented corrective action guidance.
