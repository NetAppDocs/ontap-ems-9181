...
[.lead]
mw.hir events are reported when extent reference has reached a pre-determined threshold value, and corrective actions typically involve following the documented corrective action guidance.
