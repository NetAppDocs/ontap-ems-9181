...
[.lead]
netif.ratelimitthreshold events are reported when the protocol rate threshold is reached on a network interface, and corrective actions typically involve following the documented corrective action guidance.
