...
[.lead]
Learn about connectx.ibretimerskipprogrm EMS events, which report when InfiniBand retimer programming is skipped after the system detects that a cable is plugged in, because there was no change in the cable's type and length.
