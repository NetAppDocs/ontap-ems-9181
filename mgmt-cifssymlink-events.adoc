...
[.lead]
mgmt.cifssymlink events are reported when configuration of a CIFS symbolic link fails; the symbolic link might not be available through CIFS, and corrective actions typically involve checking the reported configuration and connectivity.
