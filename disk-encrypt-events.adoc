...
[.lead]
disk.encrypt events are reported when the disk encrypt destroy operation is completed, and corrective actions typically involve following the documented corrective action guidance.
