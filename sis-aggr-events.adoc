...
[.lead]
sis.aggr events are reported when undo of cross volume savings on aggregate has to abort due to some error conditions, and corrective actions typically involve following the documented corrective action guidance.
