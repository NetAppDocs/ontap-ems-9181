...
[.lead]
Learn about acp.sock EMS events, which report when the system encounters a socket error while setting up the Alternate Control Path (ACP) Management Ethernet port.
