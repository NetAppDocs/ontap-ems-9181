...
[.lead]
rsh.rcmd events are reported when there is an error in binding a reserved port, and corrective actions typically involve following the documented corrective action guidance.
