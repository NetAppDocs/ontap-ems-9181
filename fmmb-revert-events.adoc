...
[.lead]
Learn about fmmb.revert EMS events, which report when This event is issued when the HA Mailbox opaque recieves a write request for the opaque area and a revert_to command is in progress.
