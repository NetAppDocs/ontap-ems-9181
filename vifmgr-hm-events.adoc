...
[.lead]
vifmgr.hm events are reported when a health monitor has been fully activated for an IPspace, and corrective actions typically involve following the documented corrective action guidance.
