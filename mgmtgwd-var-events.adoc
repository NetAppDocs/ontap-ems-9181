...
[.lead]
mgmtgwd.var events are reported when the system detects a missing or corrupted /var root directory, and corrective actions typically involve contacting NetApp technical support.
