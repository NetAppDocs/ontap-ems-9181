...
[.lead]
netif.phyoperationfailed events are reported when there is a failure in reading or writing the physical layer (PHY) of a network interface, and corrective actions typically involve following the documented corrective action guidance.
