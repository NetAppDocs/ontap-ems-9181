...
[.lead]
Learn about netif.phyoperationfailed EMS events, which report when there is a failure in reading or writing the physical layer (PHY) of a network interface.
