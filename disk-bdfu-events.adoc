...
[.lead]
disk.bdfu events are reported when the background drive firmware update process fails to unlock SAS NetApp(R) Storage Encryption (NSE) drives in FIPS-compliance mode, and corrective actions typically involve contacting NetApp technical support.
