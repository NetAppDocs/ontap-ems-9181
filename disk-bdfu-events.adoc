...
[.lead]
Learn about disk.bdfu EMS events, which report when the background drive firmware update process fails to unlock SAS NetApp(R) Storage Encryption (NSE) drives in FIPS-compliance mode.
