...
[.lead]
rdb.recovery events are reported when the cluster management Data Replication Module could not automatically repair its local replicas, and corrective actions typically involve following the documented corrective action guidance.
