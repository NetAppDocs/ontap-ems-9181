...
[.lead]
snmp.server events are reported when the SNMP daemon is busy serving a high rate of incoming SNMP queries, and corrective actions typically involve following the documented corrective action guidance.
