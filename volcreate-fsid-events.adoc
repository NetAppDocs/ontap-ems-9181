...
[.lead]
Learn about volcreate.fsid EMS events, which report when Flexible volumes were created with file system identifiers (FSIDs) which conflict with existing volumes.
