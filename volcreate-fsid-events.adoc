...
[.lead]
volcreate.fsid events are reported when flexible volumes were created with file system identifiers (FSIDs) which conflict with existing volumes, and corrective actions typically involve following the documented corrective action guidance.
