...
[.lead]
disk.iomediumerror events are reported when the drive reports a medium error, and corrective actions typically involve following the documented corrective action guidance.
