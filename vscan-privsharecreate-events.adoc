...
[.lead]
vscan.privsharecreate events are reported when the creation of privileged share ONTAP_ADMIN$ fails, and corrective actions typically involve checking the reported configuration and connectivity.
