...
[.lead]
unowned.disk events are reported when the system has unowned/unassigned disks, and corrective actions typically involve following the documented corrective action guidance.
