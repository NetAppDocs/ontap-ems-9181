...
[.lead]
wafl.sidl events are reported when a volume or aggregate with single instance data logging enabled encounters a problem in a metafile required for the functioning of the single instance data logging feature, and corrective actions typically involve following the documented corrective action guidance.
