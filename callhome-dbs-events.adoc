...
[.lead]
callhome.dbs events are reported when the Distributed Block Store (DBS) assignments reports a validation error, and corrective actions typically involve contacting NetApp technical support.
