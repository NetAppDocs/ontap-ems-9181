...
[.lead]
lmgr.pruning events are reported when there is a delay in pruning and removing unused entries in the volume lock manager hosts file, and corrective actions typically involve following the documented corrective action guidance.
