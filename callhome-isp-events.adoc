...
[.lead]
callhome.isp events are reported when the system detects multiple Static Random Access Memory (SRAM) parity errors within a 30 day period, and corrective actions typically involve following the documented corrective action guidance.
