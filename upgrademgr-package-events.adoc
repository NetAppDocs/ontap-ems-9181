...
[.lead]
Learn about upgrademgr.package EMS events, which report when a Data ONTAP(R) package is successfully imported into the cluster and processed by the upgrade manager's package handler.
