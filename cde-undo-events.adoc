...
[.lead]
cde.undo events are reported when undo of cde has to abort, and corrective actions typically involve following the documented corrective action guidance.
