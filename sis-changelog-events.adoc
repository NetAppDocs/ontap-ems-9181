...
[.lead]
sis.changelog events are reported when the Single Instance Storage (SIS) change logging metafile is full, and corrective actions typically involve following the documented corrective action guidance.
