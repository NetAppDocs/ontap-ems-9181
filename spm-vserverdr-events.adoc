...
[.lead]
spm.vserverdr events are reported when the Vserver DR process involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
