...
[.lead]
Learn about vldb.adtcons EMS events, which report when the Remote Procedure Call (RPC) from the Volume Location Database (VLDB) to the Management Gateway (MGWD) fails.
