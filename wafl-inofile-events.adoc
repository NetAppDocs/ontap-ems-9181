...
[.lead]
wafl.inofile events are reported when this event can occur when a snapshot's inofile buffer header has the wrong magic or file block number, and corrective actions typically involve contacting NetApp technical support.
