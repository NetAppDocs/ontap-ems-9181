...
[.lead]
Learn about wafl.inofile EMS events, which report when This event can occur when a snapshot's inofile buffer header has the wrong magic or file block number.
