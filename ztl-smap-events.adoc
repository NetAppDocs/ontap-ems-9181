...
[.lead]
ztl.smap events are reported when the specified partition on a SSD-ZNS drive could not be onlined due to internal S/W or device error, and corrective actions typically involve following the documented corrective action guidance.
