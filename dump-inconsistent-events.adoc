...
[.lead]
dump.inconsistent events are reported when the dump engine encounters a disk error in an ACL file in a Snapshot(tm) copy, and corrective actions typically involve contacting NetApp technical support.
