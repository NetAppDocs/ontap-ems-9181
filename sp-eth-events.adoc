...
[.lead]
sp.eth events are reported when service Processor (SP) or Baseboard Management Controller (BMC) fails to auto-update the internal Ethernet switch, and corrective actions typically involve following the documented corrective action guidance.
