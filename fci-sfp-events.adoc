...
[.lead]
fci.sfp events are reported when an invalid Small Form-factor Pluggable (SFP) is inserted into the adapter, and corrective actions typically involve following the documented corrective action guidance.
