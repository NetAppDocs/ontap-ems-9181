...
[.lead]
secd.netgroup events are reported when this message occurs if the filter for searching the Lightweight Directory Access Protocol (LDAP) server is found to be invalid, and corrective actions typically involve following the documented corrective action guidance.
