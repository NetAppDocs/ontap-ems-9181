...
[.lead]
Learn about secd.netgroup EMS events, which report when the filter for searching the Lightweight Directory Access Protocol (LDAP) server is found to be invalid.
