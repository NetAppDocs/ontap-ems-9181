...
[.lead]
scsiblade.mgmt events are reported when a SAN management event is lost because the system could not allocate enough free memory, and corrective actions typically involve following the documented corrective action guidance.
