...
[.lead]
wafl.buf events are reported when the system encounters a bad header in the snapshot of the active map block of the filesystem, and corrective actions typically involve following the documented corrective action guidance.
