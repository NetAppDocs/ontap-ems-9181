...
[.lead]
maxcid.threshold events are reported when the system is approaching the maximum number of open data connections supported on the node, and corrective actions typically involve following the documented corrective action guidance.
