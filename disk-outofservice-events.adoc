...
[.lead]
disk.outofservice events are reported when a drive is removed from service because it has been marked failed, is being sanitized, or has entered Maintenance Center, and corrective actions typically involve following the documented corrective action guidance.
