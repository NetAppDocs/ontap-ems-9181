...
[.lead]
Learn about disk.outofservice EMS events, which report when a drive is removed from service because it has been marked failed, is being sanitized, or has entered Maintenance Center.
