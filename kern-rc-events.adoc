...
[.lead]
kern.rc events are reported when this event is issued when an error printf is issued by the kernel in the context of executing the /etc/rc file, and corrective actions typically involve following the documented corrective action guidance.
