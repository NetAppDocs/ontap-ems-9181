...
[.lead]
crypto.ssal events are reported when a Secure Storage Access Layer(SSAL) operation fails, and corrective actions typically involve following the documented corrective action guidance.
