...
[.lead]
ses.unsupported events are reported when a disk shelf has one unsupported power supply unit installed in it, and corrective actions typically involve following the documented corrective action guidance.
