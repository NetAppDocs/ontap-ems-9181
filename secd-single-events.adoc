...
[.lead]
secd.single events are reported when the trusted domains for the CIFS home domain of a Vserver contains a single-label domain (SLD), and corrective actions typically involve following the documented corrective action guidance.
