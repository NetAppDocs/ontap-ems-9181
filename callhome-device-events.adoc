...
[.lead]
callhome.device events are reported when the system detected a disk drive device that did not receive qualification from NetApp, and corrective actions typically involve following the documented corrective action guidance.
