...
[.lead]
ha.panicinfosent events are reported when a node successfully sends panic information to its high-availability (HA) partner over the HA interconnect, and corrective actions typically involve following the documented corrective action guidance.
