...
[.lead]
Learn about ha.panicinfosent EMS events, which report when a node successfully sends panic information to its high-availability (HA) partner over the HA interconnect.
