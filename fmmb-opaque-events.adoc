...
[.lead]
fmmb.opaque events are reported when this event is issued when the HA Mailbox opaque header is invalid, and corrective actions typically involve following the documented corrective action guidance.
