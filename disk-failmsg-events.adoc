...
[.lead]
disk.failmsg events are reported when a drive is marked failed, is being sanitized, or has entered Maintenance Center, and corrective actions typically involve following the documented corrective action guidance.
