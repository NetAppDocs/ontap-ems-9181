...
[.lead]
auto.update events are reported when an action is applied to an automatic update request, and corrective actions typically involve following the documented corrective action guidance.
