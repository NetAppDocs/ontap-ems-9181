...
[.lead]
flexcache.attrib events are reported when syncing properties between an origin of a FlexCache volume and its FlexCache volume fails, and due to which FlexCache volume may not be able to proceed with accurate data, and corrective actions typically involve following the documented corrective action guidance.
