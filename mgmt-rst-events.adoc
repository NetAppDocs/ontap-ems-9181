...
[.lead]
mgmt.rst events are reported when the SnapMirror(R) 'restore' command fails because compression is enabled on the destination volume, and corrective actions typically involve following the documented corrective action guidance.
