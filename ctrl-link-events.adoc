...
[.lead]
ctrl.link events are reported when the software detects either symbol errors or out-of-sequence errors on HA interconnect links, and corrective actions typically involve following the documented corrective action guidance.
