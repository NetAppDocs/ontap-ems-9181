...
[.lead]
sfu.nsmdownloadfailed events are reported when a disk shelf firmware update fails to download disk shelf firmware to a disk shelf successfully, and corrective actions typically involve following the documented corrective action guidance.
