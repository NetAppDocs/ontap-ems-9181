...
[.lead]
nblade.cifsmanyauths events are reported when many authentication negotiations occur simultaneously, and corrective actions typically involve following the documented corrective action guidance.
