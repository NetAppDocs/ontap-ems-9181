...
[.lead]
httpd.api events are reported when a Manage ONTAP(R) API request to an internal server expires due to configured session limits, and corrective actions typically involve following the documented corrective action guidance.
