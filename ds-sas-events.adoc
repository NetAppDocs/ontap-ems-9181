...
[.lead]
ds.sas events are reported when the system detects a configuration problem on the shelf I/O module, and corrective actions typically involve following the documented corrective action guidance.
