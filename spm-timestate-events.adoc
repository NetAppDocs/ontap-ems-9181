...
[.lead]
spm.timestate events are reported when the subsystem managing timekeeping parameters (time_state) stops running, and corrective actions typically involve following the documented corrective action guidance.
