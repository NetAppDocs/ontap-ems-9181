...
[.lead]
km.okmdb events are reported when a read of the Onboard Key Manager's database file fails, and corrective actions typically involve checking the reported configuration and connectivity.
