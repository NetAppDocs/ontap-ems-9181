...
[.lead]
vm.dev events are reported when data ONTAP(R) is running on a virtual platform, and slow I/O is detected, and corrective actions typically involve following the documented corrective action guidance.
