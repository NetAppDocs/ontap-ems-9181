...
[.lead]
wafl.atime events are reported when the access time updates of all the files in the volumes of an aggregate start because the aggregate has enough free space, and corrective actions typically involve following the documented corrective action guidance.
