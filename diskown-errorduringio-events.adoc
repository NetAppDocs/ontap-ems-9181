...
[.lead]
diskown.errorduringio events are reported when this event is issued when an I/O error occurs during a sanown disk operation, and corrective actions typically involve following the documented corrective action guidance.
