...
[.lead]
bcomd.fcplifadded events are reported when a Fibre Channel logical interface (LIF) is added, and corrective actions typically involve following the documented corrective action guidance.
