...
[.lead]
snmp.authentication events are reported when there is an authentication failure during an SNMP query, and corrective actions typically involve following the documented corrective action guidance.
