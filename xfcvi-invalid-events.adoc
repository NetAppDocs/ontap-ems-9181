...
[.lead]
xfcvi.invalid events are reported when xfcvi driver receives invalid advertisement, and corrective actions typically involve following the documented corrective action guidance.
