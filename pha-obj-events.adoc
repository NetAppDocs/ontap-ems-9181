...
[.lead]
pha.obj events are reported when oNTAP(R) detects that a blob has been deleted from a container, and corrective actions typically involve following the documented corrective action guidance.
