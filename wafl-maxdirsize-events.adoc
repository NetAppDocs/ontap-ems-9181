...
[.lead]
wafl.maxdirsize events are reported when this message occurs for each volume that has a maximum directory size greater than the default during boot, and corrective actions typically involve following the documented corrective action guidance.
