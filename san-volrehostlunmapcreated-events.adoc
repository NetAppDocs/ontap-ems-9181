...
[.lead]
Learn about san.volrehostlunmapcreated EMS events, which report when This message occurs on clustered Data ONTAP(R) systems for Volume Rehost operation on successful creation of the LUN map the destination Vserver.
