...
[.lead]
san.volrehostlunmapcreated events are reported when this message occurs on clustered Data ONTAP(R) systems for Volume Rehost operation on successful creation of the LUN map the destination Vserver, and corrective actions typically involve following the documented corrective action guidance.
