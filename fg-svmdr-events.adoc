...
[.lead]
fg.svmdr events are reported when this message occurs during FlexGroup volume replication in an SVM DR setup when the available QoS workloads are insufficient on the secondary cluster, and corrective actions typically involve contacting NetApp technical support.
