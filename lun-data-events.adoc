...
[.lead]
lun.data events are reported when data is unable to be read from a capacity tier, and corrective actions typically involve following the documented corrective action guidance.
