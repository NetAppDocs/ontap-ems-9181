...
[.lead]
air.repaired events are reported when oNTAP(R) discovers an inconsistency in a metadata bucket header record, and corrective actions typically involve following the documented corrective action guidance.
