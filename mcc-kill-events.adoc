...
[.lead]
mcc.kill events are reported when the node is halting because it received a "kill" message from the disaster recovery (DR) partner, and corrective actions typically involve following the documented corrective action guidance.
