...
[.lead]
vdom.aggr events are reported when an internal timeout has been reached while processing volumes for an aggregate coming online during a takeover, giveback, or aggregate relocation event, and corrective actions typically involve following the documented corrective action guidance.
