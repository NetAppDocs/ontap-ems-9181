...
[.lead]
lun.out events are reported when a LUN is brought offline by the SCSI layer because of a write failure due to lack of space, and corrective actions typically involve following the documented corrective action guidance.
