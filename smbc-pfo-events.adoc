...
[.lead]
smbc.pfo events are reported when the SnapMirror(R) active sync planned failover operation completes, and corrective actions typically involve following the documented corrective action guidance.
