...
[.lead]
nblade.invtcprecordmarker events are reported when a TCP connection is reset due to an invalid TCP record marker in an Open Network Computing/Remote Procedure Call request, and corrective actions typically involve following the documented corrective action guidance.
