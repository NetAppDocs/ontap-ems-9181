...
[.lead]
Learn about nblade.invtcprecordmarker EMS events, which report when a TCP connection is reset due to an invalid TCP record marker in an Open Network Computing/Remote Procedure Call request.
