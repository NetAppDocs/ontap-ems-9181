...
[.lead]
Learn about pvif.badmtu EMS events, which report when the interface group (ifgrp) driver fails to update the MTU size on a member port because it does not support the requested configuration.
