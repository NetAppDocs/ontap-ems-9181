...
[.lead]
aggr.relocation events are reported when relocation of an aggregate fails, and corrective actions typically involve following the documented corrective action guidance.
