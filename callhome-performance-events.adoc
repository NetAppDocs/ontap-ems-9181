...
[.lead]
callhome.performance events are reported when you invoke an AutoSupport for performance archives, and corrective actions typically involve following the documented corrective action guidance.
