...
[.lead]
Learn about ndmp.ctrl EMS events, which report when the IP address of the logical interface (LIF) that hosts the NDMP control connection is hosted on maintenance port "e0M".
