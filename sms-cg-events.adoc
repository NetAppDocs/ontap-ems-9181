...
[.lead]
sms.cg events are reported when a SnapMirror(R) Synchronous Automated Failover relationship is part of a cascade configuration, and corrective actions typically involve following the documented corrective action guidance.
