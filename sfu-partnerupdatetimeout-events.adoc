...
[.lead]
Learn about sfu.partnerupdatetimeout EMS events, which report when This message occurs in a high-availability (HA) configuration in which an HA partner was downloading disk shelf firmware and the download has timed out.
