...
[.lead]
flexcache.encryption events are reported when a plaintext FlexCache volume has been created for an encrypted origin volume, and corrective actions typically involve following the documented corrective action guidance.
