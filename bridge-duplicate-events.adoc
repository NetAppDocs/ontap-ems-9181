...
[.lead]
bridge.duplicate events are reported when the system discovers an ATTO FibreBridge using the same IP address as some other device in the network, and corrective actions typically involve following the documented corrective action guidance.
