...
[.lead]
reg.cookie events are reported when allocation of cookies for traversing all keys under a prefix fails, and corrective actions typically involve following the documented corrective action guidance.
