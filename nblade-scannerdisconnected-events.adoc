...
[.lead]
nblade.scannerdisconnected events are reported when any Vserver disconnects from a Vscan server, and corrective actions typically involve following the documented corrective action guidance.
