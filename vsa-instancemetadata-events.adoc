...
[.lead]
Learn about vsa.instancemetadata EMS events, which report when the system detects that a field in the virtual machine's instance metadata settings has changed.
