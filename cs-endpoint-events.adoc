...
[.lead]
cs.endpoint events are reported when volume delete operations attempts to clean-up snapmirror resources and finds that there are no cloud snapshots associated with the volume, and corrective actions typically involve following the documented corrective action guidance.
