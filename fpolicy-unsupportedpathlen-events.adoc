...
[.lead]
fpolicy.unsupportedpathlen events are reported when an FPolicy screen request has a path name longer than 4k bytes, and corrective actions typically involve following the documented corrective action guidance.
