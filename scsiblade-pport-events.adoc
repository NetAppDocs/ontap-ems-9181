...
[.lead]
scsiblade.pport events are reported when pPorts LIF migration started before BSH cancel completed, and corrective actions typically involve following the documented corrective action guidance.
