...
[.lead]
netif.excesslinkinterrupts events are reported when excessive link status change interrupts occur on the network interface, and corrective actions typically involve following the documented corrective action guidance.
