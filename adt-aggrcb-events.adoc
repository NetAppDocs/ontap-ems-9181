...
[.lead]
adt.aggrcb events are reported when the auditing subsystem cannot remove a stale aggregate control block entry from the Audit aggregate hash table, and corrective actions typically involve rebooting the node or cluster component.
