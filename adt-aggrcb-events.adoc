...
[.lead]
Learn about adt.aggrcb EMS events, which report when the auditing subsystem cannot remove a stale aggregate control block entry from the Audit aggregate hash table.
