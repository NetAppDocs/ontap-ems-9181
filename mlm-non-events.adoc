...
[.lead]
mlm.non events are reported when data ONTAP(R) detects non-optimized usage of an array's target port, and corrective actions typically involve following the documented corrective action guidance.
