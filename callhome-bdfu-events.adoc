...
[.lead]
callhome.bdfu events are reported when drive unlock fails for firmware download on a FIPS-certified NetApp Storage Encryption SAS drive, and corrective actions typically involve contacting NetApp technical support.
