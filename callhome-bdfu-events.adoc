...
[.lead]
Learn about callhome.bdfu EMS events, which report when drive unlock fails for firmware download on a FIPS-certified NetApp Storage Encryption SAS drive.
