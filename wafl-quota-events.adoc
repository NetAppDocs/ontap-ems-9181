...
[.lead]
wafl.quota events are reported when the system cannot create the quota database file, and corrective actions typically involve following the documented corrective action guidance.
