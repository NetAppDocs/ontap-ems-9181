...
[.lead]
Learn about raid.monitor EMS events, which report when the hourly monitor indicates that the current aggregate or volume number exceeded the maximum number of supported volumes on the host.
