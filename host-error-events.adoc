...
[.lead]
host.error events are reported when the host software encounters an error, and corrective actions typically involve following the documented corrective action guidance.
