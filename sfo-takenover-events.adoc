...
[.lead]
sfo.takenover events are reported when an attempted optimized negotiated takeover is aborted by the node about to be taken over, and corrective actions typically involve following the documented corrective action guidance.
