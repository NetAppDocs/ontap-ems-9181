...
[.lead]
Learn about rdmalib.rcm EMS events, which report when the configuration of the high-availability (HA) interface cannot be completed due to a missing IP address.
