...
[.lead]
rdmalib.rcm events are reported when the configuration of the high-availability (HA) interface cannot be completed due to a missing IP address, and corrective actions typically involve verifying the reported configuration and health state.
