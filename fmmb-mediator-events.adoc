...
[.lead]
fmmb.mediator events are reported when a mailbox disk from the mediator site is selected to be included in the mailbox disk list, and corrective actions typically involve following the documented corrective action guidance.
