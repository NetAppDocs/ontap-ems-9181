...
[.lead]
Learn about callhome.spares EMS events, which report when one or more RAID groups do not have an eligible spare disk drive available in case of a disk drive failure.
