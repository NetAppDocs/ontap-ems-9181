...
[.lead]
replication.status events are reported when the time skew between the source and destination system is greater than 1 minute, and corrective actions typically involve following the documented corrective action guidance.
