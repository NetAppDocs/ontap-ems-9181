...
[.lead]
pha.dev events are reported when oNTAP(R)software fails to get a drives's capacity after an extended wait, and corrective actions typically involve ensuring the required configuration and resources are in place.
