...
[.lead]
tape.device events are reported when an adapter error occurs that Data ONTAP(R) does not recognize, and corrective actions typically involve following the documented corrective action guidance.
