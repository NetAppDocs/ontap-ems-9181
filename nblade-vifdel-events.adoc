...
[.lead]
nblade.vifdel events are reported when there is a failure removing the IP address of a LIF that is being deleted, and corrective actions typically involve following the documented corrective action guidance.
