...
[.lead]
shm.fab events are reported when an error is received while writing the failure bytes, and corrective actions typically involve following the documented corrective action guidance.
