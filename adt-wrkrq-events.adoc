...
[.lead]
adt.wrkrq events are reported when an internal audit worker queue fails to initialize, and corrective actions typically involve restoring available system resources.
