...
[.lead]
mcc.hwassist events are reported when a HW assist trap is received from the Service Processor of the DR-partner and is used to trigger an Automatic SwitchOver, and corrective actions typically involve following the documented corrective action guidance.
