...
[.lead]
Learn about mcc.hwassist EMS events, which report when a HW assist trap is received from the Service Processor of the DR-partner and is used to trigger an Automatic SwitchOver.
