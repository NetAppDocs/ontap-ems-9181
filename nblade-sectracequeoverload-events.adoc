...
[.lead]
nblade.sectracequeoverload events are reported when there are too many Sectrace work items, and corrective actions typically involve checking the reported configuration and connectivity.
