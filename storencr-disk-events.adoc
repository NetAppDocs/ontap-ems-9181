...
[.lead]
storencr.disk events are reported when a Storage Encryption disk command operation that modifies encrypting drive parameters is completed successfully, and corrective actions typically involve following the documented corrective action guidance.
