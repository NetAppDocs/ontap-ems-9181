...
[.lead]
Learn about storencr.disk EMS events, which report when a Storage Encryption disk command operation that modifies encrypting drive parameters is completed successfully.
