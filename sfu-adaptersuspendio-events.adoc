...
[.lead]
sfu.adaptersuspendio events are reported when this message occurs during a disk shelf firmware update on a disk shelf that cannot perform I/O while updating firmware, and corrective actions typically involve following the documented corrective action guidance.
