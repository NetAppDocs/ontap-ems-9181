...
[.lead]
Learn about license.pool EMS events, which report when a storage failover giveback is vetoed because the aggregate has no valid capacity lease from the capacity pool.
