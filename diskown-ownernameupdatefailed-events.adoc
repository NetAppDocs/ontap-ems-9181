...
[.lead]
diskown.ownernameupdatefailed events are reported when this event is issued when we have to rewrite a DOWN because it is out of date wrt the other DOWNs, and corrective actions typically involve following the documented corrective action guidance.
