...
[.lead]
bucket.soft events are reported when a bucket exceeds the soft quota limit (block), and corrective actions typically involve following the documented corrective action guidance.
