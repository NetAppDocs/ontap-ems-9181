...
[.lead]
sis.logical events are reported when the deduplication engine's logical data limit is nearly reached on a volume, and corrective actions typically involve following the documented corrective action guidance.
