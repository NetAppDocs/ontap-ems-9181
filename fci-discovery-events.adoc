...
[.lead]
fci.discovery events are reported when the Fibre Channel adapter driver cannot complete device discovery within the specified time, and corrective actions typically involve following the documented corrective action guidance.
