...
[.lead]
ses.psu events are reported when the power supplies that are installed in a disk shelf are not compatible with each other, and corrective actions typically involve following the documented corrective action guidance.
