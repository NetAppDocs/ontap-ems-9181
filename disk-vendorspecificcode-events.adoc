...
[.lead]
disk.vendorspecificcode events are reported when a disk returns a vendor-specific error, and corrective actions typically involve following the documented corrective action guidance.
