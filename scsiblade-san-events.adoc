...
[.lead]
scsiblade.san events are reported when the SAN active-active state has changed, and corrective actions typically involve following the documented corrective action guidance.
