...
[.lead]
spm.mes events are reported when the SPD MES daemon (spd) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
