...
[.lead]
cpeer.localid events are reported when there is an issue reading the local cluster ID, and corrective actions typically involve following the documented corrective action guidance.
