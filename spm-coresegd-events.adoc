...
[.lead]
spm.coresegd events are reported when the core segment server (coresegd) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
