...
[.lead]
cache.ttl events are reported when this message occurs on the last node during the upgrade to ONTAP(R) 9, and corrective actions typically involve following the documented corrective action guidance.
