...
[.lead]
callhome.ups events are reported when line power for an Uninterruptible Power Supply (UPS) system is restored and the battery power is normal, and corrective actions typically involve following the documented corrective action guidance.
