...
[.lead]
Learn about vifmgr.lifbeinghosted EMS events, which report when a logical interface (LIF) IP address that was previously marked as down because no eligible ports could host this LIF is now being hosted.
