...
[.lead]
net.static events are reported when user configured static host route entry being replaced with a dynamic entry by route redirect message, and corrective actions typically involve following the documented corrective action guidance.
