...
[.lead]
Learn about net.static EMS events, which report when This event is generated when user configured static host route entry being replaced with a dynamic entry by route redirect message.
