...
[.lead]
Learn about configbr.unpubfailed EMS events, which report when the configuration backup and restore feature fails to unpublish a package by using the file replication service.
