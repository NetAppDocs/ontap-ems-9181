...
[.lead]
configbr.unpubfailed events are reported when the configuration backup and restore feature fails to unpublish a package by using the file replication service, and corrective actions typically involve following the documented corrective action guidance.
