...
[.lead]
Learn about vnvram.flushed EMS events, which report when the VNVRAM contents of any ONTAP-based virtual appliance that is not using full-mode VNVRAM, are written to the backing storage device.
