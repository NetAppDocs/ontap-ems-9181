...
[.lead]
disk.sizegrew events are reported when the controller detects an increase in the capacity of a virtual disk, and corrective actions typically involve following the documented corrective action guidance.
