...
[.lead]
config.more2path events are reported when a disk is found to have more than two connections to the storage controller, and corrective actions typically involve following the documented corrective action guidance.
