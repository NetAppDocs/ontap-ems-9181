...
[.lead]
diskown.disk events are reported when this message occurs during an attempt to assign a disk that is being deleted, and corrective actions typically involve following the documented corrective action guidance.
