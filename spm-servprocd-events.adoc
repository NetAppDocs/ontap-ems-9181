...
[.lead]
spm.servprocd events are reported when the Service processor daemon process (servprocd) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
