...
[.lead]
repl.ser events are reported when number of operations serialized on parent directory exceed an internal limit, and corrective actions typically involve following the documented corrective action guidance.
