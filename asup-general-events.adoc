...
[.lead]
asup.general events are reported when the system cannot generate an AutoSupport message from a callhome EMS event, and corrective actions typically involve following the documented corrective action guidance.
