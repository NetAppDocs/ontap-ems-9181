...
[.lead]
netif.badoversizepacket events are reported when the network interface card (NIC) receives a bad oversize packet, and corrective actions typically involve following the documented corrective action guidance.
