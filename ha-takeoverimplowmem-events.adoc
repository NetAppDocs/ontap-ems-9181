...
[.lead]
Learn about ha.takeoverimplowmem EMS events, which report when the partner node is down; however, due to this node being low on memory, it is currently impossible to perform a takeover.
