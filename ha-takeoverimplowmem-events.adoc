...
[.lead]
ha.takeoverimplowmem events are reported when the partner node is down; however, due to this node being low on memory, it is currently impossible to perform a takeover, and corrective actions typically involve contacting NetApp technical support.
