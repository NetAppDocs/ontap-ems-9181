...
[.lead]
Learn about nblade.nfs4unoptimizedio EMS events, which report when a session trunking group that is created by the NFSv41 client is split across multiple nodes.
