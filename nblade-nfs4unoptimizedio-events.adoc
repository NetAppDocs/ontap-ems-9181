...
[.lead]
nblade.nfs4unoptimizedio events are reported when a session trunking group that is created by the NFSv41 client is split across multiple nodes, and corrective actions typically involve following the documented corrective action guidance.
