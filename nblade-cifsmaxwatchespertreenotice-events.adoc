...
[.lead]
Learn about nblade.cifsmaxwatchespertreenotice EMS events, which report when the total number of directory watch (Change Notify) requests nears the configured limit.
