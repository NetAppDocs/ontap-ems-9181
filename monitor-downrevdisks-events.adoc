...
[.lead]
monitor.downrevdisks events are reported when oNTAP(R) detects that downrev disks are still present in the system, and corrective actions typically involve following the documented corrective action guidance.
