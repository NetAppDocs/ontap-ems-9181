...
[.lead]
diskown.mccip events are reported when metroCluster(tm) quarter-shelf based drive assignment is enabled or disabled, and corrective actions typically involve following the documented corrective action guidance.
