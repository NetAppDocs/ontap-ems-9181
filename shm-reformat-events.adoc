...
[.lead]
shm.reformat events are reported when the system tries to reformat a disk, but an error is returned, and corrective actions typically involve following the documented corrective action guidance.
