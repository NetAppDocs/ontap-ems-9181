...
[.lead]
Learn about disk.encryptaccesserr EMS events, which report when a disk reports a data protection error, and ONTAP(R) cannot restore permission to access the data through storage encryption methods.
