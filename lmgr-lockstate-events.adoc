...
[.lead]
lmgr.lockstate events are reported when the system cannot clean up the lock state associated with the active file system, and corrective actions typically involve contacting NetApp technical support.
