...
[.lead]
Learn about nblade.cifsetcdmaxtxnlimit EMS events, which report when the number of Access Control Entries (ACE) present in an MSRPC request for updating share permissions exceeds the supported maximum etcd limit of 1,022 entries.
