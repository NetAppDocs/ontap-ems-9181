...
[.lead]
callhome.fdsk events are reported when you fail a file system disk drive, and corrective actions typically involve following the documented corrective action guidance.
