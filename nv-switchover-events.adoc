...
[.lead]
Learn about nv.switchover EMS events, which report when switchover proceeds even when nonvolatile RAM (NVRAM) inconsistencies are detected in the DR partner sections.
