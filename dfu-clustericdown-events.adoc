...
[.lead]
dfu.clustericdown events are reported when the high-availability (HA) interconnect is not available, and corrective actions typically involve following the documented corrective action guidance.
