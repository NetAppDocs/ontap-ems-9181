...
[.lead]
wafl.replay events are reported when a partner aggregate is mounted early before replay, and corrective actions typically involve following the documented corrective action guidance.
