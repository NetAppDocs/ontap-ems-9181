...
[.lead]
osc.signaturemismatch events are reported when the request signature sent to the object-store server does not match the signature calculated, and corrective actions typically involve verifying the reported configuration and health state.
