...
[.lead]
reg.key events are reported when oNTAP(R) software cannot access the registry because the key is not valid, and corrective actions typically involve following the documented corrective action guidance.
