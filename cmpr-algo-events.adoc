...
[.lead]
cmpr.algo events are reported when compression algorithm specified has not been enabled on the node, and corrective actions typically involve contacting NetApp technical support.
