...
[.lead]
secd.cifsauth events are reported when a CIFS authentication attempt fails for any reason other than an unknown user name or bad password, and corrective actions typically involve following the documented corrective action guidance.
