...
[.lead]
dump.max events are reported when new dump or restore sessions cannot be started because the limit for this platform has been reached, and corrective actions typically involve following the documented corrective action guidance.
