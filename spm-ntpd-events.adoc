...
[.lead]
spm.ntpd events are reported when the Network Time Protocol Daemon process (ntpd) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
