...
[.lead]
Learn about wafl.log EMS events, which report when WAFL reports suspended messages that have been languishing for more than 30 seconds (represented by the macro MAX_SUSP_TIME_REPORT_THRESHOLD).
