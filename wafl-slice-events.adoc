...
[.lead]
wafl.slice events are reported when an invalid slice stream was not fixed by wafliron because the associated slice base file was not recognized at the time wafliron ran, and corrective actions typically involve following the documented corrective action guidance.
