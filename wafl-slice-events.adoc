...
[.lead]
Learn about wafl.slice EMS events, which report when an invalid slice stream was not fixed by wafliron because the associated slice base file was not recognized at the time wafliron ran.
