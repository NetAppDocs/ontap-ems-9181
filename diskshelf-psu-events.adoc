...
[.lead]
diskshelf.psu events are reported when a power supply unit is added to the disk shelf, and corrective actions typically involve following the documented corrective action guidance.
