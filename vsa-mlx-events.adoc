...
[.lead]
Learn about vsa.mlx EMS events, which report when ONTAP(R) software is running as an instance in Azure and a NIC SR-IOV Mellanox (MLX) driver detach event is detected.
