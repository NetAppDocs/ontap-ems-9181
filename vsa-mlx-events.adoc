...
[.lead]
vsa.mlx events are reported when oNTAP(R) software is running as an instance in Azure and a NIC SR-IOV Mellanox (MLX) driver detach event is detected, and corrective actions typically involve following the documented corrective action guidance.
