...
[.lead]
vifmgr.ipspace events are reported when the system is over-provisioned with IPspaces, exceeding the maximum number allowed, and corrective actions typically involve following the documented corrective action guidance.
