...
[.lead]
vserver.rootvolume events are reported when there is no space left on Vserver root Volume, and corrective actions typically involve following the documented corrective action guidance.
