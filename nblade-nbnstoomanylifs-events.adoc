...
[.lead]
nblade.nbnstoomanylifs events are reported when the NetBIOS Name Service receives more than 25 IP addresses for a name registration request, and corrective actions typically involve following the documented corrective action guidance.
