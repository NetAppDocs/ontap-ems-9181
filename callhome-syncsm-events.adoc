...
[.lead]
callhome.syncsm events are reported when critical thresholds are breached for a SnapMirror(R) Synchronous relationship, and corrective actions typically involve following the documented corrective action guidance.
