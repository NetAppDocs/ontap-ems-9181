...
[.lead]
Learn about storvsc.srb EMS events, which report when ONTAP(R) software receives an unexpected hypervisor I/O adapter driver response code to an I/O request.
