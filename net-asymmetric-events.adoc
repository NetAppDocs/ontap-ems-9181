...
[.lead]
net.asymmetric events are reported when oNTAP(R) detects asymmetric routing on the e0M port, and corrective actions typically involve following the documented corrective action guidance.
