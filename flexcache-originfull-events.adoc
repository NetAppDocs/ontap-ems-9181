...
[.lead]
flexcache.originfull events are reported when a FlexCache(R) origin volume cannot serve data to cache volume because origin volume is full, and corrective actions typically involve ensuring the required configuration and resources are in place.
