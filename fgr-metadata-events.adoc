...
[.lead]
fgr.metadata events are reported when the system detects an inconsistency in the volume capacity rebalancing metadata, and no corrective action is typically required.
