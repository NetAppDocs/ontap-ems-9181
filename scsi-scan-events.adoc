...
[.lead]
scsi.scan events are reported when the creation of the SCSI transport (xpt) path fails, and corrective actions typically involve checking the reported configuration and connectivity.
