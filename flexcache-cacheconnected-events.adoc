...
[.lead]
flexcache.cacheconnected events are reported when a FlexCache(R) origin volume establishes communication with its cache volume, and corrective actions typically involve following the documented corrective action guidance.
