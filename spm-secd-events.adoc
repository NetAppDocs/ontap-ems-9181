...
[.lead]
spm.secd events are reported when the Security daemon (secd) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
