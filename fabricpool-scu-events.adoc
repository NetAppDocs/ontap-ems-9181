...
[.lead]
fabricpool.scu events are reported when contact has resumed between ONTAP and the Service Control Unit that is used with cloud subscription licenses, and corrective actions typically involve following the documented corrective action guidance.
