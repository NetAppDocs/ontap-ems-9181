...
[.lead]
Learn about fabricpool.scu EMS events, which report when contact has resumed between ONTAP and the Service Control Unit that is used with cloud subscription licenses.
