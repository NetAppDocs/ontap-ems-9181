...
[.lead]
lun.oovc events are reported when the rebuilding of the Out Of Volume Container (OOVC) file is complete, and corrective actions typically involve following the documented corrective action guidance.
