...
[.lead]
volcopy.flextotraderr events are reported when the user tries to copy a flexible volume into a traditional volume using the command 'vol copy', and corrective actions typically involve following the documented corrective action guidance.
