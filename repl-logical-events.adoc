...
[.lead]
repl.logical events are reported when a data warehouse is rebuilt as part of a SnapMirror(R) restore or resync operation, and corrective actions typically involve following the documented corrective action guidance.
