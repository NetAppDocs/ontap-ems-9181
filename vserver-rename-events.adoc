...
[.lead]
Learn about vserver.rename EMS events, which report when the "vserver rename" command fails to update the peer Vserver name on the peer cluster in a Vserver peer relationship.
