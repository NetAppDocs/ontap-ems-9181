...
[.lead]
fci.mserr events are reported when the Fibre Channel fabric cannot successfully complete a request to the Management Server to retrieve configuration information, and corrective actions typically involve following the documented corrective action guidance.
