...
[.lead]
Learn about fci.mserr EMS events, which report when the Fibre Channel fabric cannot successfully complete a request to the Management Server to retrieve configuration information.
