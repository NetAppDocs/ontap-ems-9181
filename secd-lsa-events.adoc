...
[.lead]
secd.lsa events are reported when none of the configured LSA servers are accepting connections, and corrective actions typically involve ensuring the required configuration and resources are in place.
