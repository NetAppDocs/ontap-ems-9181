...
[.lead]
spm.mgwd events are reported when the Management Gateway (mgwd) subsystem involuntarily exits, and corrective actions typically involve following the documented corrective action guidance.
