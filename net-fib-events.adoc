...
[.lead]
net.fib events are reported when a Vserver resource allocation fails, and corrective actions typically involve following the documented corrective action guidance.
