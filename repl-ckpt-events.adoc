...
[.lead]
repl.ckpt events are reported when this message occurs to record new checkpoint generations subsequent to the first, and corrective actions typically involve following the documented corrective action guidance.
