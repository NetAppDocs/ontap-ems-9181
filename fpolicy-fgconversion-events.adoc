...
[.lead]
Learn about fpolicy.fgconversion EMS events, which report when a FlexVol(R) unmount notification is not sent to the FPolicy(tm) server during a FlexGroup conversion.
