...
[.lead]
connectx.iblinkretrainnotreqd events are reported when the software detects that the previous InfiniBand link training was successful, and corrective actions typically involve following the documented corrective action guidance.
