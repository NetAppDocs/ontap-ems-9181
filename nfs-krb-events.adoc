...
[.lead]
nfs.krb events are reported when a Kerberos-enabled LIF in a Vserver shares NFS Kerberos credentials with a LIF in another Vserver, and corrective actions typically involve following the documented corrective action guidance.
