...
[.lead]
wafl.afs events are reported when the deswizzle scanner fails to enable the wafl, and corrective actions typically involve following the documented corrective action guidance.
