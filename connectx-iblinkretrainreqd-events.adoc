...
[.lead]
connectx.iblinkretrainreqd events are reported when the software detects that the previous InfiniBand link training was unsuccessful, and corrective actions typically involve following the documented corrective action guidance.
