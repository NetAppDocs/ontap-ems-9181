...
[.lead]
rsh.enabled events are reported when rsh is enabled in the cluster using the (privilege: advanced) "security protocol" command, and corrective actions typically involve following the documented corrective action guidance.
