...
[.lead]
dfu.firmwaredownloading events are reported when firmware is being downloaded for a specific product ID of disks on the system, and corrective actions typically involve following the documented corrective action guidance.
