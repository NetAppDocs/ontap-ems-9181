...
[.lead]
scsiblade.isolated events are reported when the node loses connectivity with the majority of the cluster, and corrective actions typically involve following the documented corrective action guidance.
