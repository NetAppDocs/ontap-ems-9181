...
[.lead]
fcvi.cross events are reported when the fcvi driver detects a cross connection, and corrective actions typically involve checking the reported configuration and connectivity.
