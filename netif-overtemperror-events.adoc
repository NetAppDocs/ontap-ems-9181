...
[.lead]
netif.overtemperror events are reported when a network port is too hot or a sensor has malfunctioned, and corrective actions typically involve ensuring the required configuration and resources are in place.
