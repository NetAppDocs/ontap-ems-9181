...
[.lead]
fm.cpuutilduringarl events are reported when this message occurs at the start of an aggregate relocation (ARL) and at the completion of an ARL, and corrective actions typically involve following the documented corrective action guidance.
