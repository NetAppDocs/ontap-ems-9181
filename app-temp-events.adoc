...
[.lead]
app.temp events are reported when a S3 Bucket cannot be deleted as a part of an application destroy operation, and corrective actions typically involve following the documented corrective action guidance.
