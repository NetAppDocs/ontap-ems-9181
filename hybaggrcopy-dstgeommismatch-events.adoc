...
[.lead]
hybaggrcopy.dstgeommismatch events are reported when there is a mismatch between the disk geometries of source and destination hybrid aggregates, and corrective actions typically involve following the documented corrective action guidance.
