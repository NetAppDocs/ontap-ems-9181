...
[.lead]
Learn about hybaggrcopy.dstgeommismatch EMS events, which report when there is a mismatch between the disk geometries of source and destination hybrid aggregates.
