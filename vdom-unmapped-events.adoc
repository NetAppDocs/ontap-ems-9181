...
[.lead]
Learn about vdom.unmapped EMS events, which report when This message occurs for Virtual Disk Object Manager (VDOM) errors that do not currently map to specific VDOM EMS events.
