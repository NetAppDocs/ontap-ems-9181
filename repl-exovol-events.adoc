...
[.lead]
repl.exovol events are reported when an exo-volume scanner detects a loss of volume quiescence during a volume move operation, and corrective actions typically involve checking the reported configuration and connectivity.
