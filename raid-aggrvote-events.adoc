...
[.lead]
raid.aggrvote events are reported when the mirror vote pull from the replicated database (RDB) to the mailbox fails, and corrective actions typically involve following the documented corrective action guidance.
