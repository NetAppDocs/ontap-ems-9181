...
[.lead]
secd.nfs events are reported when data ONTAP(R) truncates the number of groups to which a user belongs, and corrective actions typically involve following the documented corrective action guidance.
