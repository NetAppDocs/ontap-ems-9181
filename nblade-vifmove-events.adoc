...
[.lead]
Learn about nblade.vifmove EMS events, which report when there is a failure adding a Remote Direct Memory Access (RDMA) listener during a Logical Interface (LIF) move.
