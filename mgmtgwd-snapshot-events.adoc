...
[.lead]
mgmtgwd.snapshot events are reported when a snapshot cannot be deleted from an Infinite Volume, and corrective actions typically involve following the documented corrective action guidance.
