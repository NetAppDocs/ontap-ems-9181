...
[.lead]
cf.badshelfcountmsg events are reported when this event occurs if we are sent an invalid negotiated failover shelf count message, and corrective actions typically involve checking the reported configuration and connectivity.
