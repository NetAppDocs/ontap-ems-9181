...
[.lead]
root.vol events are reported when system creates a root volume automatically, after a cluster reboot occurred before root volume creation, and corrective actions typically involve following the documented corrective action guidance.
