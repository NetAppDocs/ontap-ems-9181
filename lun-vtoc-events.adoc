...
[.lead]
lun.vtoc events are reported when the rebuilding of the Vdisk Table of Contents (VTOC) file is complete, and corrective actions typically involve following the documented corrective action guidance.
