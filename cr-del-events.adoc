...
[.lead]
cr.del events are reported when an attempt to delete corrupt stream data fails, and corrective actions typically involve following the documented corrective action guidance.
