...
[.lead]
dfu.readtestfailed events are reported when a read of the disk fails after downloading firmware to a disk, and corrective actions typically involve following the documented corrective action guidance.
