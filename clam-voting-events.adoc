...
[.lead]
clam.voting events are reported when the Kernel Cluster Services Connectivity, Liveliness, Availability Monitor (CLAM) detects that the voting state of the node changed, and corrective actions typically involve following the documented corrective action guidance.
