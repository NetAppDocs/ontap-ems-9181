...
[.lead]
Learn about clam.voting EMS events, which report when the Kernel Cluster Services Connectivity, Liveliness, Availability Monitor (CLAM) detects that the voting state of the node changed.
