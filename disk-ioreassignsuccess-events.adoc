...
[.lead]
disk.ioreassignsuccess events are reported when a medium error is detected on a disk and the sector reassignment succeeds, and corrective actions typically involve following the documented corrective action guidance.
