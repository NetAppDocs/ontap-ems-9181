...
[.lead]
monitor.raiddp events are reported when this message occurs as part of an hourly system check when a double parity volume is in single degraded mode, and corrective actions typically involve following the documented corrective action guidance.
