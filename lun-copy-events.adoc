...
[.lead]
lun.copy events are reported when a LUN appears in the public namespace of the destination volume during a LUN copy operation, and corrective actions typically involve following the documented corrective action guidance.
