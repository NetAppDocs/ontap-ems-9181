...
[.lead]
Learn about sfu.rebootrequestfailure EMS events, which report when an attempt to issue a reboot request after downloading disk shelf firmware fails, indicating a software error.
