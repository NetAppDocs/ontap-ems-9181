...
[.lead]
fm.overridembxuncertain events are reported when the user has chosen to override a mailbox uncertain state using the CTRL_O option, and corrective actions typically involve following the documented corrective action guidance.
