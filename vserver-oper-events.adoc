...
[.lead]
Learn about vserver.oper EMS events, which report when the system detects a cluster reboot on a Disaster Recovery Source (MetroCluster(tm) configuration or Vserver DR).
