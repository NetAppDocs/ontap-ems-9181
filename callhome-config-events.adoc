...
[.lead]
callhome.config events are reported when the system detects a disk shelf configuration error for one or more disk shelves, and corrective actions typically involve following the documented corrective action guidance.
