...
[.lead]
raid.unpartition events are reported when this message indicates a disk was successfully unpartitioned, and corrective actions typically involve following the documented corrective action guidance.
