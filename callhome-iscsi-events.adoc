...
[.lead]
callhome.iscsi events are reported when the iSCSI host bus adapter (HBA crashes, and corrective actions typically involve following the documented corrective action guidance.
