...
[.lead]
Learn about disk.exceed EMS events, which report when This event is generated during disk qualification testing when READ/WRITE I/O requests exceed their expected maximum completion time.
