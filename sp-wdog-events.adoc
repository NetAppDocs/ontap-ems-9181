...
[.lead]
sp.wdog events are reported when oNTAP(R) software fails to disable or enable the service-processor' (SP or BMC) watchdog timer, and corrective actions typically involve following the documented corrective action guidance.
