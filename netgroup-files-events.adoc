...
[.lead]
Learn about netgroup.files EMS events, which report when a netgroup lookup request finds that files is specified as a ns-switch source, but a netgroup file cannot be found.
