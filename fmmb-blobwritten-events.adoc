...
[.lead]
fmmb.blobwritten events are reported when a mailbox 'blob' write to the on-disk mailbox data structure succeeds, and corrective actions typically involve following the documented corrective action guidance.
