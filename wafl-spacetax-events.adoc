...
[.lead]
Learn about wafl.spacetax EMS events, which report when the spacetax feature is disabled for all flexible volumes in the system due to the 'wafl-disable-spacetax?' boot option.
