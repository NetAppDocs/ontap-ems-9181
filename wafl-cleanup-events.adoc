...
[.lead]
wafl.cleanup events are reported when this message occurs after WAFL(R) completes the post-giveback cleanup, and corrective actions typically involve following the documented corrective action guidance.
