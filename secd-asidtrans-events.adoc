...
[.lead]
secd.asidtrans events are reported when oNTAP(R) software cannot translate an abbreviated SID to a Windows SID, and corrective actions typically involve contacting NetApp technical support.
