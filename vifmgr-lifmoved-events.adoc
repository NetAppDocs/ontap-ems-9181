...
[.lead]
vifmgr.lifmoved events are reported when an administrator action causes a logical interface (LIF) IP address to move to another node/port, and corrective actions typically involve following the documented corrective action guidance.
