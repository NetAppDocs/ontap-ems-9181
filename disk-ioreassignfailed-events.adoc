...
[.lead]
disk.ioreassignfailed events are reported when a disk reports a medium error and the sector reassignment fails, and corrective actions typically involve following the documented corrective action guidance.
