...
[.lead]
adminapi.xml events are reported when this event is generated in case of a mismatched XML encoding received by ONTAP server, and corrective actions typically involve following the documented corrective action guidance.
