...
[.lead]
Learn about platform.dimmconfigerror EMS events, which report when the DIMM configuration of the controller is different from the configuration supported by this model.
