...
[.lead]
sis.revert events are reported when the Single Instance Storage (SIS) volume command 'sis revert_to' has failed, and corrective actions typically involve following the documented corrective action guidance.
