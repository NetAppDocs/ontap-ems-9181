...
[.lead]
disk.lostwritedetected events are reported when the system detects a lost write, and corrective actions typically involve following the documented corrective action guidance.
