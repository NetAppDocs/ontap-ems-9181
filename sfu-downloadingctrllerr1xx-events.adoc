...
[.lead]
sfu.downloadingctrllerr1xx events are reported when a disk shelf firmware download starts on a particular disk shelf, and corrective actions typically involve following the documented corrective action guidance.
