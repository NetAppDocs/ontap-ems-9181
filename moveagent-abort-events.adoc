...
[.lead]
Learn about moveagent.abort EMS events, which report when This event is issued during volume move when cutover is aborted because the volume took too long to replicate.
