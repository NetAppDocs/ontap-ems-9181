...
[.lead]
mcc.sb events are reported when dump/restore is aborted during a MetroCluster switchback operation, and corrective actions typically involve following the documented corrective action guidance.
