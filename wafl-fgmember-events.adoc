...
[.lead]
Learn about wafl.fgmember EMS events, which report when a member of a FlexGroup experiences an unexpected rollback in its state due to a loss of the NVRAM log for the member.
