...
[.lead]
disk.lipstormdetect events are reported when a Fibre Channel disk detects a large number of Loop Initialization Procedure requests (a LIP storm) and has reset itself, and no corrective action is typically required.
