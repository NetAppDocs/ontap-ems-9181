...
[.lead]
Learn about disk.lipstormdetect EMS events, which report when a Fibre Channel disk detects a large number of Loop Initialization Procedure requests (a LIP storm) and has reset itself.
