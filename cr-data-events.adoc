...
[.lead]
cr.data events are reported when the namespace scanner skips an inode for which it cannot access the data file, and corrective actions typically involve following the documented corrective action guidance.
