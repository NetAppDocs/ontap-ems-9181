...
[.lead]
cpeer.create events are reported when a peer cluster reciprocal join fails, and corrective actions typically involve verifying the reported configuration and health state.
