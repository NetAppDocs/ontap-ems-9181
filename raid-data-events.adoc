...
[.lead]
raid.data events are reported when a WAFL(R) generated read detects a stale block due to a lost write, and corrective actions typically involve following the documented corrective action guidance.
