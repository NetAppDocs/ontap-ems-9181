...
[.lead]
Learn about ha.netparttodisabled EMS events, which report when takeovers due to network partitioning are disabled due to the number of previous, consecutive, network-partition takeovers that occurred within a preceding detection period.
