...
[.lead]
fg.recover events are reported when the recovery of a FlexGroup volume back into a FlexVol(R) fails, and corrective actions typically involve ensuring the required configuration and resources are in place.
