...
[.lead]
sysconfig.sysconfigtab events are reported when this event is issued when the sysconfigtab file cannot be opened, and corrective actions typically involve following the documented corrective action guidance.
