...
[.lead]
ucore.error events are reported when there is an error while processing a user space core dump, and corrective actions typically involve contacting NetApp technical support.
