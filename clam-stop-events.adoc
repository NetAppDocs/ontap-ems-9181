...
[.lead]
clam.stop events are reported when the Kernel Cluster Services (KCS) Connectivity, Liveliness, Availability Monitor (CLAM) has stopped polling the CLAM mailboxes, and corrective actions typically involve following the documented corrective action guidance.
