...
[.lead]
ccma.quota events are reported when a datastore has been orphaned due to the system not having sufficient memory to keep track of it in the quota system, and corrective actions typically involve following the documented corrective action guidance.
