...
[.lead]
useradmin.registry events are reported when the system encounters an internal registry error while reading the useradmin entries, and corrective actions typically involve following the documented corrective action guidance.
