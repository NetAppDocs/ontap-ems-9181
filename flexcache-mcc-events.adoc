...
[.lead]
flexcache.mcc events are reported when a FlexCache(R) configuration refresh operation fails during MetroCluster(tm) switchover and switchback, and corrective actions typically involve following the documented corrective action guidance.
