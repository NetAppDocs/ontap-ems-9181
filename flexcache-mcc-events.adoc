...
[.lead]
Learn about flexcache.mcc EMS events, which report when a FlexCache(R) configuration refresh operation fails during MetroCluster(tm) switchover and switchback.
