...
[.lead]
callhome.kernel events are reported when you invoke an AutoSupport for kernel coredump files, and corrective actions typically involve following the documented corrective action guidance.
