...
[.lead]
cpeer.pp events are reported when an incoming cluster peer authentication request fails due to a passphrase mismatch, and corrective actions typically involve following the documented corrective action guidance.
