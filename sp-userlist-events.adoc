...
[.lead]
sp.userlist events are reported when there is an error updating user information for the Service Processor (SP), and corrective actions typically involve following the documented corrective action guidance.
