...
[.lead]
dm.vserver events are reported when resynchronization of the Vserver configuration failed in a MetroCluster(tm) configuration, and corrective actions typically involve following the documented corrective action guidance.
