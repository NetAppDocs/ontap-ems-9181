...
[.lead]
vifmgr.vifidmissing events are reported when a LIF ID, associated with a particular storage virtual machine (SVM), is configured in the VIFMgr but is missing in the vifids UI table, and corrective actions typically involve contacting NetApp technical support.
