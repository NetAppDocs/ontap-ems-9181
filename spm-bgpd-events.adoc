...
[.lead]
spm.bgpd events are reported when the Border Gateway Protocol daemon (bgpd) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
