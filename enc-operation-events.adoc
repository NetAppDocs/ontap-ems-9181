...
[.lead]
enc.operation events are reported when rekey or conversion to encryption operation is completed in a flexible volume, and corrective actions typically involve following the documented corrective action guidance.
