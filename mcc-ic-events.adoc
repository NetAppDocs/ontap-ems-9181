...
[.lead]
mcc.ic events are reported when the MetroCluster(tm) config module receives a node advertisement from any of its partners, and corrective actions typically involve following the documented corrective action guidance.
