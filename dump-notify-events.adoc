...
[.lead]
dump.notify events are reported when the dump incremental backup might be incomplete, and corrective actions typically involve following the documented corrective action guidance.
