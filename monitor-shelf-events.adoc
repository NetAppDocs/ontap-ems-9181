...
[.lead]
monitor.shelf events are reported when the monitor detects that a disk shelf access error has occurred, and corrective actions typically involve checking the reported configuration and connectivity.
