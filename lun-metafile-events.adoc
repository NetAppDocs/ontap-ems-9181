...
[.lead]
lun.metafile events are reported when lun metafile directory creation failed, and corrective actions typically involve checking the reported configuration and connectivity.
