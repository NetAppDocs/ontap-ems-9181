...
[.lead]
fmmb.payload events are reported when this event is issued when the outbound FM payload area is found to be corrupted, and corrective actions typically involve following the documented corrective action guidance.
