...
[.lead]
monitor.mismatch events are reported when the version of ONTAP(R) is not supported on this hardware, and corrective actions typically involve following the documented corrective action guidance.
