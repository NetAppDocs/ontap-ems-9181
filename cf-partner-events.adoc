...
[.lead]
cf.partner events are reported when this event is issued when a login to the console of the partner occurs as a result of the 'partner' command being issued with no arguments, and corrective actions typically involve following the documented corrective action guidance.
