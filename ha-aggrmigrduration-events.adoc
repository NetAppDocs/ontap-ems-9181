...
[.lead]
ha.aggrmigrduration events are reported when this message occurs every 60 seconds during an aggregate migration operation, and corrective actions typically involve following the documented corrective action guidance.
