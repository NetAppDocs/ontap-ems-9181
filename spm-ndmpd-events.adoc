...
[.lead]
spm.ndmpd events are reported when the Network Data Management Protocol (NDMP) server (ndmpd) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
