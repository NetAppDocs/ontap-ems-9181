...
[.lead]
hm.alert events are reported when a system health monitor alert is successfully cleared, and corrective actions typically involve following the documented corrective action guidance.
