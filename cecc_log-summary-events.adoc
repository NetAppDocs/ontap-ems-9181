...
[.lead]
cecc_log.summary events are reported when the ECC error logger reports its periodic summary of new correctable ECC errors that occurred after the last report and the total number of ECC errors that occurred since boot, and corrective actions typically involve following the documented corrective action guidance.
