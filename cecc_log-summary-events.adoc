...
[.lead]
Learn about cecc_log.summary EMS events, which report when the ECC error logger reports its periodic summary of new correctable ECC errors that occurred after the last report and the total number of ECC errors that occurred since boot.
