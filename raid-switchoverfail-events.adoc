...
[.lead]
Learn about raid.switchoverfail EMS events, which report when a MetroCluster(tm) switchover attempt fails due to an error detected during RAID assimilation.
