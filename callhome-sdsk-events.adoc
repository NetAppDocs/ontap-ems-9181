...
[.lead]
callhome.sdsk events are reported when you fail a hot spare disk drive, and corrective actions typically involve following the documented corrective action guidance.
