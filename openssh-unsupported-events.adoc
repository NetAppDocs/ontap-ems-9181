...
[.lead]
openssh.unsupported events are reported when an unsupported cipher is used while attempting an SSH connection, and corrective actions typically involve following the documented corrective action guidance.
