...
[.lead]
fg.writeback events are reported when an inconsistency is discovered during a writeback, and corrective actions typically involve following the documented corrective action guidance.
