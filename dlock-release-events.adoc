...
[.lead]
dlock.release events are reported when oNTAP(R) software reports an error while attempting to release an internal lock, and corrective actions typically involve following the documented corrective action guidance.
