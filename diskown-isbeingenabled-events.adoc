...
[.lead]
Learn about diskown.isbeingenabled EMS events, which report when This event is issued when the system is being converted from non-software based disk ownership to software based disk ownership.
