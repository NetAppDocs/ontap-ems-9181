...
[.lead]
snaplock.legal events are reported when this message occurs on completion of a legal-hold dump-files operation on a SnapLock(R) compliance volume, and corrective actions typically involve following the documented corrective action guidance.
