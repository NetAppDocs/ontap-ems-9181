...
[.lead]
Learn about adminapi.input EMS events, which report when the Data ONTAP server receives a bad XML request that does not contain the API name to be executed.
