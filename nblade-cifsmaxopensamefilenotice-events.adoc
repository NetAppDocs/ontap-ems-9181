...
[.lead]
nblade.cifsmaxopensamefilenotice events are reported when the number of open instances of a particular file under a CIFS tree nears the configuration limit, and corrective actions typically involve following the documented corrective action guidance.
