...
[.lead]
Learn about nblade.cifsmaxopensamefilenotice EMS events, which report when the number of open instances of a particular file under a CIFS tree nears the configuration limit.
