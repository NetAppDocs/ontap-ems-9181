...
[.lead]
repl.out events are reported when replication source is asked to send certain blocks out of band because the replica volume did a snapshot restore, and corrective actions typically involve following the documented corrective action guidance.
