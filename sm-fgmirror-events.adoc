...
[.lead]
sm.fgmirror events are reported when improper group workflow cleanup caused the subsequent SnapMirror(R) operation to fail, and corrective actions typically involve following the documented corrective action guidance.
