...
[.lead]
ses.inconsistent events are reported when the system detects an inconsistent configuration of shelf-to-channel connections, and corrective actions typically involve verifying the reported configuration and health state.
