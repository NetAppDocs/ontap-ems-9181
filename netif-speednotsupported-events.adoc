...
[.lead]
netif.speednotsupported events are reported when a network interface autonegotiates to an unsupported speed, and corrective actions typically involve following the documented corrective action guidance.
