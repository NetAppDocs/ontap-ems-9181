...
[.lead]
config.mirrorscsidisk events are reported when a SCSI disk is found in a SyncMirror(R) configuration, and corrective actions typically involve following the documented corrective action guidance.
