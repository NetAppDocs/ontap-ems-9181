...
[.lead]
Learn about cf.multidisk EMS events, which report when the node is waiting for the partner to take over, after the node encounters a multidisk error or some other fatal error.
