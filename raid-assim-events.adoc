...
[.lead]
raid.assim events are reported when adding an offline disk into a raidtree, and corrective actions typically involve following the documented corrective action guidance.
