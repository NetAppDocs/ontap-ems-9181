...
[.lead]
mgmt.fpolicy events are reported when a Vserver administrator disables an FPolicy(R) policy, and corrective actions typically involve following the documented corrective action guidance.
