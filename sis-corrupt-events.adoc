...
[.lead]
Learn about sis.corrupt EMS events, which report when a Single Instance Storage (SIS) metafile is deleted because there are Disk/Media errors affecting the file.
