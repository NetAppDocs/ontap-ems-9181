...
[.lead]
sis.corrupt events are reported when a Single Instance Storage (SIS) metafile is deleted because there are Disk/Media errors affecting the file, and corrective actions typically involve following the documented corrective action guidance.
