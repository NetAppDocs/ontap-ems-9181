...
[.lead]
nblade.vscanvirusdetected events are reported when a vscan server reports an error to the storage system, and corrective actions typically involve checking the reported configuration and connectivity.
