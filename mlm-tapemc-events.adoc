...
[.lead]
mlm.tapemc events are reported when the system discovers a new tape or media changer logical unit (Tape/MC LUN) reported by a tape library, and corrective actions typically involve following the documented corrective action guidance.
