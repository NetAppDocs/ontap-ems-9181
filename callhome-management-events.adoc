...
[.lead]
callhome.management events are reported when the MANAGEMENT_LOG AutoSupport or 'call home' event is sent, and corrective actions typically involve following the documented corrective action guidance.
