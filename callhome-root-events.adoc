...
[.lead]
callhome.root events are reported when the root volume is not working properly and its recovery is required, and corrective actions typically involve contacting NetApp technical support.
