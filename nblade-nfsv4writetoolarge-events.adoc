...
[.lead]
nblade.nfsv4writetoolarge events are reported when a client attempts to write over NFSv4 with an amount of data that is greater than the maximum allowed TCP transfer size, and corrective actions typically involve following the documented corrective action guidance.
