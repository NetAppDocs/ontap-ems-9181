...
[.lead]
monitor.cluster events are reported when the cluster is full after consuming space beyond the threshold value, and corrective actions typically involve following the documented corrective action guidance.
