...
[.lead]
disk.partition events are reported when the disk partition layout contains more partitions than are supported by the system, and corrective actions typically involve following the documented corrective action guidance.
