...
[.lead]
Learn about ha.resvmediatormbxstatus EMS events, which report when the local node attempts to reserve a mailbox disk while trying to acquire the takeover lock as part of the takeover operation.
