...
[.lead]
flexcache.cachedisconnected events are reported when a FlexCache(R) origin volume cannot communicate with its cache volume, and corrective actions typically involve verifying the reported configuration and health state.
