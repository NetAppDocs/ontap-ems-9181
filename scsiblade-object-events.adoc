...
[.lead]
scsiblade.object events are reported when a SAN management event receives a timeout error due to network congestion in the system and all efforts of recovery fail, and corrective actions typically involve contacting NetApp technical support.
