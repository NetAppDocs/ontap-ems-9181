...
[.lead]
vol.registryget events are reported when a registry request finds no 512 or 520 BPS (bytes per sector) disks, and corrective actions typically involve following the documented corrective action guidance.
