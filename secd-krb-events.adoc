...
[.lead]
secd.krb events are reported when kerberos S4U2self (Service for User to Self) operation fails, and corrective actions typically involve following the documented corrective action guidance.
