...
[.lead]
bridge.removed events are reported when an FC-to-SAS bridge is removed from the system, and corrective actions typically involve following the documented corrective action guidance.
