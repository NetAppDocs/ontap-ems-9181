...
[.lead]
sk.ring events are reported when a module detected a condition that warranted dumping the internal tracing buffer to a file, and corrective actions typically involve following the documented corrective action guidance.
