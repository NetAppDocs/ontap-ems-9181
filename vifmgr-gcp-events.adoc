...
[.lead]
vifmgr.gcp events are reported when the network load balancing listener becomes unresponsive, and corrective actions typically involve rebooting the node or cluster component.
