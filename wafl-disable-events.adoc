...
[.lead]
Learn about wafl.disable EMS events, which report when the volume guarantee of a flexible volume is disabled due to aggregate space being physically overallocated.
