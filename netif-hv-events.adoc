...
[.lead]
netif.hv events are reported when the heartbeat between hypervisor and the guest virtual machine (VM) fails, and corrective actions typically involve rebooting the node or cluster component.
