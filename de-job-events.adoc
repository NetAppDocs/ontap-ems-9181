...
[.lead]
de.job events are reported when a job in AIDP fails to complete successfully, and corrective actions typically involve checking the reported configuration and connectivity.
