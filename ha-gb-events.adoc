...
[.lead]
ha.gb events are reported when a mailbox disk cannot be accessed prior to a giveback, and corrective actions typically involve verifying the reported configuration and health state.
