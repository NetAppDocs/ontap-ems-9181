...
[.lead]
callhome.raid events are reported when auto-partitioning for root aggregate creation is disabled on a system, and corrective actions typically involve following the documented corrective action guidance.
