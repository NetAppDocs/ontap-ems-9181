...
[.lead]
config.badswitchlocal events are reported when a disk is found to be attached locally, but there are also disks attached via switches, and corrective actions typically involve following the documented corrective action guidance.
