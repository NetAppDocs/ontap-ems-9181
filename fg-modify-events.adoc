...
[.lead]
fg.modify events are reported when a user modifies the workflow type of a FlexGroup volume, and corrective actions typically involve following the documented corrective action guidance.
