...
[.lead]
sfu.partnerinaccessible events are reported when this message occurs in a high-availability (HA) configuration in which communication between partner nodes cannot be established, and corrective actions typically involve verifying the reported configuration and health state.
