...
[.lead]
Learn about sfu.partnerinaccessible EMS events, which report when This message occurs in a high-availability (HA) configuration in which communication between partner nodes cannot be established.
