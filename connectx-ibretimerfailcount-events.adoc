...
[.lead]
Learn about connectx.ibretimerfailcount EMS events, which report when InfiniBand retimer programming fails due to one of the following reasons: InfiniBand device not found, GPIO read failure or retimer chip failure.
