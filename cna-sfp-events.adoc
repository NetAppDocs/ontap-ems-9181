...
[.lead]
Learn about cna.sfp EMS events, which report when the converged network adapter (CNA) detects an unsupported small form-factor Pluggable (SFP) in the adapter.
