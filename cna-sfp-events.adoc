...
[.lead]
cna.sfp events are reported when the converged network adapter (CNA) detects an unsupported small form-factor Pluggable (SFP) in the adapter, and corrective actions typically involve following the documented corrective action guidance.
