...
[.lead]
netgroupbyname.cache events are reported when a host is checked for its membership in a netgroup that contains a large number of members, and corrective actions typically involve following the documented corrective action guidance.
