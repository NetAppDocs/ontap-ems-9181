...
[.lead]
Learn about netgroupbyname.cache EMS events, which report when a host is checked for its membership in a netgroup that contains a large number of members.
