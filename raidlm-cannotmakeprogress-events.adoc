...
[.lead]
raidlm.cannotmakeprogress events are reported when a system does not contain enough spares to correct existing disk failures or misconfigurations, and corrective actions typically involve following the documented corrective action guidance.
