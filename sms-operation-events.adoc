...
[.lead]
Learn about sms.operation EMS events, which report when a blacklisted operation is performed on the primary volume of a SnapMirror(R) Sync relationship when the relationship status is "Transitioning".
