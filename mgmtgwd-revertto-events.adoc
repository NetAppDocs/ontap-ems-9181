...
[.lead]
mgmtgwd.revertto events are reported when a revert to process is being initiated with the "force" flag, and configuration errors have been detected, and corrective actions typically involve following the documented corrective action guidance.
