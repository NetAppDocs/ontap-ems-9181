...
[.lead]
Learn about mgmtgwd.revertto EMS events, which report when a revert to process is being initiated with the "force" flag, and configuration errors have been detected.
