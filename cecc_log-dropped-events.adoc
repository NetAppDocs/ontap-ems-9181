...
[.lead]
cecc_log.dropped events are reported when the ECC error logger dropped some correctable ECC errors without logging them, and corrective actions typically involve following the documented corrective action guidance.
