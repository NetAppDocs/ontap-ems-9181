...
[.lead]
callhome.hba events are reported when a HBA port is taken offline due to read-after-write verification errors, and corrective actions typically involve following the documented corrective action guidance.
