...
[.lead]
smc.restore events are reported when a SnapMirror restore operation or a SnapMirror restore cleanup operation fails to cleanup a SnapMirror restore source relationship information, and corrective actions typically involve following the documented corrective action guidance.
