...
[.lead]
Learn about smc.restore EMS events, which report when a SnapMirror restore operation or a SnapMirror restore cleanup operation fails to cleanup a SnapMirror restore source relationship information.
