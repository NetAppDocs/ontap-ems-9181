...
[.lead]
spm.ktlsd events are reported when the Kernel Transport Layer Security Daemon support process (ktlsd) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
