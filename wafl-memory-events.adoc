...
[.lead]
wafl.memory events are reported when this message occurs periodically to inform the administrator about the amount of WAFL memory that is currently available, and corrective actions typically involve following the documented corrective action guidance.
