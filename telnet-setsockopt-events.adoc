...
[.lead]
telnet.setsockopt events are reported when setsockopt on telnet socket fails, and corrective actions typically involve following the documented corrective action guidance.
