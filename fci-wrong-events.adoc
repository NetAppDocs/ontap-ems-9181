...
[.lead]
fci.wrong events are reported when the fixed speed level requested by the fc-force-XG-ports bootarg is out of range for the corresponding FC port, and corrective actions typically involve following the documented corrective action guidance.
