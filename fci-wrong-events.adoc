...
[.lead]
Learn about fci.wrong EMS events, which report when the fixed speed level requested by the fc-force-XG-ports bootarg is out of range for the corresponding FC port.
