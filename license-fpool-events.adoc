...
[.lead]
license.fpool events are reported when the maximum storage capacity limit for FabricPool is changed, and corrective actions typically involve following the documented corrective action guidance.
