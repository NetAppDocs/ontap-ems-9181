...
[.lead]
wafl.gd events are reported when reserving allocation size fails for a file using granular data because there is no space available in the volume, and corrective actions typically involve following the documented corrective action guidance.
