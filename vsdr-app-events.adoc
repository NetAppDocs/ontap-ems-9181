...
[.lead]
Learn about vsdr.app EMS events, which report when This message occurs during the configuration replication phase of a Vserver DR transfer when the consistency group that the system is trying to replicate already exists in the cluster on a different Vserver.
