...
[.lead]
diskown.autoassignproblem events are reported when data ONTAP(R) attempts to assign a disk automatically, but the request fails, and corrective actions typically involve following the documented corrective action guidance.
