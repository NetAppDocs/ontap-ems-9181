...
[.lead]
Learn about netif.autonegfailed EMS events, which report when autonegotiation fails and the interface is operating at half-duplex, which might not be the desired mode.
