...
[.lead]
fm.cpuutilduringtransition events are reported when this message occurs during various failover and aggregate mobility events, including start of a takeover, end of a successful takeover, start of root aggregate giveback, after completion of data aggregate giveback and completion of an aggregate relocation, and corrective actions typically involve following the documented corrective action guidance.
