...
[.lead]
Learn about fm.cpuutilduringtransition EMS events, which report when This message occurs during various failover and aggregate mobility events, including start of a takeover, end of a successful takeover, start of root aggregate giveback, after completion of data aggregate giveback and completion of an aggregate relocation.
