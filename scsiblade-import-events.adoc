...
[.lead]
scsiblade.import events are reported when attributes of a SAN LUN under LUN import are modified, and corrective actions typically involve following the documented corrective action guidance.
