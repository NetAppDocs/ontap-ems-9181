...
[.lead]
repl.switch events are reported when the average Op Latency increases beyond the threshold value in parallel splitting mode, and corrective actions typically involve following the documented corrective action guidance.
