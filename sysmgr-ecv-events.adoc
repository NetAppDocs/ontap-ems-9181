...
[.lead]
sysmgr.ecv events are reported when acquiring the desired Effective Cluster Version (ECV) of System Manager was not accomplished within the time limit, and corrective actions typically involve following the documented corrective action guidance.
