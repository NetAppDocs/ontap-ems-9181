...
[.lead]
sfo.tkovertoclusterwait events are reported when a node whose M-host applications have not fully stabilized initiates a takeover followed by a giveback to its high-availability (HA) partner, and corrective actions typically involve contacting NetApp technical support.
