...
[.lead]
callhome.wafl events are reported when this message occurs after a WAFL(R) check (wack) operation runs, and corrective actions typically involve checking the reported configuration and connectivity.
