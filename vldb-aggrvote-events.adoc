...
[.lead]
Learn about vldb.aggrvote EMS events, which report when a row of the aggr vote table is not replicated to the local table when an update is received from the remote cluster.
