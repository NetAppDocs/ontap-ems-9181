...
[.lead]
Learn about secd.rogue EMS events, which report when a CIFS authentication request fails more than 30 times in one minute with an invalid login password from a particular client.
