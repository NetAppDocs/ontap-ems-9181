...
[.lead]
auto.cds events are reported when this message occurs during upgrade to Data ONTAP(R) 9, and corrective actions typically involve following the documented corrective action guidance.
