...
[.lead]
coredump.dr events are reported when coredump subsystem detects that disaster recovery (DR) partner sparecore dump did not start, and corrective actions typically involve following the documented corrective action guidance.
