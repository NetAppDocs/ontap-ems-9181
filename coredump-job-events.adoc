...
[.lead]
coredump.job events are reported when the system cannot automatically save a core, and corrective actions typically involve following the documented corrective action guidance.
