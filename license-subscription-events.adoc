...
[.lead]
license.subscription events are reported when your Cloud ONTAP(R) license subscription has expired but may still be renewed, and corrective actions typically involve contacting NetApp technical support.
