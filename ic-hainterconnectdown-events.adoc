...
[.lead]
ic.hainterconnectdown events are reported when this message occurs every hour when the high-availability (HA) interconnect is down, and corrective actions typically involve following the documented corrective action guidance.
