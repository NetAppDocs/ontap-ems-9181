...
[.lead]
s3.schedsnap events are reported when the system fails to create a scheduled S3 bucket snapshot for the given S3 bucket, and corrective actions typically involve following the documented corrective action guidance.
