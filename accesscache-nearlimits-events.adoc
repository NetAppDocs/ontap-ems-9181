...
[.lead]
accesscache.nearlimits events are reported when the access cache module is near its limit for entries, and corrective actions typically involve ensuring the required configuration and resources are in place.
