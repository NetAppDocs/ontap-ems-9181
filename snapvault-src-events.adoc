...
[.lead]
snapvault.src events are reported when a SnapVault(R) source appliance receives a transfer request when the service is not enabled, and corrective actions typically involve following the documented corrective action guidance.
