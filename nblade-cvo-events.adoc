...
[.lead]
nblade.cvo events are reported when a remote volume has been accessed in the Cloud Volumes ONTAP(R) environment, and corrective actions typically involve following the documented corrective action guidance.
