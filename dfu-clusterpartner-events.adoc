...
[.lead]
Learn about dfu.clusterpartner EMS events, which report when automatic firmware download is performed as part of system boot and partner disks are downrev.
