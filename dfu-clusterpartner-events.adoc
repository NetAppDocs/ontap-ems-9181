...
[.lead]
dfu.clusterpartner events are reported when automatic firmware download is performed as part of system boot and partner disks are downrev, and corrective actions typically involve following the documented corrective action guidance.
