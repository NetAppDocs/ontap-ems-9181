...
[.lead]
asup.post events are reported when the AutoSupport(R) mechanism quits trying to post to the NetApp URL after having retried for the specified number of times, and corrective actions typically involve following the documented corrective action guidance.
