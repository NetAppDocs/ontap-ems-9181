...
[.lead]
Learn about asup.post EMS events, which report when the AutoSupport(R) mechanism quits trying to post to the NetApp URL after having retried for the specified number of times.
