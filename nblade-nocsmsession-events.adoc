...
[.lead]
nblade.nocsmsession events are reported when the local node could not acquire a Connection Session Manager (CSM) session, and corrective actions typically involve checking the reported configuration and connectivity.
