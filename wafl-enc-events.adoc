...
[.lead]
wafl.enc events are reported when the system detects a corrupted WAFL aggregate encryption keys metafile and creates a corrected replacement, and corrective actions typically involve following the documented corrective action guidance.
