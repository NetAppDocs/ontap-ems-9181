...
[.lead]
wafl.seclabel events are reported when the mutual exclusion has failed between the SnapMirror Synchronous and NFS v4, and corrective actions typically involve following the documented corrective action guidance.
