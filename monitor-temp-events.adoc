...
[.lead]
monitor.temp events are reported when the controller module temperature is not readable, and corrective actions typically involve following the documented corrective action guidance.
