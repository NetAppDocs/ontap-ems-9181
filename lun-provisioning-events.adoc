...
[.lead]
Learn about lun.provisioning EMS events, which report when This message occurs during the creation of a LUN or NVME namespace when the provisioning for its metadata fails due to insufficient space in the aggregate.
