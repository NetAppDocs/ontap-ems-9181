...
[.lead]
disk.cksum events are reported when the system detects a block number mismatch during disk checksum verification, and corrective actions typically involve following the documented corrective action guidance.
