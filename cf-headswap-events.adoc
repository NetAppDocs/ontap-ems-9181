...
[.lead]
cf.headswap events are reported when the headswap on the partner node is aborted, and corrective actions typically involve following the documented corrective action guidance.
