...
[.lead]
fg.admin events are reported when the data component takes longer than 15 seconds to update its view of the FlexGroup volume after an admin operation, and corrective actions typically involve following the documented corrective action guidance.
