...
[.lead]
Learn about fg.admin EMS events, which report when the data component takes longer than 15 seconds to update its view of the FlexGroup volume after an admin operation.
