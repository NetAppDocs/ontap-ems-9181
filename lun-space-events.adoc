...
[.lead]
lun.space events are reported when the space reservation settings for the named volume are not honored in its containing aggregate, and corrective actions typically involve following the documented corrective action guidance.
