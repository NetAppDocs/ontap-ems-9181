...
[.lead]
shelf.reset events are reported when oNTAP(R) software resets the error counters on a disk shelf module, and corrective actions typically involve following the documented corrective action guidance.
