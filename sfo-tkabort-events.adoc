...
[.lead]
Learn about sfo.tkabort EMS events, which report when the destination node cannot contact the object stores during the planned takeover of a FabricPool aggregate.
