...
[.lead]
sfo.tkabort events are reported when the destination node cannot contact the object stores during the planned takeover of a FabricPool aggregate, and corrective actions typically involve verifying the reported configuration and health state.
