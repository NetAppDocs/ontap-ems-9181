...
[.lead]
repl.space events are reported when the attempt to change space guarantee type fails on the destination volume, and corrective actions typically involve following the documented corrective action guidance.
