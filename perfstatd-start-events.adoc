...
[.lead]
perfstatd.start events are reported when the perfstat daemon (perfstatd) startup fails, and corrective actions typically involve following the documented corrective action guidance.
