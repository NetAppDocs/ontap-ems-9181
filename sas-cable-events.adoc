...
[.lead]
sas.cable events are reported when the cable attached to SAS (Serial Attached SCSI) adapter port is functioning in a degraded mode, and corrective actions typically involve following the documented corrective action guidance.
