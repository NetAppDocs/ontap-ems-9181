...
[.lead]
mpt.action events are reported when the system bus is reset in the message processing technology (MPT) adapter driver, and corrective actions typically involve following the documented corrective action guidance.
