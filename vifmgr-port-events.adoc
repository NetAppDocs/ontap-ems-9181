...
[.lead]
vifmgr.port events are reported when a physical network port has been discovered, and corrective actions typically involve following the documented corrective action guidance.
