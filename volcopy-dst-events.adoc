...
[.lead]
volcopy.dst events are reported when this event is issued when a vol copy start is issued on a volume which is offline, and corrective actions typically involve following the documented corrective action guidance.
