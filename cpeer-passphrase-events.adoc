...
[.lead]
Learn about cpeer.passphrase EMS events, which report when the cluster peer offer for anonymous cluster with system-generated passphrase expired and deleted.
