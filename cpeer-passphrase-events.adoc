...
[.lead]
cpeer.passphrase events are reported when the cluster peer offer for anonymous cluster with system-generated passphrase expired and deleted, and corrective actions typically involve following the documented corrective action guidance.
