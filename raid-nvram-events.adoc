...
[.lead]
raid.nvram events are reported when rAID NVRAM contains some bad entries, and corrective actions typically involve following the documented corrective action guidance.
