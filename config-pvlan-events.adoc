...
[.lead]
config.pvlan events are reported when a pseudo-VLAN port is created, and corrective actions typically involve following the documented corrective action guidance.
