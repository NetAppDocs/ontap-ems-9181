...
[.lead]
Learn about esh.unable EMS events, which report when a disk shelf cannot be added due to a memory allocation failure during disk shelf discovery processing.
