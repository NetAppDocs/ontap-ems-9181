...
[.lead]
esh.unable events are reported when a disk shelf cannot be added due to a memory allocation failure during disk shelf discovery processing, and corrective actions typically involve following the documented corrective action guidance.
