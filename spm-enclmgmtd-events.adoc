...
[.lead]
spm.enclmgmtd events are reported when the Enclosure Management Daemon (enclmgmtd) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
