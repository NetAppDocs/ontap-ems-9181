...
[.lead]
upgrademgr.lifmigrate events are reported when an ONTAP automated nondisruptive upgrade (ANDU) of ONTAP finishes the data LIF migration or failover stage, and corrective actions typically involve following the documented corrective action guidance.
