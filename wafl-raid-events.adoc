...
[.lead]
wafl.raid events are reported when this message occurs during an aggregate transition workflow when an aggregate snapshot created in a 7-Mode environment is missing, and corrective actions typically involve following the documented corrective action guidance.
