...
[.lead]
fci.link events are reported when the Fibre Channel adapter detects a break in the link, and corrective actions typically involve following the documented corrective action guidance.
