...
[.lead]
Learn about sfu.sasdownloadfailed EMS events, which report when a disk shelf firmware update fails to download disk shelf firmware to a disk shelf successfully.
