...
[.lead]
xinetd.hit events are reported when the rate of incoming network connections for a service exceeds the maximum allowed rate, and corrective actions typically involve following the documented corrective action guidance.
