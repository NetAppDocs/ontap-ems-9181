...
[.lead]
mlm.scsi events are reported when an array target port contains SCSI INQUIRY data with an incorrect support level, and corrective actions typically involve verifying the reported configuration and health state.
