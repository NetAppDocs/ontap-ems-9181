...
[.lead]
cr.sync events are reported when an attempt to synchronize the ACL from data to redirector fails, and corrective actions typically involve following the documented corrective action guidance.
