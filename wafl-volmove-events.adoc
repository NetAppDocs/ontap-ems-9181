...
[.lead]
wafl.volmove events are reported when the active map delta file for a volume move destination is corrupt, and corrective actions typically involve following the documented corrective action guidance.
