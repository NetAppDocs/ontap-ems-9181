...
[.lead]
nblade.cifsencshraccessdenied events are reported when a client not capable of SMB encryption tries to connect to a CIFS share that requires SMB encryption, and corrective actions typically involve following the documented corrective action guidance.
