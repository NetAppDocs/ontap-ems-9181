...
[.lead]
certificate.insecure events are reported when an installed certificate uses a hash function that is no longer considered secure, and corrective actions typically involve following the documented corrective action guidance.
