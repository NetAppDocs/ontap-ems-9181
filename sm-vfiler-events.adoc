...
[.lead]
sm.vfiler events are reported when movement of the SnapMirror(R) status configuration from 'from' vFiler to 'to' vFiler fails, and corrective actions typically involve following the documented corrective action guidance.
