...
[.lead]
sfu.auto events are reported when oNTAP(R) software cannot automatically upgrade the firmware on a disk shelf because the hidden 'shelf, and corrective actions typically involve following the documented corrective action guidance.
