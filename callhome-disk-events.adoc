...
[.lead]
callhome.disk events are reported when a system does not contain enough spares to correct existing disk failures, and corrective actions typically involve following the documented corrective action guidance.
