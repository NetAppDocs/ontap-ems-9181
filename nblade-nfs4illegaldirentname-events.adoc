...
[.lead]
Learn about nblade.nfs4illegaldirentname EMS events, which report when a user attempts to list a directory over NFSv4 that contains an entry name with non UTF-8 characters.
