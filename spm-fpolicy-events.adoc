...
[.lead]
spm.fpolicy events are reported when the fpolicy involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
