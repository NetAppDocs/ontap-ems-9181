...
[.lead]
callhome.invoke events are reported when you invoke an AutoSupport(R) message, and the "type" of that message is set to "test", and corrective actions typically involve following the documented corrective action guidance.
