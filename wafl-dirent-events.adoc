...
[.lead]
Learn about wafl.dirent EMS events, which report when a user attempts to use a directory entry name that is not supported by the virtual server's language setting.
