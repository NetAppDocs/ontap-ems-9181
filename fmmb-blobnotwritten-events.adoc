...
[.lead]
fmmb.blobnotwritten events are reported when a mailbox 'blob' write operation to the on-disk mailbox data structure fails, and corrective actions typically involve following the documented corrective action guidance.
