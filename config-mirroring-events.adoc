...
[.lead]
config.mirroring events are reported when the name-service configuration is not replicated in the node, and corrective actions typically involve following the documented corrective action guidance.
