...
[.lead]
san.replicated events are reported when an unreplicated LUN becomes mapped to a replicated initiator group, and corrective actions typically involve following the documented corrective action guidance.
