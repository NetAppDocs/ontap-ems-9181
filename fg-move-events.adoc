...
[.lead]
fg.move events are reported when a user moves a FlexGroup constituent to an unmirrored aggregate on nodes in a MetroCluster(tm) configuration, and corrective actions typically involve following the documented corrective action guidance.
