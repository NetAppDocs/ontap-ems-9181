...
[.lead]
Learn about fg.move EMS events, which report when a user moves a FlexGroup constituent to an unmirrored aggregate on nodes in a MetroCluster(tm) configuration.
