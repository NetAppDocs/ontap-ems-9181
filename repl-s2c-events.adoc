...
[.lead]
repl.s2c events are reported when the checksum of an object's contents does not match with the expected checksum, and corrective actions typically involve following the documented corrective action guidance.
