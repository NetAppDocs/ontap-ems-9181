...
[.lead]
san.optimizedpersonality events are reported when a mismatch is detected between the san-optimized personality of a node and the cluster, and corrective actions typically involve contacting NetApp technical support.
