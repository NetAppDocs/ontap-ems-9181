...
[.lead]
Learn about san.optimizedpersonality EMS events, which report when a mismatch is detected between the san-optimized personality of a node and the cluster.
