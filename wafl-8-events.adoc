...
[.lead]
wafl.8 events are reported when wAFL(R) unexpectedly encounters a Data ONTAP(R) 8, and corrective actions typically involve following the documented corrective action guidance.
