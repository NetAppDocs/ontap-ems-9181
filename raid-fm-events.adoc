...
[.lead]
raid.fm events are reported when this event contains summary information for the disaster takeover, and corrective actions typically involve following the documented corrective action guidance.
