...
[.lead]
callhome.sp events are reported when oNTAP(R) does not receive an expected "heartbeat" signal from the Service Processor (SP), and corrective actions typically involve contacting NetApp technical support.
