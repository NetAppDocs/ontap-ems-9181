...
[.lead]
lun.inconsistent events are reported when the block containing a LUN or NVMe namespace's attributes is found to be inconsistent, and corrective actions typically involve following the documented corrective action guidance.
