...
[.lead]
callhome.svm events are reported when a Vserver migration failed to be aborted, and corrective actions typically involve following the documented corrective action guidance.
