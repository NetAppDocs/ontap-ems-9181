...
[.lead]
lun.restore events are reported when the SFSR (Single File SnapRestore(R)) for a LUN or NVMe namespace is complete, and corrective actions typically involve following the documented corrective action guidance.
