...
[.lead]
Learn about siw.pollingenablefailed EMS events, which report when SW-iWARP device polling cannot be enabled during the boot-up and SW-iWARP will be running in a degraded state.
