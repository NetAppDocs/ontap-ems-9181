...
[.lead]
sfu.downloadsuccess events are reported when disk shelf firmware updates successfully, and corrective actions typically involve following the documented corrective action guidance.
