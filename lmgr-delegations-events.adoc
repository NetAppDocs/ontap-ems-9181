...
[.lead]
Learn about lmgr.delegations EMS events, which report when a lock manager WAN FlexCache(R) delegation object cannot be allocated due to reaching the limit for WAN FlexCache delegation objects in the associated pool.
