...
[.lead]
dump.xfercomplete events are reported when the dump engine completes data backup with disk errors in user files, and corrective actions typically involve contacting NetApp technical support.
