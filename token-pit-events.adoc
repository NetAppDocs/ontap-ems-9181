...
[.lead]
token.pit events are reported when the token manager cannot create a PIT file in a volume, and corrective actions typically involve following the documented corrective action guidance.
