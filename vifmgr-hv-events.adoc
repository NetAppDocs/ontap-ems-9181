...
[.lead]
vifmgr.hv events are reported when no Hypervisor host configuration is available, and corrective actions typically involve verifying the reported configuration and health state.
