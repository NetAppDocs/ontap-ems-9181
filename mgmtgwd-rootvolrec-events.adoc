...
[.lead]
mgmtgwd.rootvolrec events are reported when the system detects that the root volume is dangerously low on space, and corrective actions typically involve contacting NetApp technical support.
