...
[.lead]
reg.file events are reported when the system registry file could not be created, and corrective actions typically involve following the documented corrective action guidance.
