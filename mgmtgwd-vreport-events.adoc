...
[.lead]
mgmtgwd.vreport events are reported when the 'debug vreport' command found that some nodes were unreachable, and corrective actions typically involve following the documented corrective action guidance.
