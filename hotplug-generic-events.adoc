...
[.lead]
hotplug.generic events are reported when a module replacement or removal command fails because the driver or system is busy, and corrective actions typically involve following the documented corrective action guidance.
