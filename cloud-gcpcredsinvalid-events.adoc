...
[.lead]
cloud.gcpcredsinvalid events are reported when the system acquires Google Cloud Platform (GCP) Service Account based credentials that are not valid, and corrective actions typically involve following the documented corrective action guidance.
