...
[.lead]
Learn about sis.clog EMS events, which report when This message occurs while mounting a volume, when an error with the SIS metafile operation results in the change logging function being disabled to avoid inconsistencies.
