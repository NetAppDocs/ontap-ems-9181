...
[.lead]
cachemirror.offline events are reported when cache Mirror encounters an error and has to be taken offline, and corrective actions typically involve rebooting the node or cluster component.
