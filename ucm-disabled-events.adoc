...
[.lead]
ucm.disabled events are reported when the Unified Target Adapter reads an invalid mode from flash memory, and corrective actions typically involve contacting NetApp technical support.
