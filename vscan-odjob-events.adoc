...
[.lead]
vscan.odjob events are reported when the system fails to delete queued Vscan On-Demand job, and corrective actions typically involve following the documented corrective action guidance.
