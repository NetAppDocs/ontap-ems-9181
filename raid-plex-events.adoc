...
[.lead]
raid.plex events are reported when disks in a plex do not have the same hardware-based pool, and corrective actions typically involve following the documented corrective action guidance.
