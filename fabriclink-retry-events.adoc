...
[.lead]
fabriclink.retry events are reported when object replication encounters an error when attempting to contact a remote object store, and corrective actions typically involve following the documented corrective action guidance.
