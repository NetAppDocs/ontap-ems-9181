...
[.lead]
mgmtgwd.schedsnap events are reported when the system fails to create a Snapshot(tm) copy for the given volume, and corrective actions typically involve following the documented corrective action guidance.
