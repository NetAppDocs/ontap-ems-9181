...
[.lead]
sis.fingerprint events are reported when a bad block is encountered while reading SIS metafiles, and corrective actions typically involve following the documented corrective action guidance.
