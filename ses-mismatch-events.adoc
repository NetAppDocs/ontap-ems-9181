...
[.lead]
Learn about ses.mismatch EMS events, which report when the two disk shelf modules within the same disk shelf are running different versions of the firmware.
