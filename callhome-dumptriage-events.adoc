...
[.lead]
callhome.dumptriage events are reported when kernel dumptriage files are collected for a coredump event, and corrective actions typically involve following the documented corrective action guidance.
