...
[.lead]
km.restore events are reported when the key manager attempts to restore a key which has an invalid length, and corrective actions typically involve following the documented corrective action guidance.
