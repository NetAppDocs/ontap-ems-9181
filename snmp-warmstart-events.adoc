...
[.lead]
snmp.warmstart events are reported when the SNMP daemon is reinitializing itself with a warmStart, and corrective actions typically involve following the documented corrective action guidance.
