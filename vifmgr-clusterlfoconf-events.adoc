...
[.lead]
Learn about vifmgr.clusterlfoconf EMS events, which report when the failover policy and failover group for a cluster LIF are restored to their default values.
