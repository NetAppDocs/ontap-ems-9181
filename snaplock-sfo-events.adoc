...
[.lead]
Learn about snaplock.sfo EMS events, which report when SnapLock legal-hold or event-retention operations are aborted during an aggregate relocation or a sendhome operation.
