...
[.lead]
snaplock.sfo events are reported when snapLock legal-hold or event-retention operations are aborted during an aggregate relocation or a sendhome operation, and corrective actions typically involve following the documented corrective action guidance.
