...
[.lead]
extcache.aggregate events are reported when this message provides diagnostic information about background work taking place in the WAFL(R) external cache subsystem, and corrective actions typically involve following the documented corrective action guidance.
