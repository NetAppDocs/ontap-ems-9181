...
[.lead]
Learn about extcache.aggregate EMS events, which report when This message provides diagnostic information about background work taking place in the WAFL(R) external cache subsystem.
