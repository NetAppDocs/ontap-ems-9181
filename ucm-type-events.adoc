...
[.lead]
ucm.type events are reported when the user changes the FC-4 type on a configurable adapter, and corrective actions typically involve following the documented corrective action guidance.
