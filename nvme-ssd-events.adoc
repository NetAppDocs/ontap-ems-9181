...
[.lead]
nvme.ssd events are reported when the NVMe drive encounters an error before the drive is reported to upper layers, and corrective actions typically involve following the documented corrective action guidance.
