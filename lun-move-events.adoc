...
[.lead]
lun.move events are reported when a LUN appears in the public namespace of the destination volume during a LUN move operation, and corrective actions typically involve following the documented corrective action guidance.
