...
[.lead]
nblade.smb1onlyclientfound events are reported when oNTAP(R) detects a client that supports only the SMB1 protocol, and corrective actions typically involve following the documented corrective action guidance.
