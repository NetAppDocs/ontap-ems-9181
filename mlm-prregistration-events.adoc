...
[.lead]
mlm.prregistration events are reported when the registration of a SCSI persistent reservation key fails, and corrective actions typically involve following the documented corrective action guidance.
