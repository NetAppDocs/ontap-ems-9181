...
[.lead]
Learn about vifmgr.viplifwithoutbgp EMS events, which report when a logical interface (LIF) associated with the Virtual IP (VIP) feature does not have a BGP peer group.
