...
[.lead]
vifmgr.viplifwithoutbgp events are reported when a logical interface (LIF) associated with the Virtual IP (VIP) feature does not have a BGP peer group, and corrective actions typically involve following the documented corrective action guidance.
