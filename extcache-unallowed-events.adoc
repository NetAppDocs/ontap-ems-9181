...
[.lead]
extcache.unallowed events are reported when an external cache bootarg or setflag is set without the required privilege, and corrective actions typically involve following the documented corrective action guidance.
