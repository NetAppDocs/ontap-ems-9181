...
[.lead]
acp.voltage events are reported when a 'voltage status' request that was sent to the Alternate Controller Path Processor fails, and corrective actions typically involve following the documented corrective action guidance.
