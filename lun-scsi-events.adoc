...
[.lead]
Learn about lun.scsi EMS events, which report when the SCSI reservation for one or more LUNs in the secondary or primary Vserver cannot be deleted during a Vserver disaster recovery(DR) resynchronize operation.
