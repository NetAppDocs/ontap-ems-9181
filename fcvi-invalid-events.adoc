...
[.lead]
fcvi.invalid events are reported when fCVI driver receives invalid advertisement, and corrective actions typically involve following the documented corrective action guidance.
