...
[.lead]
async.igroup events are reported when an error occurs asynchronously replicating an initiator group, and corrective actions typically involve following the documented corrective action guidance.
