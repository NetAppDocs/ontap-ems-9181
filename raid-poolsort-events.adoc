...
[.lead]
raid.poolsort events are reported when the system detects an invalid number of disks on a single channel, and corrective actions typically involve following the documented corrective action guidance.
