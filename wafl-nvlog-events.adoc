...
[.lead]
wafl.nvlog events are reported when this event is issued to indicate that the system is unable to create nvlog stats file, and corrective actions typically involve following the documented corrective action guidance.
