...
[.lead]
Learn about diskown.stealingdisk EMS events, which report when This event is issued when a user reassigns a disk that is owned and has a reservation from another system.
