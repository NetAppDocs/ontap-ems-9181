...
[.lead]
san.initiator events are reported when oNTAP detects that an initiator which was previously not logged on is now logged on, and corrective actions typically involve following the documented corrective action guidance.
