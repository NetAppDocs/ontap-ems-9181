...
[.lead]
Learn about ha.panicinfosznotok EMS events, which report when the size of the panic information received from the high-availability (HA) partner is not equal to the expected panic information size.
