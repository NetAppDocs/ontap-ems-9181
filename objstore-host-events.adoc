...
[.lead]
objstore.host events are reported when the object-store server host name cannot be resolved to an IP address, and corrective actions typically involve checking the reported configuration and connectivity.
