...
[.lead]
arl.postmigrnotok events are reported when the specified subsystem encounters an error during the post-migration phase of the aggregate relocation (ARL) operation, and corrective actions typically involve checking the reported configuration and connectivity.
