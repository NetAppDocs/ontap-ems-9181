...
[.lead]
nvmeof.portiomb events are reported when there are no longer two ports cabled incorrectly from a node to bottom module (B) on a shelf, and corrective actions typically involve following the documented corrective action guidance.
