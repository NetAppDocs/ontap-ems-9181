...
[.lead]
wafl.encryption events are reported when the system takes offline an encrypted virtual volume because encryption became unsupported, and corrective actions typically involve following the documented corrective action guidance.
