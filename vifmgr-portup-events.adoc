...
[.lead]
vifmgr.portup events are reported when a link up event was received on a network port, and corrective actions typically involve following the documented corrective action guidance.
