...
[.lead]
asup.smtp events are reported when the AutoSupport(R) mechanism drops email messages after having retried for the specified times, and corrective actions typically involve following the documented corrective action guidance.
