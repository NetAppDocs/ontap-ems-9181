...
[.lead]
repl.large events are reported when the replication engine encounters a destination that cannot handle large 600TB volume limits, and corrective actions typically involve following the documented corrective action guidance.
