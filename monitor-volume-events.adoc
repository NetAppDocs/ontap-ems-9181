...
[.lead]
monitor.volume events are reported when one or more file systems are full, typically indicating at least 98% full, and corrective actions typically involve following the documented corrective action guidance.
