...
[.lead]
Learn about kern.version EMS events, which report when you reboot your system with a version of the Data ONTAP(R) kernel that is different from the one you ran previously.
