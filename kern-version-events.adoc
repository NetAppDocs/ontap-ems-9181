...
[.lead]
kern.version events are reported when you reboot your system with a version of the Data ONTAP(R) kernel that is different from the one you ran previously, and corrective actions typically involve following the documented corrective action guidance.
