...
[.lead]
useradmin.added events are reported when a user, group, or role has been added, deleted, or modified, and corrective actions typically involve following the documented corrective action guidance.
