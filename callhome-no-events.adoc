...
[.lead]
callhome.no events are reported when a volume is out of inodes, which refer to individual files, other types of files, and directories, and corrective actions typically involve following the documented corrective action guidance.
