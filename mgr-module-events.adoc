...
[.lead]
mgr.module events are reported when this occurs to inform you of where kernel modules were loaded in memory, and corrective actions typically involve following the documented corrective action guidance.
