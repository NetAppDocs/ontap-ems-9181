...
[.lead]
nand.predict events are reported when data ONTAP(R) determines that failure is forthcoming for the associated flash device on the NVRAM module, and corrective actions typically involve following the documented corrective action guidance.
