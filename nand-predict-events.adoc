...
[.lead]
Learn about nand.predict EMS events, which report when Data ONTAP(R) determines that failure is forthcoming for the associated flash device on the NVRAM module.
