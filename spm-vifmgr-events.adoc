...
[.lead]
spm.vifmgr events are reported when the Logical Interface Manager (VIFMgr) subsystem aborts, and corrective actions typically involve ensuring the required configuration and resources are in place.
