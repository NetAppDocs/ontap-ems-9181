...
[.lead]
securepurge.aborted events are reported when a secure purge operation is aborted in a flexible volume, and corrective actions typically involve following the documented corrective action guidance.
