...
[.lead]
sis.policy events are reported when this message occurs during system software upgrade to Data ONTAP(R) 8, and corrective actions typically involve following the documented corrective action guidance.
