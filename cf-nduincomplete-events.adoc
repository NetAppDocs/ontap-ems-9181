...
[.lead]
cf.nduincomplete events are reported when a nondisruptive upgrade fails, and corrective actions typically involve following the documented corrective action guidance.
