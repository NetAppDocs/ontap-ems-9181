...
[.lead]
Learn about vsdr.ruleaddedtosmpolicy EMS events, which report when a MAX Data(R) schedule update adds a new rule to a SnapMirror(R) policy with the "mirror-vault" type.
