...
[.lead]
cpeer.unavailable events are reported when a peer cluster becomes unavailable, and corrective actions typically involve verifying the reported configuration and health state.
