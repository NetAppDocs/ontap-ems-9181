...
[.lead]
daasync.capacity events are reported when the capacity data of a target device changes, and corrective actions typically involve following the documented corrective action guidance.
