...
[.lead]
ha.mbxresvreleasedelay events are reported when the takeover node cannot release a disk reservation for a mailbox disk in preparation for a giveback event, and corrective actions typically involve following the documented corrective action guidance.
