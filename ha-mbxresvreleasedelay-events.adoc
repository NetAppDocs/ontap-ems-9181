...
[.lead]
Learn about ha.mbxresvreleasedelay EMS events, which report when the takeover node cannot release a disk reservation for a mailbox disk in preparation for a giveback event.
