...
[.lead]
nv.rename events are reported when there is an error while renaming the files specified in /etc/nvfail_rename, and corrective actions typically involve following the documented corrective action guidance.
