...
[.lead]
ctran.gc events are reported when the Cluster Transaction Manager (CTRAN) Group Coordinator (GC) of a group runs a prop-done probe for a proposal longer than anticipated, and corrective actions typically involve following the documented corrective action guidance.
