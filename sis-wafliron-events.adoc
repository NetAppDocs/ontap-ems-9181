...
[.lead]
sis.wafliron events are reported when a requested SIS volume 'undo' operation fails to correct on-disk corruption and requires wafliron to be run, and corrective actions typically involve following the documented corrective action guidance.
