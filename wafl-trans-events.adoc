...
[.lead]
wafl.trans events are reported when the system transitions a hybrid aggregate from 7-Mode to clustered Data ONTAP, and corrective actions typically involve following the documented corrective action guidance.
