...
[.lead]
netif.linkdown events are reported when a network link goes down or the interface is not operational when first configured up, and corrective actions typically involve following the documented corrective action guidance.
