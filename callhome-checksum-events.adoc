...
[.lead]
callhome.checksum events are reported when the system detects a RAID level checksum error, and corrective actions typically involve following the documented corrective action guidance.
