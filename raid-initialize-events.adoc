...
[.lead]
raid.initialize events are reported when a foreign or partner homed spare disk is detected during system initialization, and corrective actions typically involve following the documented corrective action guidance.
