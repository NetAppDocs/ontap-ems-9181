...
[.lead]
Learn about disk.encryptcmdfailed EMS events, which report when the indicated "storage encryption disk" command fails on an encrypting disk that supports storage encryption methods.
