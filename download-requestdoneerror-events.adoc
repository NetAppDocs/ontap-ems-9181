...
[.lead]
Learn about download.requestdoneerror EMS events, which report when This event is generated when a user-initiated download did not complete successfully due to a problem.
