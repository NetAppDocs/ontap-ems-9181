...
[.lead]
nblade.tlshandshakefailed events are reported when the NFS over TLS (Transport Layer Security) handshake fails between NFS client and NFS server, and corrective actions typically involve verifying the reported configuration and health state.
