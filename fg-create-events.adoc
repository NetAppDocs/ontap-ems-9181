...
[.lead]
fg.create events are reported when a user creates a FlexGroup volume that has a workflow with a type that is not "auto", and corrective actions typically involve following the documented corrective action guidance.
