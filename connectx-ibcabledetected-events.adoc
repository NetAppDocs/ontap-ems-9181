...
[.lead]
connectx.ibcabledetected events are reported when an InfiniBand cable is detected on the InfiniBand port, and corrective actions typically involve following the documented corrective action guidance.
