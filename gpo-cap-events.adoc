...
[.lead]
gpo.cap events are reported when applying group policy object (GPO) central access policy (CAP) settings succeeds, and corrective actions typically involve following the documented corrective action guidance.
