...
[.lead]
callhome.hwaccel events are reported when the hardware accelerator gets certain threshold number of errors and collects related diagnostic data concerning the device, and corrective actions typically involve following the documented corrective action guidance.
