...
[.lead]
connectx.ibunsupportcable events are reported when an unsupported InfiniBand cable is detected on the InfiniBand port, and corrective actions typically involve following the documented corrective action guidance.
