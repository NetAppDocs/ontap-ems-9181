...
[.lead]
ha.nomediatormbx events are reported when the non-local mailbox disks of a node are not accessible, and corrective actions typically involve following the documented corrective action guidance.
