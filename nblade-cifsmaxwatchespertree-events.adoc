...
[.lead]
Learn about nblade.cifsmaxwatchespertree EMS events, which report when the total number of directory watch (Change Notify) requests exceed the per-tree limit.
