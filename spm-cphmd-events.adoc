...
[.lead]
spm.cphmd events are reported when the Chassis Health Monitor process (cphmd) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
