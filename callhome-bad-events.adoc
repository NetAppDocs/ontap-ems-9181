...
[.lead]
callhome.bad events are reported when correctable ECC errors are masked off, possibly due to bad or poorly seated memory or a faulty motherboard, and corrective actions typically involve following the documented corrective action guidance.
