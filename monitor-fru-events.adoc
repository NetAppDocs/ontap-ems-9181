...
[.lead]
monitor.fru events are reported when the inventory information about a field-replaceable unit (FRU) that was previously unreadable becomes readable, and corrective actions typically involve following the documented corrective action guidance.
