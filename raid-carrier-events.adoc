...
[.lead]
raid.carrier events are reported when the evacuation operation is complete on a disk in a multidisk carrier that contains at least one failed disk, and corrective actions typically involve following the documented corrective action guidance.
