...
[.lead]
vsa.sriov events are reported when oNTAP(R) software running in the guest virtual machine (VM) detects an SR-IOV NIC detach event, and corrective actions typically involve following the documented corrective action guidance.
