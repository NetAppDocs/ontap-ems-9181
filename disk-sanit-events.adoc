...
[.lead]
disk.sanit events are reported when disk sanitization has been completed, and corrective actions typically involve following the documented corrective action guidance.
