...
[.lead]
Learn about coredump.delete EMS events, which report when a requested coredump delete cannot occur because an aggregate relocation or a takeover is in progress.
