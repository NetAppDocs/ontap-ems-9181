...
[.lead]
scsiblade.lu events are reported when this node completes a group internal rebuild for an LU, and corrective actions typically involve following the documented corrective action guidance.
