...
[.lead]
nameserv.conf events are reported when a UNIX user or group name exceeds 64 characters, and corrective actions typically involve following the documented corrective action guidance.
