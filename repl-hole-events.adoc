...
[.lead]
repl.hole events are reported when a SnapMirror(R) transfer encounters an unrecoverable RAID error, and corrective actions typically involve contacting NetApp technical support.
