...
[.lead]
pn.mvia events are reported when the round-trip-time (RTT) measured in pass-through network layer exceeds predefined threshold, and corrective actions typically involve following the documented corrective action guidance.
