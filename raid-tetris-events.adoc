...
[.lead]
raid.tetris events are reported when the system detects a block number mismatch during a write operation, and corrective actions typically involve following the documented corrective action guidance.
