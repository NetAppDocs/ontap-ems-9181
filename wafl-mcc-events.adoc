...
[.lead]
wafl.mcc events are reported when wAFL(R) does not find the MetroCluster configuration information on this node, and corrective actions typically involve following the documented corrective action guidance.
