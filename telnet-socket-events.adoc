...
[.lead]
telnet.socket events are reported when telnet could not create a socket, and corrective actions typically involve following the documented corrective action guidance.
