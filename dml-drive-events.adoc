...
[.lead]
dml.drive events are reported when drive offline completes, and corrective actions typically involve following the documented corrective action guidance.
