...
[.lead]
asup.throttle events are reported when an AutoSupport message is dropped because it is believed to be spam, and corrective actions typically involve following the documented corrective action guidance.
