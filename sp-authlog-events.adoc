...
[.lead]
Learn about sp.authlog EMS events, which report when the Service Processor (SP) or baseboard management controller (BMC) fails to log an authentication event in the system event log (SEL).
