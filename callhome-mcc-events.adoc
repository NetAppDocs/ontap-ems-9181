...
[.lead]
callhome.mcc events are reported when a MetroCluster(tm) automatic unplanned switchover operation has completed and the outage window was longer than 120 sec, and corrective actions typically involve checking the reported configuration and connectivity.
