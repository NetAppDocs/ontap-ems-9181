...
[.lead]
cr.redir events are reported when the data scanner skips an inode for which it cannot access the redirector file, and corrective actions typically involve following the documented corrective action guidance.
