...
[.lead]
smc.tot events are reported when snapMirror is unable to update the latest total transfer bytes value of the SnapMirror relationship, and corrective actions typically involve following the documented corrective action guidance.
