...
[.lead]
Learn about tapemc.unsupported EMS events, which report when a tape or media changer is detected that is not supported on this system, but its usage is not blocked.
