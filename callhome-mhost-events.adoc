...
[.lead]
callhome.mhost events are reported when you invoke an AutoSupport for userspace coredump files, and corrective actions typically involve following the documented corrective action guidance.
