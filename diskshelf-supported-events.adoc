...
[.lead]
diskshelf.supported events are reported when a newly supported disk shelf is detected, and corrective actions typically involve following the documented corrective action guidance.
