...
[.lead]
Learn about dfu.badbridgeshelfconfig EMS events, which report when the disk firmware update aborts because it cannot contact the two peer FC-to-SAS bridges.
