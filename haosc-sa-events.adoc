...
[.lead]
haosc.sa events are reported when nonvolatile memory on a stand-alone system is configured for a high-availability system, and corrective actions typically involve rebooting the node or cluster component.
