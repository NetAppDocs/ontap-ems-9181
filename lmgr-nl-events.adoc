...
[.lead]
lmgr.nl events are reported when the number of mirrored open lock count reaches the maximum supported limit, and corrective actions typically involve following the documented corrective action guidance.
