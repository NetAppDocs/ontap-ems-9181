...
[.lead]
nblade.cifsmaxsessperusrconnnotice events are reported when the number of sessions allowed per user over a TCP connection nears the configured limit, and corrective actions typically involve following the documented corrective action guidance.
