...
[.lead]
Learn about usbmon.unable EMS events, which report when the Data ONTAP(R) module that is responsible for monitoring the health of the Universal Serial Bus (USB) boot devices cannot extract health information from the monitored device.
