...
[.lead]
malloc.failure events are reported when this event is generated if malloc is called unsafely, and corrective actions typically involve following the documented corrective action guidance.
