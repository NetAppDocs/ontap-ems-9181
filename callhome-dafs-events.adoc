...
[.lead]
callhome.dafs events are reported when the DAFS (Direct Acess File System) NIC (Network Interface Controller) has stopped while DAFS was running, and corrective actions typically involve rebooting the node or cluster component.
