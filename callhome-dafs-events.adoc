...
[.lead]
Learn about callhome.dafs EMS events, which report when the DAFS (Direct Acess File System) NIC (Network Interface Controller) has stopped while DAFS was running.
