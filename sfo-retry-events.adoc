...
[.lead]
sfo.retry events are reported when automatic giveback of one or more SFO aggregates fails, and corrective actions typically involve following the documented corrective action guidance.
