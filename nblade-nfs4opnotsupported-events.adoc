...
[.lead]
nblade.nfs4opnotsupported events are reported when a NFSv4 client presents an unsupported operation to the server, and corrective actions typically involve following the documented corrective action guidance.
