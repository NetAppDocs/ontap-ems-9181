...
[.lead]
Learn about aggrcopy.src EMS events, which report when This event is issued when we are not able to obtain all the snapshot information, from the vol copy source volume, required for a vol copy transfer.
