...
[.lead]
nvdimm.flash events are reported when the NVDIMM device exceeds its warning threshold, and corrective actions typically involve contacting NetApp technical support.
