...
[.lead]
nvmens.offline events are reported when an NVMe namespace has been brought offline manually, and corrective actions typically involve following the documented corrective action guidance.
