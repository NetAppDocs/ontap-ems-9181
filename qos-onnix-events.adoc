...
[.lead]
qos.onnix events are reported when the classification subsystem for Quality of Service (QoS) fails, and corrective actions typically involve contacting NetApp technical support.
