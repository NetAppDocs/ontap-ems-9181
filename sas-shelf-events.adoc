...
[.lead]
sas.shelf events are reported when the system detects that two or more SAS (serial attached SCSI) disk shelves have the same shelf ID, and corrective actions typically involve following the documented corrective action guidance.
