...
[.lead]
pac.peer events are reported when the protocol access control fails to get the peer name, and corrective actions typically involve checking the reported configuration and connectivity.
