...
[.lead]
shelf.identify events are reported when the user turns on the disk shelf's Identify mode, and corrective actions typically involve following the documented corrective action guidance.
