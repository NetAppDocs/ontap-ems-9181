...
[.lead]
coredump.host events are reported when no sparecore disk is found at boot/takeover time, and corrective actions typically involve following the documented corrective action guidance.
