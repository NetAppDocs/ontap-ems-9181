...
[.lead]
sis.verify events are reported when the system suspends a Single Instance Storage (SIS) volume checking operation to to run a queued SIS operation, and corrective actions typically involve following the documented corrective action guidance.
