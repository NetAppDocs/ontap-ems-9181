...
[.lead]
Learn about sis.verify EMS events, which report when the system suspends a Single Instance Storage (SIS) volume checking operation to to run a queued SIS operation.
