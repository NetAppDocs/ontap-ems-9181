...
[.lead]
sectrace.warning events are reported when a security tracing filter is enabled, and corrective actions typically involve following the documented corrective action guidance.
