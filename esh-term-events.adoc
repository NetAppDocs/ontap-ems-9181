...
[.lead]
esh.term events are reported when there is an error related to loop termination, and corrective actions typically involve following the documented corrective action guidance.
