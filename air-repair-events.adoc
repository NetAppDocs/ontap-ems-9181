...
[.lead]
air.repair events are reported when there is an inconsistency in the persistent lock entry metafile, and corrective actions typically involve following the documented corrective action guidance.
