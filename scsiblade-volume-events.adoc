...
[.lead]
scsiblade.volume events are reported when lUNs in the specified Vserver and volume are not accessible on one or more SAN LIFs, and corrective actions typically involve following the documented corrective action guidance.
