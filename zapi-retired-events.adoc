...
[.lead]
zapi.retired events are reported when oNTAPI (ZAPI) is used for ONTAP data storage management, and corrective actions typically involve ensuring the required configuration and resources are in place.
