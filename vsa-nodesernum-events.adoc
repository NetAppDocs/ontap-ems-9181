...
[.lead]
vsa.nodesernum events are reported when a node serial number change operation fails, and corrective actions typically involve checking the reported configuration and connectivity.
