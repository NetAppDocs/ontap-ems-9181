...
[.lead]
dyn.auth events are reported when the custom trust score component of the Dynamic Authorization feature encounters an error, and corrective actions typically involve verifying the reported configuration and health state.
