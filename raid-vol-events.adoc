...
[.lead]
raid.vol events are reported when this event is issued when a disk is added to a aggregate, and corrective actions typically involve following the documented corrective action guidance.
