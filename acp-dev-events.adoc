...
[.lead]
acp.dev events are reported when the Alternate Control Path (ACP) Administrator encounters an error event in a development-only kernel, and corrective actions typically involve following the documented corrective action guidance.
