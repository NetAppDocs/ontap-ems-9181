...
[.lead]
disk.capacity events are reported when a media size change is reported for the underlying storage device, and corrective actions typically involve following the documented corrective action guidance.
