...
[.lead]
nblade.sharemaxconnlimit events are reported when a CIFS share exceeds its maximum configured connection limit, and corrective actions typically involve following the documented corrective action guidance.
