...
[.lead]
wafl.lookup events are reported when the system encounters an unexpected deleted directory entry in a snapmirrored qtree, and corrective actions typically involve following the documented corrective action guidance.
