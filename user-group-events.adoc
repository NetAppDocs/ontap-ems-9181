...
[.lead]
user.group events are reported when the number of UNIX users or groups in the cluster reaches or exceeds system limits, and corrective actions typically involve following the documented corrective action guidance.
