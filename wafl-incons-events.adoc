...
[.lead]
wafl.incons events are reported when the WAFL(R) kernel detects inconsistent compression metadata for a compression group, and corrective actions typically involve following the documented corrective action guidance.
