...
[.lead]
snaplock.state events are reported when this event is generated if SnapLock is unable to destroy the SnapLock state for a SnapLock volume, and corrective actions typically involve following the documented corrective action guidance.
