...
[.lead]
Learn about snaplock.state EMS events, which report when This event is generated if SnapLock is unable to destroy the SnapLock state for a SnapLock volume.
