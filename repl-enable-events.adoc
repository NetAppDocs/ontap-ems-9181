...
[.lead]
repl.enable events are reported when sequential splitting mode is enabled for a SnapMirror Synchronous relationship, and corrective actions typically involve following the documented corrective action guidance.
