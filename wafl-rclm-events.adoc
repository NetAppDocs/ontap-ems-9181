...
[.lead]
wafl.rclm events are reported when an attempt to estimate the space that can be reclaimed for the aggregate was completed successfully, and corrective actions typically involve following the documented corrective action guidance.
