...
[.lead]
raid.sparecore events are reported when a sparecore disk is prepared for ownership change by administrator forcibly, and corrective actions typically involve following the documented corrective action guidance.
