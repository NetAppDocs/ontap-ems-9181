...
[.lead]
config.badslot events are reported when a disk is found to be attached to an invalid Host Adapter (HA) controller slot, and corrective actions typically involve following the documented corrective action guidance.
