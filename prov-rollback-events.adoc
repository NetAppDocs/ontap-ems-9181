...
[.lead]
prov.rollback events are reported when oNTAP(R) software cannot complete a rollback of a provisioning operation sequence that failed, and corrective actions typically involve following the documented corrective action guidance.
