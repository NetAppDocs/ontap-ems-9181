...
[.lead]
dfu.clustericerror events are reported when communication with the controller failover partner cannot be established, and corrective actions typically involve following the documented corrective action guidance.
