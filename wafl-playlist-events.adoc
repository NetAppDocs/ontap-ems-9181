...
[.lead]
wafl.playlist events are reported when this event indicates bad playlist file handle, and corrective actions typically involve following the documented corrective action guidance.
