...
[.lead]
Learn about ems.asup EMS events, which report when the e-mail addresses for deprecated AutoSupport "noteto" messages are copied to EMS event notification destinations during an upgrade to Data ONTAP(R) 9.0 or later.
