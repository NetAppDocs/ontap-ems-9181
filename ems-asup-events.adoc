...
[.lead]
ems.asup events are reported when the e-mail addresses for deprecated AutoSupport "noteto" messages are copied to EMS event notification destinations during an upgrade to Data ONTAP(R) 9, and corrective actions typically involve following the documented corrective action guidance.
