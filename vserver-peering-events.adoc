...
[.lead]
vserver.peering events are reported when the Vserver peer relationship is established, and corrective actions typically involve following the documented corrective action guidance.
