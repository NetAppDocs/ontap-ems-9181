...
[.lead]
Learn about vifmgr.lifidoutofsync EMS events, which report when a Logical Interface (LIF) is configured in the Logical Interface manager (VIFMgr) but is not visible in the user interface.".
