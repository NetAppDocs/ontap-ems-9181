...
[.lead]
adt.aucb events are reported when this message occurs in the auditing subsytem, when the subsystem overwrite an existing audit control block during audit control block creation, and corrective actions typically involve following the documented corrective action guidance.
