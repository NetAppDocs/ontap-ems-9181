...
[.lead]
lmgr.recons events are reported when locks established through CIFS Continuously Available (CA) shares are dropped after a takeover, giveback, or aggregate relocation, and corrective actions typically involve following the documented corrective action guidance.
