...
[.lead]
Learn about lmgr.recons EMS events, which report when locks established through CIFS Continuously Available (CA) shares are dropped after a takeover, giveback, or aggregate relocation.
