...
[.lead]
callhome.stackmon events are reported when the system fails to assign the correct stack-id to one or more disk shelves, and corrective actions typically involve verifying the reported configuration and health state.
