...
[.lead]
raid.root events are reported when the root volume is not mirrored in a MetroCluster(tm) configuration, and corrective actions typically involve following the documented corrective action guidance.
