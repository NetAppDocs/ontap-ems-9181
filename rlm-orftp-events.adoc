...
[.lead]
Learn about rlm.orftp EMS events, which report when A communication error occured while sending or receiving information from the Remote Lan Module (RLM).
