...
[.lead]
rlm.orftp events are reported when a communication error occured while sending or receiving information from the Remote Lan Module (RLM), and corrective actions typically involve following the documented corrective action guidance.
