...
[.lead]
sms.resync events are reported when a resynchronize operation between the source volume and destination volume fails, and corrective actions typically involve following the documented corrective action guidance.
