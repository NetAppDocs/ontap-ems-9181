...
[.lead]
wafl.online events are reported when a cluster admin volume comes online during MetroCluster(TM) switchover, and no corrective action is typically required.
