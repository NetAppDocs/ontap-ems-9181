...
[.lead]
ucore.ulimit0 events are reported when a userspace core is not dumped because the core size limit is set to 0, and corrective actions typically involve contacting NetApp technical support.
