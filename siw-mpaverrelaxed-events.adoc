...
[.lead]
Learn about siw.mpaverrelaxed EMS events, which report when there is a mismatch in SW-iWARP versions, but due to negotiation or enhanced connect being enabled.
