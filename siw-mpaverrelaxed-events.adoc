...
[.lead]
siw.mpaverrelaxed events are reported when there is a mismatch in SW-iWARP versions, but due to negotiation or enhanced connect being enabled, and corrective actions typically involve following the documented corrective action guidance.
