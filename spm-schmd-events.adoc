...
[.lead]
spm.schmd events are reported when the System Connectivity Health Monitor process (schmd) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
