...
[.lead]
arl.subsystemabort events are reported when the specified subsystem aborts relocation of the aggregate, and corrective actions typically involve checking the reported configuration and connectivity.
