...
[.lead]
dns.server events are reported when the DNS server fails to respond to a query and timeout occurs, and corrective actions typically involve following the documented corrective action guidance.
