...
[.lead]
nblade.cifs events are reported when there is a budget allocation failure for a CIFS subsystem because other CIFS subsystems are consuming too much memory, and corrective actions typically involve following the documented corrective action guidance.
