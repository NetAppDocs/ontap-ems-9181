...
[.lead]
Learn about wafl.no EMS events, which report when This message occur when a volume don't have 'large_size_enabled' flag set even when the nominal size crosses the 100TB limit.
