...
[.lead]
wafl.no events are reported when this message occur when a volume don't have 'large_size_enabled' flag set even when the nominal size crosses the 100TB limit, and corrective actions typically involve following the documented corrective action guidance.
