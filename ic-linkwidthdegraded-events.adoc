...
[.lead]
ic.linkwidthdegraded events are reported when the high-availability (HA) interconnect detects a degraded link width, and corrective actions typically involve following the documented corrective action guidance.
