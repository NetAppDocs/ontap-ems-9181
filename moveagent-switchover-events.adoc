...
[.lead]
Learn about moveagent.switchover EMS events, which report when the volume move operation vetoes a MetroCluster(tm) switchover because the operations are mutually exclusive.
