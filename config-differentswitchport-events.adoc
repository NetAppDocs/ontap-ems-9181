...
[.lead]
config.differentswitchport events are reported when the two ports of the disk are connected to different switch ports, and corrective actions typically involve following the documented corrective action guidance.
