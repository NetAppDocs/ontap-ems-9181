...
[.lead]
crypto.export events are reported when the export of a cryptographic key fails, and corrective actions typically involve following the documented corrective action guidance.
