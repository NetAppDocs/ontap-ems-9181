...
[.lead]
cmd.sasadmin events are reported when an adapter firmware update failure occurs, and corrective actions typically involve verifying the reported configuration and health state.
