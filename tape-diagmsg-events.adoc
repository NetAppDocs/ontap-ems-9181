...
[.lead]
tape.diagmsg events are reported when there is a new state of the tape diagnostic message flag, and corrective actions typically involve following the documented corrective action guidance.
