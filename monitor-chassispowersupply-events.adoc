...
[.lead]
monitor.chassispowersupply events are reported when a power supply is degraded, and corrective actions typically involve following the documented corrective action guidance.
