...
[.lead]
ses.shelf events are reported when one of the drive in bay 1 or 2 is missing, and corrective actions typically involve following the documented corrective action guidance.
