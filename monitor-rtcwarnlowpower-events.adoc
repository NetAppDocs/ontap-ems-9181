...
[.lead]
monitor.rtcwarnlowpower events are reported when the real-time clock (RTC) battery is at a "warning low" voltage level, and corrective actions typically involve following the documented corrective action guidance.
