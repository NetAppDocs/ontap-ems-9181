...
[.lead]
scsiblade.invalid events are reported when a SCSI command requests a transfer length greater than the LUN's maximum supported transfer length of 1MB, and corrective actions typically involve following the documented corrective action guidance.
