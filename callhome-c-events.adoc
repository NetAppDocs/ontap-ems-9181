...
[.lead]
callhome.c events are reported when there is an unexpected decrease in a chassis fan's spin rate, possibly due to a slight decrease in revolutions or to a failed chassis fan, and corrective actions typically involve checking the reported configuration and connectivity.
