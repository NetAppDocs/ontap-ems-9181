...
[.lead]
sis.reg events are reported when this event is issued when a SIS volume operation found an invalid registry entry, and corrective actions typically involve following the documented corrective action guidance.
