...
[.lead]
monitor.weeklystatsasup events are reported when weekly performance AutoSupport(tm) is disabled, and corrective actions typically involve following the documented corrective action guidance.
