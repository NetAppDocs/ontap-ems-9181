...
[.lead]
csm.badconnection events are reported when oNTAP(R) software receives a Cluster Session Manager (CSM) connection with unrecognizable content, and corrective actions typically involve following the documented corrective action guidance.
