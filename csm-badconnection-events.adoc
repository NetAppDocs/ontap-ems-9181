...
[.lead]
Learn about csm.badconnection EMS events, which report when ONTAP(R) software receives a Cluster Session Manager (CSM) connection with unrecognizable content.
