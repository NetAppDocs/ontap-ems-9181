...
[.lead]
object.store events are reported when the node can connect to the object store again after an "object, and corrective actions typically involve following the documented corrective action guidance.
