...
[.lead]
diskown.duplicatesoftentries events are reported when this event is issued when we find duplicate entries in the sanown filer table, and corrective actions typically involve following the documented corrective action guidance.
