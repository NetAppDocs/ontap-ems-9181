...
[.lead]
acp.post events are reported when a 'post data' request that was sent to the Alternate Controller Path Processor fails, and corrective actions typically involve following the documented corrective action guidance.
