...
[.lead]
Learn about config.move EMS events, which report when a logical interface (LIF) migration fails in such a way that there might have been a resulting internal loss of the LIF IP address.
