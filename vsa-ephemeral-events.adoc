...
[.lead]
Learn about vsa.ephemeral EMS events, which report when a node is configured to use ephemeral vNVRAM and the virtual machine has been re-hosted, using new ephemeral disk for vNVRAM.
