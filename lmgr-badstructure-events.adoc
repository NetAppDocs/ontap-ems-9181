...
[.lead]
Learn about lmgr.badstructure EMS events, which report when This event is issued whenever the multi-protocol lock manager finds a bad file pointer and turns off the logging of lock manipulation to preserve trace information.
