...
[.lead]
disk.iorecoverederror events are reported when a disk determines that it will fail shortly, and corrective actions typically involve following the documented corrective action guidance.
