...
[.lead]
arl.opstart events are reported when the aggregate relocation operation starts, and corrective actions typically involve following the documented corrective action guidance.
