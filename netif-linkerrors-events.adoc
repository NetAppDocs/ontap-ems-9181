...
[.lead]
netif.linkerrors events are reported when the driver detects an excessive link error rate, and corrective actions typically involve verifying the reported configuration and health state.
