...
[.lead]
extcache.io events are reported when the external cache detects a block checksum verification error while performing a read operation, and corrective actions typically involve following the documented corrective action guidance.
