...
[.lead]
ata.excessive events are reported when an I/O request to the ATA driver in ONTAP(R) Select takes longer than five seconds, and corrective actions typically involve following the documented corrective action guidance.
