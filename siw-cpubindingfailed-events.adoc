...
[.lead]
siw.cpubindingfailed events are reported when the system fails to bind a SW-iWARP thread to a CPU during the boot-up, and corrective actions typically involve following the documented corrective action guidance.
