...
[.lead]
dfu.firmwareuptodate events are reported when all eligible disks are determined to be updated to the latest version of firmware available on the system, and corrective actions typically involve following the documented corrective action guidance.
