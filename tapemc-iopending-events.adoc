...
[.lead]
Learn about tapemc.iopending EMS events, which report when Data ONTAP(R) detects that multiple I/Os were sent to a device that supports only one I/O at a time.
