...
[.lead]
cpeer.long events are reported when a cross-cluster update takes longer than 15 minutes, and corrective actions typically involve ensuring the required configuration and resources are in place.
