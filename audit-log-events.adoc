...
[.lead]
audit.log events are reported when there is an issue during message auditing, and corrective actions typically involve following the documented corrective action guidance.
