...
[.lead]
Learn about bridge.sas EMS events, which report when the SAS disk shelves behind an FC-to-SAS bridge are not cabled correctly, indicating an invalid SAS2 to SAS3 transition.
