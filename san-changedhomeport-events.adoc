...
[.lead]
san.changedhomeport events are reported when the home port of an existing SAN LIF is modified during LIF placement, and corrective actions typically involve following the documented corrective action guidance.
