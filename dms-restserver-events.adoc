...
[.lead]
dms.restserver events are reported when the system hits an error in enabling SSL authentication in the rest server, and corrective actions typically involve checking the reported configuration and connectivity.
