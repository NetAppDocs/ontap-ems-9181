...
[.lead]
flexcache.featuredisabled events are reported when an attempt is made to mount a FlexCache volume, and corrective actions typically involve following the documented corrective action guidance.
