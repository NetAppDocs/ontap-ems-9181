...
[.lead]
vifmgr.lifbeingremoved events are reported when a logical interface (LIF) IP address is being removed or moved from the node, and corrective actions typically involve following the documented corrective action guidance.
