...
[.lead]
wafl.descend events are reported when there is an error during descendency checking, and corrective actions typically involve following the documented corrective action guidance.
