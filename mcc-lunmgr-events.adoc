...
[.lead]
mcc.lunmgr events are reported when failing to allocate a CTL Target LUN ID to a target disk, and corrective actions typically involve following the documented corrective action guidance.
