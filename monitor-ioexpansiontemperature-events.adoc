...
[.lead]
monitor.ioexpansiontemperature events are reported when this warning message occurs when the I/O expansion module is too cold, and corrective actions typically involve following the documented corrective action guidance.
