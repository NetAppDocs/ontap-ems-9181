...
[.lead]
sfu.badbridgeshelfconfig events are reported when the disk shelf firmware update aborts because it cannot contact the two peer FC-to-SAS bridges, and corrective actions typically involve following the documented corrective action guidance.
