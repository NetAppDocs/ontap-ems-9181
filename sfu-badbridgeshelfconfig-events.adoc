...
[.lead]
Learn about sfu.badbridgeshelfconfig EMS events, which report when the disk shelf firmware update aborts because it cannot contact the two peer FC-to-SAS bridges.
