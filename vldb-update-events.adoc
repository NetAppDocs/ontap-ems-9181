...
[.lead]
vldb.update events are reported when the aggregate ownership update fails during switchover, and corrective actions typically involve contacting NetApp technical support.
