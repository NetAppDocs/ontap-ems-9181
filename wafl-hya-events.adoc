...
[.lead]
wafl.hya events are reported when the default caching policies are to be configured on all volumes contained in this aggregate, and corrective actions typically involve following the documented corrective action guidance.
