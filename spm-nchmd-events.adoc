...
[.lead]
spm.nchmd events are reported when the Node Connectivity Health Monitor process (nchmd) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
