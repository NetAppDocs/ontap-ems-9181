...
[.lead]
scsiblade.kernel events are reported when the kernel cluster group for the specified volume is in an indeterminate state, and corrective actions typically involve contacting NetApp technical support.
