...
[.lead]
clus.net events are reported when the cluster network ports with "link" reported as "up" are neither receiving CDP nor LLDP neighbor announcements, and corrective actions typically involve following the documented corrective action guidance.
