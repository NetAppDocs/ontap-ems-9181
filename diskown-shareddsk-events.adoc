...
[.lead]
diskown.shareddsk events are reported when a disk is shared by multiple nodes in a non-HA or stand-alone configuration, and corrective actions typically involve following the documented corrective action guidance.
