...
[.lead]
repl.xfer events are reported when a replication transfer component (sender or receiver) has taken more than an hour to terminate, and corrective actions typically involve following the documented corrective action guidance.
