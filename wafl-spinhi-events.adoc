...
[.lead]
wafl.spinhi events are reported when a new spinnp error is being propagated to a blade that does not understand that error yet, and corrective actions typically involve following the documented corrective action guidance.
