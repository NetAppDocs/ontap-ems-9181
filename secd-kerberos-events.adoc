...
[.lead]
secd.kerberos events are reported when there is a "time error"(clock skew, time skew, time out of bounds), and corrective actions typically involve ensuring the required configuration and resources are in place.
