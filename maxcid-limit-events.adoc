...
[.lead]
maxcid.limit events are reported when system exceeds the maximum number of open network data connections on the node, and corrective actions typically involve following the documented corrective action guidance.
