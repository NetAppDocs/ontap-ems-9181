...
[.lead]
certificate.node events are reported when an installed certificate record exists in a node Vserver, and corrective actions typically involve following the documented corrective action guidance.
