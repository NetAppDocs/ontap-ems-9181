...
[.lead]
spm.perfstatd events are reported when the perfstat daemon (perfstatd) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
