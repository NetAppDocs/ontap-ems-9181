...
[.lead]
Learn about ha.takeoverimpunsync EMS events, which report when the partner node is down and it is currently impossible to perform a takeover because the takeover node does not have partner NVRAM data.
