...
[.lead]
esh.module events are reported when the ESH might have failed because it is reporting multiple problems, and corrective actions typically involve following the documented corrective action guidance.
