...
[.lead]
vifmgr.portremoved events are reported when a port is removed because it no longer exists, and corrective actions typically involve following the documented corrective action guidance.
