...
[.lead]
sms.failed events are reported when a SnapMirror(R) Sync relationship cannot be established due to precheck failures, and corrective actions typically involve following the documented corrective action guidance.
