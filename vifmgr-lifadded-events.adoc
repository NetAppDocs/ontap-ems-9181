...
[.lead]
vifmgr.lifadded events are reported when an administrator action causes a logical interface (LIF) IP address to be added, and corrective actions typically involve following the documented corrective action guidance.
