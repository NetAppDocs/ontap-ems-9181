...
[.lead]
esh.init events are reported when the system cannot allocate memory for a required service, and corrective actions typically involve contacting NetApp technical support.
