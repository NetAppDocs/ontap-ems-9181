...
[.lead]
air.evicted events are reported when the Automated Incremental Repair (AIR) subsystem evicts an entry in the qtree metafile because of inconsistent data within that entry, and corrective actions typically involve following the documented corrective action guidance.
