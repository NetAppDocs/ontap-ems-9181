...
[.lead]
Learn about air.evicted EMS events, which report when the Automated Incremental Repair (AIR) subsystem evicts an entry in the qtree metafile due to inconsistent data in that entry.
