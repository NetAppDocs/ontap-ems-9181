...
[.lead]
fal_nvme.partition events are reported when a partition status in the Flash Adaptation Layer (FAL) changes, and corrective actions typically involve following the documented corrective action guidance.
