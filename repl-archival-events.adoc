...
[.lead]
repl.archival events are reported when archival tier scan fails for a cloud snapshot, and corrective actions typically involve following the documented corrective action guidance.
