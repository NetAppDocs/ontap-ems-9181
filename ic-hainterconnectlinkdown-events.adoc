...
[.lead]
Learn about ic.hainterconnectlinkdown EMS events, which report when This message occurs every hour when one of the high-availability (HA) interconnect links is down.
