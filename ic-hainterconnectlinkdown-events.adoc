...
[.lead]
ic.hainterconnectlinkdown events are reported when this message occurs every hour when one of the high-availability (HA) interconnect links is down, and corrective actions typically involve verifying the reported configuration and health state.
