...
[.lead]
sfo.takeover events are reported when the taking over node cannot complete an attempted optimized negotiated takeover, and corrective actions typically involve following the documented corrective action guidance.
