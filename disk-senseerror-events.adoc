...
[.lead]
disk.senseerror events are reported when the drive reports an error, and corrective actions typically involve checking the reported configuration and connectivity.
