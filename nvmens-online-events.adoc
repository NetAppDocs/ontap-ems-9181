...
[.lead]
nvmens.online events are reported when an NVMe namespace is brought online manually, and corrective actions typically involve following the documented corrective action guidance.
