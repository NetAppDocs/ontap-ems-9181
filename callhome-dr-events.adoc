...
[.lead]
callhome.dr events are reported when all attempts to replicate the configuration fails, and corrective actions typically involve following the documented corrective action guidance.
