...
[.lead]
nvmeof.portioma events are reported when there are no longer two ports cabled incorrectly from a node to top module (A) on a shelf, and corrective actions typically involve following the documented corrective action guidance.
