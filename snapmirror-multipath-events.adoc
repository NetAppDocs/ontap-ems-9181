...
[.lead]
Learn about snapmirror.multipath EMS events, which report when This event is issued during boot or during takeover when the filer is unable to setup the necessary infrastructure required for SnapMirror multipathing support.
