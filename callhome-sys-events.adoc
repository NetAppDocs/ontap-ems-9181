...
[.lead]
callhome.sys events are reported when the appliance has an unsupported PCI slot configuration, and corrective actions typically involve following the documented corrective action guidance.
