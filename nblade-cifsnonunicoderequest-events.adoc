...
[.lead]
nblade.cifsnonunicoderequest events are reported when a client attempts to send a non-unicode request to a Vserver, and corrective actions typically involve checking the reported configuration and connectivity.
