...
[.lead]
adt.cmdq events are reported when an internal audit command queue fails to initialize, and corrective actions typically involve restoring available system resources.
