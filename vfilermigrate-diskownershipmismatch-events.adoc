...
[.lead]
Learn about vfilermigrate.diskownershipmismatch EMS events, which report when The SnapMover feature is licensed but the disk ownership model is not using the software-based disk ownership model.
