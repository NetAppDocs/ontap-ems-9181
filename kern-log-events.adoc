...
[.lead]
kern.log events are reported when this event is issued when the system messages log is rotated to a new name, and corrective actions typically involve following the documented corrective action guidance.
