...
[.lead]
mc.post events are reported when this message occurs post replay and conveys information regarding bdatas inserted, rejected, duplicate, hits and misses, and corrective actions typically involve following the documented corrective action guidance.
