...
[.lead]
netif.phyread events are reported when there is a failure in reading the physical layer (PHY) of a network interface, and corrective actions typically involve following the documented corrective action guidance.
