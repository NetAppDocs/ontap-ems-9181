...
[.lead]
vscan.pool events are reported when the Vscan scanner pool is automatically activated, and corrective actions typically involve following the documented corrective action guidance.
