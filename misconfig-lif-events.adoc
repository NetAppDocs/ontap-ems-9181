...
[.lead]
Learn about misconfig.lif EMS events, which report when the record for the incorrectly placed LIF is lost during MetroCluster(TM) switchover or switchback.
