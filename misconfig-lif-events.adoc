...
[.lead]
misconfig.lif events are reported when the record for the incorrectly placed LIF is lost during MetroCluster(TM) switchover or switchback, and corrective actions typically involve following the documented corrective action guidance.
