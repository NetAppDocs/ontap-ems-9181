...
[.lead]
raid.labelmaint events are reported when the system places an aggregate into online label maintenance mode, and corrective actions typically involve following the documented corrective action guidance.
