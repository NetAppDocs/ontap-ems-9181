...
[.lead]
repl.seq events are reported when the SnapMirror sequential split is enabled on a SAN operating workload, and corrective actions typically involve following the documented corrective action guidance.
