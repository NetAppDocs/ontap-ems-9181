...
[.lead]
Learn about callhome.bootfs EMS events, which report when a consistency check of the boot media (compact flash or other type) has shown a problem and has not been corrected automatically.
