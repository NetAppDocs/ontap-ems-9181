...
[.lead]
Learn about rsh.firewall EMS events, which report when rsh is automatically removed from firewall policies during a revert operation from Data ONTAP(R) 9.0 to 8.3.
