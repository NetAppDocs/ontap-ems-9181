...
[.lead]
rsh.firewall events are reported when rsh is automatically removed from firewall policies during a revert operation from Data ONTAP(R) 9, and corrective actions typically involve following the documented corrective action guidance.
