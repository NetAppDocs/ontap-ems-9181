...
[.lead]
fg.multidelete events are reported when a Snapshot copy in an invalid state is deleted from a FlexGroup volume, and corrective actions typically involve following the documented corrective action guidance.
