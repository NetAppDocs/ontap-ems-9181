...
[.lead]
Learn about vnvram.flush EMS events, which report when the write to the backing storage device for the EMS region of VNVRAM (virtual NVRAM) takes longer than 500 msec.
