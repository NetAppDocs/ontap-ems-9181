...
[.lead]
monitor.globalstatus events are reported when the system's global health is critical; for example, if a fan failed, and corrective actions typically involve checking the reported configuration and connectivity.
