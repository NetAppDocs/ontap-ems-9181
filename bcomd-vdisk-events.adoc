...
[.lead]
bcomd.vdisk events are reported when this message occurs after a replication failure of a LUN or an NVMe namespace configuration in a MetroCluster(TM) configuration, and corrective actions typically involve following the documented corrective action guidance.
