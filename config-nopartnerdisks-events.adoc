...
[.lead]
config.nopartnerdisks events are reported when this message occurs in a High-Availablity (HA> configuration when there are no partner disks, and corrective actions typically involve ensuring the required configuration and resources are in place.
