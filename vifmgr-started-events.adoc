...
[.lead]
vifmgr.started events are reported when this message occurs to notify you that the Logical Interface Manager (VIFMgr) started, and corrective actions typically involve following the documented corrective action guidance.
