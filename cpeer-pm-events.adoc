...
[.lead]
cpeer.pm events are reported when the peer manager job experiences a transient failure, and corrective actions typically involve verifying the reported configuration and health state.
