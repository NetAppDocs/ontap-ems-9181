...
[.lead]
wafl.mirror events are reported when the system rejects client access to a primordial volume, and corrective actions typically involve following the documented corrective action guidance.
