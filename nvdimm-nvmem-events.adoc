...
[.lead]
nvdimm.nvmem events are reported when nVDIMM-based NVMEM checks fail, and corrective actions typically involve following the documented corrective action guidance.
