...
[.lead]
rlm.network events are reported when the Remote LAN Module (RLM) detects a link error on the RLM network port, and corrective actions typically involve following the documented corrective action guidance.
