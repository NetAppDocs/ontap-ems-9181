...
[.lead]
sis.compress events are reported when postprocess compression is skipped during a deduplication operation, even though postprocess compression is enabled on the volume, and corrective actions typically involve following the documented corrective action guidance.
