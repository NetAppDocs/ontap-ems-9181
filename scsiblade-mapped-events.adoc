...
[.lead]
scsiblade.mapped events are reported when a mapped NVMe namespace attribute changes as a result of a management operation, and corrective actions typically involve following the documented corrective action guidance.
