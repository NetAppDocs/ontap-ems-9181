...
[.lead]
fcvi.link events are reported when the physical link of the Fibre Channel Virtual Interface (FC-VI) adapter goes down, and corrective actions typically involve following the documented corrective action guidance.
