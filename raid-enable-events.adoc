...
[.lead]
Learn about raid.enable EMS events, which report when This event is issued when RAID sub system enables recording in the partner's NVRAM entries for the log based file system.
