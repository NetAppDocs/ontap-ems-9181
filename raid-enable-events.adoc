...
[.lead]
raid.enable events are reported when this event is issued when RAID sub system enables recording in the partner's NVRAM entries for the log based file system, and corrective actions typically involve following the documented corrective action guidance.
