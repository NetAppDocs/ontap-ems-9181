...
[.lead]
sfu.downloadsummaryerrors events are reported when a disk shelf firmware update completes without successfully downloading to all shelves it attempted, and corrective actions typically involve following the documented corrective action guidance.
