...
[.lead]
Learn about sfu.downloadsummaryerrors EMS events, which report when a disk shelf firmware update completes without successfully downloading to all shelves it attempted.
