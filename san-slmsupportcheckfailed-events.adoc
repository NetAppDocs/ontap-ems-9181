...
[.lead]
Learn about san.slmsupportcheckfailed EMS events, which report when This message occurs during reboot when SAN capability is enabled, the cluster has more than 8 nodes and lun.reporting.nodes options is disabled.
