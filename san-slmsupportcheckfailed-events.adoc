...
[.lead]
san.slmsupportcheckfailed events are reported when this message occurs during reboot when SAN capability is enabled, the cluster has more than 8 nodes and lun, and corrective actions typically involve following the documented corrective action guidance.
