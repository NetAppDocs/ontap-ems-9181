...
[.lead]
Learn about snapmirror.reconstruct EMS events, which report when the SnapMirror(R) requested reconstruction of a per-volume meta file used for labeling block information is complete.
