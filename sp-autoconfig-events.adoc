...
[.lead]
Learn about sp.autoconfig EMS events, which report when the system cannot automatically obtain IP configuration because the subnet associated with the Service Processor does not have any available IP addresses.
