...
[.lead]
lmgr.gb events are reported when giveback veto is overridden, and corrective actions typically involve following the documented corrective action guidance.
