...
[.lead]
fg.inactive events are reported when the system automatically deletes an inactive FlexGroup constituent that existed only in the data component, and corrective actions typically involve following the documented corrective action guidance.
