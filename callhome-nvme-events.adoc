...
[.lead]
callhome.nvme events are reported when a directly attached NVMe module has worn out and is at the end of its write life, and corrective actions typically involve contacting NetApp technical support.
