...
[.lead]
disk.readreservationfailed events are reported when a SCSI (Small Computer System Interface) read reservation fails, and corrective actions typically involve following the documented corrective action guidance.
