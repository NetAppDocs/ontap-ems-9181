...
[.lead]
wafl.convert events are reported when a directory cannot be safely converted to Unicode format, and corrective actions typically involve following the documented corrective action guidance.
