...
[.lead]
acp.shelf events are reported when the Alternate Control Path (ACP) Processor fails to complete a power cycle of the disk shelf, and corrective actions typically involve following the documented corrective action guidance.
