...
[.lead]
mcc.config events are reported when the MetroCluster(tm) local node configuration assignment to persistent storage failed, and corrective actions typically involve contacting NetApp technical support.
