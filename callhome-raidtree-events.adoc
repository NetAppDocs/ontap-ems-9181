...
[.lead]
callhome.raidtree events are reported when an aggregate experiences a configuration corruption error during assimilation of aggregate structures, and corrective actions typically involve contacting NetApp technical support.
