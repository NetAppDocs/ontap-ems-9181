...
[.lead]
vifmgr.lifdeleted events are reported when an administrator action causes a logical interface (LIF) IP address to be deleted, and corrective actions typically involve following the documented corrective action guidance.
