...
[.lead]
vsdr.rootvol events are reported when the system detects that there is data in the Server Virtual Machine root volume during a disaster recovery (DR) transfer phase, and corrective actions typically involve following the documented corrective action guidance.
