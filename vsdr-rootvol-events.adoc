...
[.lead]
Learn about vsdr.rootvol EMS events, which report when the system detects that there is data in the Server Virtual Machine root volume during a disaster recovery (DR) transfer phase.
