...
[.lead]
wafl.snapshot events are reported when this event is issued when the system discover that a filesize is out of range in a snapshot, and corrective actions typically involve following the documented corrective action guidance.
