...
[.lead]
Learn about dump.bitmap EMS events, which report when This event is generated during dump restarting and looking for the bitmap file and it is unable to locate.
