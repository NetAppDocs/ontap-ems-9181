...
[.lead]
Learn about extcache.configunsupported EMS events, which report when the controller contains an external cache hardware configuration that cannot be supported on the controller.
