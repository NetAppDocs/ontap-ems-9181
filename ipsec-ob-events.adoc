...
[.lead]
ipsec.ob events are reported when the kernel cannot acquire an IPsec Security Association (SA) to protect an outbound packet, and corrective actions typically involve following the documented corrective action guidance.
