...
[.lead]
cf.fsm events are reported when a node initiates an automatic giveback to its partner following a takeover that was due to a panic on the partner, and corrective actions typically involve following the documented corrective action guidance.
