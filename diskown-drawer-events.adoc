...
[.lead]
diskown.drawer events are reported when drawer-based drive assignment for shelves with drawers is enabled or disabled, and corrective actions typically involve following the documented corrective action guidance.
