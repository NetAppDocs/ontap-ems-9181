...
[.lead]
Learn about lldp.receive EMS events, which report when the LLDP (Link Layer Discovery Protocol) daemon running on the storage controller receives more unique neighbor advertisements than it can cache.
