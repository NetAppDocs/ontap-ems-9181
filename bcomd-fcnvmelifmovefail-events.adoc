...
[.lead]
bcomd.fcnvmelifmovefail events are reported when a LIF move failed and the recovery action to restore the LIF has also failed, and corrective actions typically involve contacting NetApp technical support.
