...
[.lead]
mgr.stack events are reported when this message contains the panic string, and corrective actions typically involve following the documented corrective action guidance.
