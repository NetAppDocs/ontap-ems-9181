...
[.lead]
bdfu.selected events are reported when background disk firmware update selects a disk for firmware download, and corrective actions typically involve following the documented corrective action guidance.
