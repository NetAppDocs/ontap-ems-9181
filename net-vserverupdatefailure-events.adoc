...
[.lead]
net.vserverupdatefailure events are reported when a node cannot be updated with Vserver configuration, and corrective actions typically involve following the documented corrective action guidance.
