...
[.lead]
revertto.system events are reported when the system is rebooting to complete the revert process, and corrective actions typically involve following the documented corrective action guidance.
