...
[.lead]
connectx.ibretimerprogrmpass events are reported when infiniBand retimer programming is succesfully completed after the system detects that a cable is plugged in, and corrective actions typically involve following the documented corrective action guidance.
