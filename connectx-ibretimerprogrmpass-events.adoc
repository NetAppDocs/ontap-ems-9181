...
[.lead]
Learn about connectx.ibretimerprogrmpass EMS events, which report when InfiniBand retimer programming is succesfully completed after the system detects that a cable is plugged in.
