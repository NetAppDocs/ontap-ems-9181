...
[.lead]
Learn about config.habadbank2 EMS events, which report when a local host adapter is connected to a different switch bank (on ports 0-7) than other adapters on this controller, which are connected to ports 8-15.
