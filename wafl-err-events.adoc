...
[.lead]
wafl.err events are reported when a level 1 indirect block with given block number is not found in a compacted block, and corrective actions typically involve following the documented corrective action guidance.
