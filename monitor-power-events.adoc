...
[.lead]
monitor.power events are reported when the main unit power supply is in a degraded mode, and corrective actions typically involve following the documented corrective action guidance.
