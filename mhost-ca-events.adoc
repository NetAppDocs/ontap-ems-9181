...
[.lead]
mhost.ca events are reported when the client connection has failed due to certificate error, and corrective actions typically involve ensuring the required configuration and resources are in place.
