...
[.lead]
kern.shutdown events are reported when this event is issued to indicate a pending shutdown is underway, and corrective actions typically involve following the documented corrective action guidance.
