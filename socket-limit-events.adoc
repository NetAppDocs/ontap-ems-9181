...
[.lead]
Learn about socket.limit EMS events, which report when the operating system is unable to allocate a new socket because that would exceed the maximum open sockets.
