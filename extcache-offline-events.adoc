...
[.lead]
extcache.offline events are reported when the external cache is automatically taken offline, and corrective actions typically involve following the documented corrective action guidance.
