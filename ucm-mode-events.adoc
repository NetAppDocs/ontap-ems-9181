...
[.lead]
ucm.mode events are reported when the FC adapter or converged networking adapter is reconfigured from a backup, and corrective actions typically involve following the documented corrective action guidance.
