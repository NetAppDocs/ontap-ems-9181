...
[.lead]
km.extkeysvr events are reported when a key is retrieved or restored from an external KMIP server, and corrective actions typically involve following the documented corrective action guidance.
