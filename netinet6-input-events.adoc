...
[.lead]
netinet6.input events are reported when the destination address is not ready, so the packet is discarded, and corrective actions typically involve following the documented corrective action guidance.
