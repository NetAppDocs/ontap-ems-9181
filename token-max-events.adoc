...
[.lead]
token.max events are reported when the maximum number of tokens that can be created in a volume is determined, and corrective actions typically involve following the documented corrective action guidance.
