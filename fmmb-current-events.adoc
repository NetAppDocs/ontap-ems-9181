...
[.lead]
fmmb.current events are reported when this event is issued when HA mailbox disks are discovered or allocated, and corrective actions typically involve following the documented corrective action guidance.
