...
[.lead]
ses.drive events are reported when disk drives are placed in locations that do not provide for proper signal integrity, and corrective actions typically involve following the documented corrective action guidance.
