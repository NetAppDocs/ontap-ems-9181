...
[.lead]
config.sameha events are reported when a disk is multipathed to the same host adapter, and corrective actions typically involve following the documented corrective action guidance.
