...
[.lead]
Learn about msata.unable EMS events, which report when Data ONTAP(R) module that is responsible for monitoring the health of the mSATA device cannot extract health information from the associated device.
