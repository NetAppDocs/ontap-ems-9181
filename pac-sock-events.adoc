...
[.lead]
pac.sock events are reported when the protocol access control fails to get the socket name, and corrective actions typically involve following the documented corrective action guidance.
