...
[.lead]
Learn about dump.inconsistent_streamdir_lunclone EMS events, which report when the dump engine encounters a disk error in a stream directory of an inconsistent LUN clone in a Snapshot(tm) copy.
