...
[.lead]
ipmultipath.session events are reported when an IP Multipath session is dropped due to failure to allocate memory, and corrective actions typically involve following the documented corrective action guidance.
