...
[.lead]
Learn about disk.uid EMS events, which report when a SCSI (Small Computer System Interface) INQUIRY command done during a disk drive initialization sequence finds different data in the INQUIRY response for page 0x83.
