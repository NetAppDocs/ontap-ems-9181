...
[.lead]
upgrademgr.cmd events are reported when the execution of the commands listed in the support file has completed, and corrective actions typically involve following the documented corrective action guidance.
