...
[.lead]
Learn about sp.orftp EMS events, which report when there is a communication error while sending information to or receiving information from the Service Processor (SP).
