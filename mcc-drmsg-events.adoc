...
[.lead]
mcc.drmsg events are reported when a DR message is successfully received from a DR partner node, and corrective actions typically involve following the documented corrective action guidance.
