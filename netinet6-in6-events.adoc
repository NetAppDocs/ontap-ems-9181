...
[.lead]
netinet6.in6 events are reported when this message occurs because of equal prefix length, and corrective actions typically involve following the documented corrective action guidance.
