...
[.lead]
auditlog.change events are reported when the system detects that audit log files have been tampered with, and corrective actions typically involve contacting NetApp technical support.
