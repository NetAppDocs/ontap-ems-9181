...
[.lead]
dfu.fwdownloadfailedmultfiles events are reported when more than one file is found for downloading to an ATA drive, and corrective actions typically involve following the documented corrective action guidance.
