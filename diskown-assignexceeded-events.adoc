...
[.lead]
diskown.assignexceeded events are reported when an attempt is made to assign more disks than are supported by this node, and corrective actions typically involve following the documented corrective action guidance.
