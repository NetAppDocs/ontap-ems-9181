...
[.lead]
monitor.chassisfan events are reported when a chassis fan is degraded, and corrective actions typically involve following the documented corrective action guidance.
