...
[.lead]
mes_dimm.error events are reported when this message appears when an error is encountered by MES (Memory Error Statistics), and corrective actions typically involve following the documented corrective action guidance.
