...
[.lead]
xfcvi.initfailed events are reported when the driver fails to initialize a FC-VI port, and corrective actions typically involve rebooting the node or cluster component.
