...
[.lead]
esh.auto events are reported when there is an error in autotermination, and corrective actions typically involve following the documented corrective action guidance.
