...
[.lead]
rdb.sql events are reported when the cluster management Data Replication Module could not upgrade its database from RDB to SQL, and corrective actions typically involve contacting NetApp technical support.
