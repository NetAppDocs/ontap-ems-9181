...
[.lead]
license.feat events are reported when the system cannot successfully delete a license for a feature, and corrective actions typically involve following the documented corrective action guidance.
