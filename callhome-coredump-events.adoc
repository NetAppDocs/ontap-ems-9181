...
[.lead]
callhome.coredump events are reported when all the core segments belonging to a coredump have been saved, and corrective actions typically involve following the documented corrective action guidance.
