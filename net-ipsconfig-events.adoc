...
[.lead]
net.ipsconfig events are reported when creation of an IPspace fails, and corrective actions typically involve following the documented corrective action guidance.
