...
[.lead]
mgmt.smbc events are reported when the system fails to replicate the configuration of Report Target Group Port(RTPG) and Inter-Cluster(IC) LIF information, and corrective actions typically involve following the documented corrective action guidance.
