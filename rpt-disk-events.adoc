...
[.lead]
rpt.disk events are reported when the generation of a disk UUID fails, and corrective actions typically involve following the documented corrective action guidance.
