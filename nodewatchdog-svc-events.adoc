...
[.lead]
nodewatchdog.svc events are reported when a service critical to data access fails to respond to service monitoring and is restarted, and corrective actions typically involve following the documented corrective action guidance.
