...
[.lead]
disk.spindleerror events are reported when a disk returns a spindle detect error, and corrective actions typically involve following the documented corrective action guidance.
