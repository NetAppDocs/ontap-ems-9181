...
[.lead]
callhome.mlm events are reported when all paths for an array LUN are connected to the same controller on the array, and corrective actions typically involve following the documented corrective action guidance.
