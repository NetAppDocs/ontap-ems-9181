...
[.lead]
pha.vsa events are reported when oNTAP(R) software detects a device with a device descriptor length greater than 40 characters, and corrective actions typically involve following the documented corrective action guidance.
