...
[.lead]
netinet6.nbr events are reported when oNTAP receives unexpected Neighbor Discovery (ND) packets, and corrective actions typically involve following the documented corrective action guidance.
