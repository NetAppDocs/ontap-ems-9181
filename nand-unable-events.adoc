...
[.lead]
Learn about nand.unable EMS events, which report when Data ONTAP(R) module that is responsible for monitoring the health of the NVRAM device cannot extract health information.
