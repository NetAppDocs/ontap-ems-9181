...
[.lead]
nvram.battery events are reported when the NVRAM battery capacity is critically low, and corrective actions typically involve following the documented corrective action guidance.
