...
[.lead]
asup.aods events are reported when the size of the response from the AutoSupport OnDemand Server (AODS) goes over the AOD response buffer size limit in ONTAP, and corrective actions typically involve contacting NetApp technical support.
