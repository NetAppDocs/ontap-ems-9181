...
[.lead]
acp.fw events are reported when the Alternate Control Path (ACP) Processor receives a command to initiate a firmware download, and corrective actions typically involve following the documented corrective action guidance.
