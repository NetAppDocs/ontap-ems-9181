...
[.lead]
isns.reg events are reported when the Internet Storage Name Service (iSNS) registration information is not valid or not available, and corrective actions typically involve checking the reported configuration and connectivity.
