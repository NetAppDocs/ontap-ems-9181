...
[.lead]
Learn about config.badpoolassign EMS events, which report when SyncMirror(R) is in use and disks are assigned to different pools on the same interface or loop.
