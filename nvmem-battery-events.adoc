...
[.lead]
nvmem.battery events are reported when the NVMEM battery lacks the capacity to preserve the NVMEM contents for the required minimum of 72 hours, and corrective actions typically involve following the documented corrective action guidance.
