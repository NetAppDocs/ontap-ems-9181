...
[.lead]
mcc.auso events are reported when a trigger for automatic unplanned switchover fails to issue the operation, and corrective actions typically involve verifying the reported configuration and health state.
