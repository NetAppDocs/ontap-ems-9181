...
[.lead]
Learn about rdmalib.multichan EMS events, which report when this node's high-availability (HA) partner reports an update on the number of interconnect channels (multichan count) in use.
