...
[.lead]
hotplug.init events are reported when the "slot module insert" command encounters an error while initializing the module, and corrective actions typically involve following the documented corrective action guidance.
