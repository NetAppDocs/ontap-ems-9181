...
[.lead]
diskown.rescan events are reported when the high-availability (HA) messaging layer fails to connect to the specified node for disk ownership updates, and corrective actions typically involve following the documented corrective action guidance.
