...
[.lead]
fcadmin.bridge events are reported when this event reports the WWN written to a device, and corrective actions typically involve following the documented corrective action guidance.
