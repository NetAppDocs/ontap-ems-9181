...
[.lead]
Learn about callhome.appdm EMS events, which report when the Application Data Management feature encounters an error while attempting to restore an application from a snapshot.
