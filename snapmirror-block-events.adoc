...
[.lead]
snapmirror.block events are reported when a SnapMirror(R) operation needs to reconstruct the block type bits, and corrective actions typically involve following the documented corrective action guidance.
