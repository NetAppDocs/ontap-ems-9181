...
[.lead]
nblade.fpolpassthruconnect events are reported when a pass-through read channel is established between the node and the FPolicy server, and corrective actions typically involve following the documented corrective action guidance.
