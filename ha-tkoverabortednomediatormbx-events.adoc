...
[.lead]
ha.tkoverabortednomediatormbx events are reported when a planned failover is aborted because the mediator mailbox disks were not detected, and corrective actions typically involve following the documented corrective action guidance.
