...
[.lead]
Learn about ha.tkoverabortednomediatormbx EMS events, which report when a planned failover is aborted because the mediator mailbox disks were not detected.
