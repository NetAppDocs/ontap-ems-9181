...
[.lead]
wafl.giveback events are reported when the system cannot perform a giveback due to vol create, and must abort giveback, and corrective actions typically involve following the documented corrective action guidance.
