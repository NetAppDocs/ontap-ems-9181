...
[.lead]
Learn about callhome.scsi EMS events, which report when a LUN (Logical Unit Number) mapping or igroup type misconfiguration has been detected when the cluster interconnect has transitioned from down to up.
