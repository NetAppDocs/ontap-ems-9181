...
[.lead]
Learn about vldb.mccaggregate EMS events, which report when This message occurs during MetroCluster(tm) configuration setup, when the aggregate at the destination site is renamed to handle a name collision.
