...
[.lead]
callhome.nvram events are reported when excessive correctable error-correcting code (ECC) memory errors are reported by the NVRAM complex, and corrective actions typically involve following the documented corrective action guidance.
