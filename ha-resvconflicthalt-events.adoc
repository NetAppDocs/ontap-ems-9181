...
[.lead]
ha.resvconflicthalt events are reported when the node halts itself after it finds disks with reservation conflicts, and corrective actions typically involve following the documented corrective action guidance.
