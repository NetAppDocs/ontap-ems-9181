...
[.lead]
replication.stats events are reported when this message occurs during system boot when SnapMirror(R) or SnapVault(R) cannot load the statistics (for example, and corrective actions typically involve following the documented corrective action guidance.
