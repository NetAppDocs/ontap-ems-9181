...
[.lead]
fc.bridge events are reported when an FC port goes offline, and corrective actions typically involve checking the reported configuration and connectivity.
