...
[.lead]
Learn about savecore.nospace EMS events, which report when Savecore has determined that the space available for storing the unsaved core is not sufficient.
