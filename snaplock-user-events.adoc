...
[.lead]
Learn about snaplock.user EMS events, which report when the SnapLock(R) logging system fails to securely log either the addition or deletion of the compliance admin role to or from a user account.
