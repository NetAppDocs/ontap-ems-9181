...
[.lead]
callhome.sm events are reported when a break operation on a SnapMirror(R) relationship that is a part of VserverDR fails, and corrective actions typically involve contacting NetApp technical support.
