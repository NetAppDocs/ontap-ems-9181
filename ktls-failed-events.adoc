...
[.lead]
ktls.failed events are reported when several successive Transport Layer Security (TLS) connections with a remote system have failed, and corrective actions typically involve following the documented corrective action guidance.
