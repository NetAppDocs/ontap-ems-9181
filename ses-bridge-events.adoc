...
[.lead]
ses.bridge events are reported when the bridge firmware revision cannot be obtained, and corrective actions typically involve checking the reported configuration and connectivity.
