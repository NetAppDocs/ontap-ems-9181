...
[.lead]
air.removed events are reported when there is an inconsistency in the remote lock entry metafile, and corrective actions typically involve following the documented corrective action guidance.
