...
[.lead]
Learn about flexcache.config EMS events, which report when the FlexCache volume expand operation fails to synchronize the FlexCache configuration information between the newly created constituent volume and the origin cluster.
