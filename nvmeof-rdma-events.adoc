...
[.lead]
nvmeof.rdma events are reported when the NVMe-oF driver detects an RDMA disconnect, and corrective actions typically involve following the documented corrective action guidance.
