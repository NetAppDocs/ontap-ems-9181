...
[.lead]
ucore.limits events are reported when a userspace core is not dumped because system limits for this process are reached, and corrective actions typically involve contacting NetApp technical support.
