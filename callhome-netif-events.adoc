...
[.lead]
callhome.netif events are reported when network Interface Card encountered a fatal error, and corrective actions typically involve checking the reported configuration and connectivity.
