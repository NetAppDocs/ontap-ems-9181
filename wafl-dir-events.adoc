...
[.lead]
wafl.dir events are reported when cIFS directory conversion is in progress and WAFL will not hang due to timeout, and corrective actions typically involve following the documented corrective action guidance.
