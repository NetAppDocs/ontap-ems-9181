...
[.lead]
wafl.bad events are reported when you attempt to bring an aggregate online whose file system buftree type and RAID label format are inconsistent, and corrective actions typically involve contacting NetApp technical support.
