...
[.lead]
mlm.bad events are reported when a device reports invalid data for "REPORT LUNS" command, and corrective actions typically involve following the documented corrective action guidance.
