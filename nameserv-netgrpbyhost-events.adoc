...
[.lead]
Learn about nameserv.netgrpbyhost EMS events, which report when netgroup is configured but the netgroup byhost database is not generated during an upgrade operation.
