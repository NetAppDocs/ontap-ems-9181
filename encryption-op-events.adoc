...
[.lead]
encryption.op events are reported when a rekey or conversion to encryption operation is completed on a volume, and corrective actions typically involve following the documented corrective action guidance.
