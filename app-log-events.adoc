...
[.lead]
app.log events are reported when this event is issued when an application is in a condition that should be corrected immediately, and corrective actions typically involve following the documented corrective action guidance.
