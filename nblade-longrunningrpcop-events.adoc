...
[.lead]
nblade.longrunningrpcop events are reported when a running remote procedure call (RPC) operation takes longer than a defined length of time, and corrective actions typically involve checking the reported configuration and connectivity.
