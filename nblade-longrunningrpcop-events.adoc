...
[.lead]
Learn about nblade.longrunningrpcop EMS events, which report when a running remote procedure call (RPC) operation takes longer than a defined length of time.
