...
[.lead]
nvme.fw events are reported when new firmware has been successfully activated on the drive and running normally, and corrective actions typically involve following the documented corrective action guidance.
