...
[.lead]
snapmirror.corrupted events are reported when metadata replay fails in the process of making a Synchronous SnapMirror(R) destination flexible volume writable, and corrective actions typically involve following the documented corrective action guidance.
