...
[.lead]
san.fcadapter events are reported when fC adapters hosting LIFs fails to initialize during node boot, and corrective actions typically involve rebooting the node or cluster component.
