...
[.lead]
lun.inaccessible events are reported when a LUN or NVMe namespace that is inaccessible due to restore is found in a volume, and corrective actions typically involve following the documented corrective action guidance.
