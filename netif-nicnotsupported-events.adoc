...
[.lead]
netif.nicnotsupported events are reported when the installed network interface card (NIC) version is not supported, and corrective actions typically involve following the documented corrective action guidance.
