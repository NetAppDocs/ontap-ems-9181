...
[.lead]
nvpm.extend events are reported when nvlog client segments cannot be enabled in a partner NVRAM section following a controller failover or MetroCluster(R) switchover, and corrective actions typically involve following the documented corrective action guidance.
