...
[.lead]
Learn about nvpm.extend EMS events, which report when nvlog client segments cannot be enabled in a partner NVRAM section following a controller failover or MetroCluster(R) switchover.
