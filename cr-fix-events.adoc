...
[.lead]
cr.fix events are reported when corrective action for corrupt redirector file failed, and corrective actions typically involve following the documented corrective action guidance.
