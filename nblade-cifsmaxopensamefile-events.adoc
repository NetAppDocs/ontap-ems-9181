...
[.lead]
nblade.cifsmaxopensamefile events are reported when the number of times a user tries to open a file over a TCP connection is exceeded, and corrective actions typically involve following the documented corrective action guidance.
