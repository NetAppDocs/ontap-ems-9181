...
[.lead]
vscan.newversion events are reported when the Vscan version mechanism allocates a new version-ID corresponding to the Vscan server version, and corrective actions typically involve following the documented corrective action guidance.
