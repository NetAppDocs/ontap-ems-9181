...
[.lead]
Learn about vscan.newversion EMS events, which report when the Vscan version mechanism allocates a new version-ID corresponding to the Vscan server version.
