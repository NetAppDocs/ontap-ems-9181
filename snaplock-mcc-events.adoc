...
[.lead]
Learn about snaplock.mcc EMS events, which report when SnapLock legal-hold or event based retention operations are aborted during a MetroCluster Switchback or a MetroCluster Switchover operation.
