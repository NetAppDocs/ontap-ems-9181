...
[.lead]
snaplock.mcc events are reported when snapLock legal-hold or event based retention operations are aborted during a MetroCluster Switchback or a MetroCluster Switchover operation, and corrective actions typically involve following the documented corrective action guidance.
