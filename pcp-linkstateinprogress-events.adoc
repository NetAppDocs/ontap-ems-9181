...
[.lead]
Learn about pcp.linkstateinprogress EMS events, which report when a change of network port state cannot be confirmed because another configuration task is in progress.
