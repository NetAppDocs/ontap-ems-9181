...
[.lead]
vifmgr.clus events are reported when a cluster link goes down unexpectedly, and corrective actions typically involve verifying the reported configuration and health state.
