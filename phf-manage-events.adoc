...
[.lead]
phf.manage events are reported when peripheral host bus adapter freebsd (phf) detects a device to be added to the system, and corrective actions typically involve following the documented corrective action guidance.
