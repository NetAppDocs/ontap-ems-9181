...
[.lead]
ses.disk events are reported when there are no longer any drives in a FAS2050 system's slots 20 through 23, and corrective actions typically involve following the documented corrective action guidance.
