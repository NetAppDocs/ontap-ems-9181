...
[.lead]
flexcache.origindisconnected events are reported when a FlexCache(R) volume cannot communicate with its origin volume, and corrective actions typically involve verifying the reported configuration and health state.
