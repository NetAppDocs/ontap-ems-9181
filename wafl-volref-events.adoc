...
[.lead]
wafl.volref events are reported when wafliron is started on aggregate containing volumes, which are in-use by other subsystems, and corrective actions typically involve following the documented corrective action guidance.
