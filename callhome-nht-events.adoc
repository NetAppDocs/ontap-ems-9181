...
[.lead]
callhome.nht events are reported when the weekly AutoSupport or 'call home' event is sent for any drive NHT data, and corrective actions typically involve following the documented corrective action guidance.
