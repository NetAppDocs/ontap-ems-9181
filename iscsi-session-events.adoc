...
[.lead]
iscsi.session events are reported when iSCSI session status is changed, and corrective actions typically involve following the documented corrective action guidance.
