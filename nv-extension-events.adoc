...
[.lead]
nv.extension events are reported when nVRAM segments of a nvlog client are disabled in a NVRAM section, and corrective actions typically involve following the documented corrective action guidance.
