...
[.lead]
cecc_log.entry_no_syslog events are reported when correctable ECC errors occurred in the system memory, and corrective actions typically involve following the documented corrective action guidance.
