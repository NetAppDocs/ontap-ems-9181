...
[.lead]
space.ratchet events are reported when this event is generated if the space ratchet catches a space-check error, and corrective actions typically involve following the documented corrective action guidance.
