...
[.lead]
replication.rmt events are reported when the remote system of a SnapMirror(R) or SnapVault(R) transfer does not have a host name, and corrective actions typically involve following the documented corrective action guidance.
