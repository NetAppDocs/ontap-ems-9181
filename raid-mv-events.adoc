...
[.lead]
raid.mv events are reported when aggregates are brought online in a deferred way after mirror votes are retrieved automatically, and corrective actions typically involve following the documented corrective action guidance.
