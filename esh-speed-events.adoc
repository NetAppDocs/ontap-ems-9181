...
[.lead]
esh.speed events are reported when there is an error in the link speed of the disk shelves that are attached to the node, and corrective actions typically involve following the documented corrective action guidance.
