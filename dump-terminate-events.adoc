...
[.lead]
dump.terminate events are reported when this event is generated during dump termination, we see if we can retrieve the name of the dump, and corrective actions typically involve following the documented corrective action guidance.
