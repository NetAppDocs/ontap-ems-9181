...
[.lead]
scsiblade.vserver events are reported when a command or other internal operation becomes blocked within Data ONTAP(R), and corrective actions typically involve following the documented corrective action guidance.
