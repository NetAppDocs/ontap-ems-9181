...
[.lead]
nblade.vscannodispatcher events are reported when the vscan-dispatcher component cannot be created, and corrective actions typically involve following the documented corrective action guidance.
