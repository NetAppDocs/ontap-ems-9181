...
[.lead]
wafl.nfsv4 events are reported when the system cannot map an ID stored in the Access Control Entry (ACE) to a valid UNIX(R) User ID/Group ID (UID/GID) pair, and corrective actions typically involve contacting NetApp technical support.
