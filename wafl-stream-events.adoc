...
[.lead]
wafl.stream events are reported when the "wafl scan stream_check" command is completed successfully, and corrective actions typically involve following the documented corrective action guidance.
