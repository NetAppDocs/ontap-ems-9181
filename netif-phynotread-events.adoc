...
[.lead]
Learn about netif.phynotread EMS events, which report when the system cannot read identification information from the physical layer (PHY) of a network interface.
