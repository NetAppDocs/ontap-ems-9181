...
[.lead]
nblade.showmountdisabled events are reported when the "showmount" command is triggered by client, but the command is disabled on the NFS server, and corrective actions typically involve following the documented corrective action guidance.
