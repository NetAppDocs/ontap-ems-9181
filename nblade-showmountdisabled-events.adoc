...
[.lead]
Learn about nblade.showmountdisabled EMS events, which report when the "showmount" command is triggered by client, but the command is disabled on the NFS server.
