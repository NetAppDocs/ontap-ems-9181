...
[.lead]
sas.8001 events are reported when the PM8001 serial-attached SCSI (SAS) host bus adapter reports an adapter firmware error, and corrective actions typically involve following the documented corrective action guidance.
