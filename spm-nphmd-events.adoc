...
[.lead]
spm.nphmd events are reported when the Controller Health Monitor process (nphmd) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
