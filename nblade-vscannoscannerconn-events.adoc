...
[.lead]
nblade.vscannoscannerconn events are reported when oNTAP(R) has no vscan connection for servicing virus scan-requests, and corrective actions typically involve ensuring the required configuration and resources are in place.
