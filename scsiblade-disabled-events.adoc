...
[.lead]
scsiblade.disabled events are reported when the local node is made ineligible, and corrective actions typically involve following the documented corrective action guidance.
