...
[.lead]
volcreate.name events are reported when flexible volumes were created with names which conflict with existing volume names, and corrective actions typically involve following the documented corrective action guidance.
