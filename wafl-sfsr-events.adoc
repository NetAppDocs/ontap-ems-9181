...
[.lead]
wafl.sfsr events are reported when this event is issued when the system is forced to abort a file restore, and corrective actions typically involve following the documented corrective action guidance.
