...
[.lead]
spm.shmd events are reported when the System Health Monitor process (shmd) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
