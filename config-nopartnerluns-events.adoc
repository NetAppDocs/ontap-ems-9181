...
[.lead]
Learn about config.nopartnerluns EMS events, which report when This message occurs in a High-Availablity (HA) configuration with array LUNS when there is no attachment to both local and partner LUNs.
