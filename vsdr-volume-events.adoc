...
[.lead]
vsdr.volume events are reported when the volume to be created on the destination cluster fails because of an internal identity conflict with another volume in the system, and corrective actions typically involve following the documented corrective action guidance.
