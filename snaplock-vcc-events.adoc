...
[.lead]
snaplock.vcc events are reported when the system detects mismatch in the SnapLock(R) volume compliance clock association with the system compliance clock, and corrective actions typically involve following the documented corrective action guidance.
