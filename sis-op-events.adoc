...
[.lead]
sis.op events are reported when this event is issued when a SIS volume operation is aborted due to unexpected conditions, and corrective actions typically involve following the documented corrective action guidance.
