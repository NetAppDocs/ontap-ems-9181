...
[.lead]
Learn about fg.plex EMS events, which report when a user unmirrors an aggregate (plex delete) that contains a FlexGroup constituent on nodes in a MetroCluster(tm) configuration.
