...
[.lead]
sp.notconfigured events are reported when this message occurs weekly to remind you to configure the Service Processor (SP), and corrective actions typically involve following the documented corrective action guidance.
