...
[.lead]
ctl.session events are reported when iSCSI CAM target layer session status is changed, and corrective actions typically involve following the documented corrective action guidance.
