...
[.lead]
Learn about cpeer.ip EMS events, which report when an attempt is made to insert an IP address whose address family does not match the family style specified for the cluster peer relationship.
