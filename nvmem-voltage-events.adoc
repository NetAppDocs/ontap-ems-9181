...
[.lead]
nvmem.voltage events are reported when the NVMEM supply voltage is high and the system is at a high risk of data loss if power fails, and corrective actions typically involve following the documented corrective action guidance.
