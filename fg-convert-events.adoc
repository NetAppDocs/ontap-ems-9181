...
[.lead]
fg.convert events are reported when the conversion of a FlexVol(R) volume into a FlexGroup fails, and corrective actions typically involve following the documented corrective action guidance.
