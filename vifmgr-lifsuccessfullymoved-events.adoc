...
[.lead]
vifmgr.lifsuccessfullymoved events are reported when a logical interface (LIF) IP address was successfully moved to another node/port, and corrective actions typically involve following the documented corrective action guidance.
