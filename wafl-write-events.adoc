...
[.lead]
wafl.write events are reported when a write to a file with CIFS-style space reservations fails due to a lack of space in the volume or aggregate, and corrective actions typically involve following the documented corrective action guidance.
