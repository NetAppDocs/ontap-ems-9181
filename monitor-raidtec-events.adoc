...
[.lead]
monitor.raidtec events are reported when this message occurs as part of an hourly system check, when a RAID-TEC aggregate is in double degraded mode, and corrective actions typically involve following the documented corrective action guidance.
