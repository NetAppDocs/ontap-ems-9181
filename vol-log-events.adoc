...
[.lead]
vol.log events are reported when the volume or aggregate allocates more space than it can honor by way of reservations, or the aggregate has allocated more space than it can honor by way of guarantees, and corrective actions typically involve following the documented corrective action guidance.
