...
[.lead]
fcvi.qlgc events are reported when total number of async events are overflowed, and corrective actions typically involve following the documented corrective action guidance.
