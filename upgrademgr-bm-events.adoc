...
[.lead]
upgrademgr.bm events are reported when the upgrade manager starts to update boot media of the node with the target ONTAP image, and corrective actions typically involve following the documented corrective action guidance.
