...
[.lead]
xfcvi.qlgc_regdumpfailed events are reported when the HA interconnect driver could not save a diagnostic dump, and corrective actions typically involve following the documented corrective action guidance.
