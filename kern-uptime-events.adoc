...
[.lead]
kern.uptime events are reported when this message occurs to display the uptime status of the controller, and corrective actions typically involve following the documented corrective action guidance.
