...
[.lead]
nvmf.roce events are reported when there was an internal error while creating a NVMe over RoCE logical network interface (LIF), and corrective actions typically involve following the documented corrective action guidance.
