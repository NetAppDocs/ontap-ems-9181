...
[.lead]
Learn about vsdr.invalid EMS events, which report when a package is licensed at the primary site but not licensed at the secondary site in a MetroCluster(tm) configuration or Vserver DR setup.
