...
[.lead]
vsdr.invalid events are reported when a package is licensed at the primary site but not licensed at the secondary site in a MetroCluster(tm) configuration or Vserver DR setup, and corrective actions typically involve following the documented corrective action guidance.
