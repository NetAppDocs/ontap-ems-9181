...
[.lead]
disk.toomanypartitioneddisks events are reported when data ONTAP(R) finds more partitioned disks present on a platform than the platform supports, and corrective actions typically involve following the documented corrective action guidance.
