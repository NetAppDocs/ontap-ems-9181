...
[.lead]
Learn about disk.toomanypartitioneddisks EMS events, which report when Data ONTAP(R) finds more partitioned disks present on a platform than the platform supports.
