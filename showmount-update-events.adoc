...
[.lead]
showmount.update events are reported when the showmount job fails to update the "exports, and corrective actions typically involve verifying the reported configuration and health state.
