...
[.lead]
repl.jumpahead events are reported when the system cannot bring a replica volume online after applying the latest update to the replica because of possible inconsistencies detected in the update, and corrective actions typically involve following the documented corrective action guidance.
