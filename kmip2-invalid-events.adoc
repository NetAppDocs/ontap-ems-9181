...
[.lead]
kmip2.invalid events are reported when oNTAP cannot push a key to a KMIP key server because the key has an invalid length, and corrective actions typically involve following the documented corrective action guidance.
