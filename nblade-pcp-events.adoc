...
[.lead]
nblade.pcp events are reported when a network port undergoes multiple link state transitions within a short period of time, and corrective actions typically involve following the documented corrective action guidance.
