...
[.lead]
diskown.ownerchangefailed events are reported when a disk ownership change request fails, and corrective actions typically involve verifying the reported configuration and health state.
