...
[.lead]
Learn about pci.init EMS events, which report when This message occurs to warn about the time taken by PCI initialization when PCI configuration is waiting for outstanding background threads that might still be running.
