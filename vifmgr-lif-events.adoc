...
[.lead]
vifmgr.lif events are reported when a LIF's failover policy has been modified, and corrective actions typically involve following the documented corrective action guidance.
