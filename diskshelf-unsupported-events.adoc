...
[.lead]
diskshelf.unsupported events are reported when oNTAP(R) software detects an unsupported disk shelf, and corrective actions typically involve verifying the reported configuration and health state.
