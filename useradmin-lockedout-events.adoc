...
[.lead]
Learn about useradmin.lockedout EMS events, which report when the user attempts to log into the appliance using an invalid password and the account has been disabled.
