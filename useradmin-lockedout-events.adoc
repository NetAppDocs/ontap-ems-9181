...
[.lead]
useradmin.lockedout events are reported when the user tries to log into the appliance using an invalid password and the account has been disabled, and corrective actions typically involve following the documented corrective action guidance.
