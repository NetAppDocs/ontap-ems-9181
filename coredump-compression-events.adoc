...
[.lead]
coredump.compression events are reported when a compressed kernel core is generated, and corrective actions typically involve following the documented corrective action guidance.
