...
[.lead]
cf.transition events are reported when a failover event is completed successfully, and corrective actions typically involve following the documented corrective action guidance.
