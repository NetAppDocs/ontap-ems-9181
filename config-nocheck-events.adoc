...
[.lead]
config.nocheck events are reported when the system should be halting, but it cannot because the "no-config-check?, and corrective actions typically involve following the documented corrective action guidance.
