...
[.lead]
scsiblade.vol events are reported when sAN initialization fails for the specified volume on this node, and corrective actions typically involve rebooting the node or cluster component.
