...
[.lead]
flexcache.originconnected events are reported when a FlexCache(R) volume establishes communication with its origin volume, and corrective actions typically involve following the documented corrective action guidance.
