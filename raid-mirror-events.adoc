...
[.lead]
raid.mirror events are reported when a SyncMirror(R) aggregate uses aggregate snapshots other than SyncMirror aggregate snapshots, and corrective actions typically involve following the documented corrective action guidance.
