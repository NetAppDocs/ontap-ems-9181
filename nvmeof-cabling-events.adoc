...
[.lead]
nvmeof.cabling events are reported when all of the cabling issues to the shelf have been corrected, and corrective actions typically involve following the documented corrective action guidance.
