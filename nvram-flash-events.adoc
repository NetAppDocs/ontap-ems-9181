...
[.lead]
nvram.flash events are reported when this message occurs periodically when the capacity of the NVRAM flash memory spare blocks is low, before it becomes critically low, and corrective actions typically involve contacting NetApp technical support.
