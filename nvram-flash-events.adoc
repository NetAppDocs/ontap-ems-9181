...
[.lead]
Learn about nvram.flash EMS events, which report when This message occurs periodically when the capacity of the NVRAM flash memory spare blocks is low, before it becomes critically low.
