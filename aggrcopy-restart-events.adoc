...
[.lead]
aggrcopy.restart events are reported when 'aggr copy' checks for restart capability on the destination storage system fail, and corrective actions typically involve following the documented corrective action guidance.
