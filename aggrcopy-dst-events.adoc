...
[.lead]
aggrcopy.dst events are reported when this event is issued when an aggregate copy start is issued on an aggregate which is offline, and corrective actions typically involve following the documented corrective action guidance.
