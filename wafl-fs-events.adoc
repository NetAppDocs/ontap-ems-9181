...
[.lead]
wafl.fs events are reported when this message occurs during volume mount, when the fractional reservation value for a volume is found to be corrupted, and corrective actions typically involve following the documented corrective action guidance.
