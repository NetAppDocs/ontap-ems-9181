...
[.lead]
wafl.qtree events are reported when a qtree ID derived from a WAFL(R) buffer does not match the given tree ID in a snapshot, and corrective actions typically involve following the documented corrective action guidance.
