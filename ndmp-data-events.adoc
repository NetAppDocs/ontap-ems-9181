...
[.lead]
Learn about ndmp.data EMS events, which report when the IP address of the logical interface (LIF) that hosts the NDMP data connection is hosted on maintenance port "e0M".
