...
[.lead]
sfu.downloadingcontroller events are reported when a disk shelf firmware download starts on a specific disk shelf, and corrective actions typically involve following the documented corrective action guidance.
