...
[.lead]
smtape.bkp events are reported when an SMTape backup operation is aborted because a write to tape device fails, and corrective actions typically involve following the documented corrective action guidance.
