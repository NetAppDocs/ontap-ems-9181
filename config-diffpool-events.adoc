...
[.lead]
config.diffpool events are reported when a disk is found to be multipathed to two different mirroring pools, and corrective actions typically involve following the documented corrective action guidance.
