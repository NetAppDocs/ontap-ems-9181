...
[.lead]
bcomd.fcplifremoved events are reported when a Fibre Channel logical interface (LIF) is removed, and corrective actions typically involve following the documented corrective action guidance.
