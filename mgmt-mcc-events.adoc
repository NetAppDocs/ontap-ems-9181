...
[.lead]
Learn about mgmt.mcc EMS events, which report when MetroCluster(tm) switchback or switchover happens while applying a file security (fsecurity) policy on the MetroCluster partner.
