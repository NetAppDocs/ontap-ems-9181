...
[.lead]
Learn about nblade.vscanconninvaliduser EMS events, which report when This message occurs during a client attempt to establish a vscan connection, when the logged-in user of that client is not found in the list of allowed users.
