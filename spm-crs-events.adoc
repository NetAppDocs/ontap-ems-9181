...
[.lead]
spm.crs events are reported when the configuration replication server (crs) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
