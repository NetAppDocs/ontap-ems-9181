...
[.lead]
wafl.cde events are reported when the WAFL(R) kernel cannot decompress a compressed user data block, and corrective actions typically involve contacting NetApp technical support.
