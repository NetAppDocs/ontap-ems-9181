...
[.lead]
Learn about mpt.phydisk EMS events, which report when the system cannot allocate a physical disk path in the message processing technology (MPT) adapter driver.
