...
[.lead]
mpt.phydisk events are reported when the system cannot allocate a physical disk path in the message processing technology (MPT) adapter driver, and corrective actions typically involve checking the reported configuration and connectivity.
