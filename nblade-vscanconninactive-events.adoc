...
[.lead]
nblade.vscanconninactive events are reported when oNTAP(R) detects a nonresponsive antivirus (AV) server and forcibly closes its vscan connection, and corrective actions typically involve ensuring the required configuration and resources are in place.
