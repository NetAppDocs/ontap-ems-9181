...
[.lead]
Learn about nblade.vscanconninactive EMS events, which report when ONTAP(R) detects a nonresponsive antivirus (AV) server and forcibly closes its vscan connection.
