...
[.lead]
Learn about diskown.diskhaswronginfo EMS events, which report when the disk ownership information on a disk does not belong to the disk that it was read from.
