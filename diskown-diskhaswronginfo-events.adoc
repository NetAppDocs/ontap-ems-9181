...
[.lead]
diskown.diskhaswronginfo events are reported when the disk ownership information on a disk does not belong to the disk that it was read from, and corrective actions typically involve following the documented corrective action guidance.
