...
[.lead]
fmmb.destroy events are reported when this event is issued when the high-availability (HA) Mailbox contents are cleared, typically by the 'mailbox destroy' command, and corrective actions typically involve following the documented corrective action guidance.
