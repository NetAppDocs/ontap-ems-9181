...
[.lead]
lmgr.sendhome events are reported when this message occurs during an SFO aggregate giveback or relocation, and corrective actions typically involve following the documented corrective action guidance.
