...
[.lead]
Learn about sp.snmp EMS events, which report when This message occurs each time a system boots, if the advanced privilege level in Data ONTAP(R) was used to disable the SNMP Trap feature of the Service Processor (SP).
