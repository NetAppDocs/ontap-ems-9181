...
[.lead]
mav.disabled events are reported when multi-admin verification (MAV) is enabled, the bootarg "bootarg, and corrective actions typically involve following the documented corrective action guidance.
