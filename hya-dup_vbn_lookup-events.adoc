...
[.lead]
hya.dup_vbn_lookup events are reported when this event is generated if we detect redundant lookups of a PVBN without an intervening suspend, and corrective actions typically involve following the documented corrective action guidance.
