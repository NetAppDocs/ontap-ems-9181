...
[.lead]
certificate.invalid events are reported when an installed certificate record contains multiple X, and corrective actions typically involve following the documented corrective action guidance.
