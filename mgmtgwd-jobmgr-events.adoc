...
[.lead]
mgmtgwd.jobmgr events are reported when the system cannot locate the configuration for a specific Vserver, and corrective actions typically involve following the documented corrective action guidance.
