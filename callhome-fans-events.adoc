...
[.lead]
callhome.fans events are reported when multiple fans inside the appliance case fail, and corrective actions typically involve following the documented corrective action guidance.
