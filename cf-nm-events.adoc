...
[.lead]
cf.nm events are reported when the controller performs a soft reset of the HA interconnect card as part of automatic recovery from a timeout or link error, and corrective actions typically involve following the documented corrective action guidance.
