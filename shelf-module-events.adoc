...
[.lead]
shelf.module events are reported when the system cannot complete the configuration of a disk shelf module with the desired parameters, and corrective actions typically involve contacting NetApp technical support.
