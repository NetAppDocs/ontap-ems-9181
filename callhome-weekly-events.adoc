...
[.lead]
callhome.weekly events are reported when the weekly AutoSupport or 'call home' event is sent, and corrective actions typically involve following the documented corrective action guidance.
