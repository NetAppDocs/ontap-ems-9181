...
[.lead]
snapdiff.rebl events are reported when snapDiff(R), the snapshot copy differencing engine, encounters an absent allocated block, and no corrective action is typically required.
