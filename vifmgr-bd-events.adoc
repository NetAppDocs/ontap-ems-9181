...
[.lead]
vifmgr.bd events are reported when an MTU is entered on a Broadcast Domain that its member ports cannot support, and corrective actions typically involve following the documented corrective action guidance.
