...
[.lead]
volume.check events are reported when a 'volume check' scan successfully runs to completion, and corrective actions typically involve following the documented corrective action guidance.
