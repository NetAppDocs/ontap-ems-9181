...
[.lead]
snapvault.tgt events are reported when snapVault(R) detects more than one coalesced snapshot of a specific type in a SnapVault secondary volume, and corrective actions typically involve following the documented corrective action guidance.
