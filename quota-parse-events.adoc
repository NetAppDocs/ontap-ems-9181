...
[.lead]
quota.parse events are reported when the system detects an error while scanning the quota rules, and corrective actions typically involve following the documented corrective action guidance.
