...
[.lead]
vifmgr.portowner events are reported when a port receives a configuration error, and corrective actions typically involve following the documented corrective action guidance.
