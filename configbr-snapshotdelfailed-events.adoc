...
[.lead]
configbr.snapshotdelfailed events are reported when a Snapshot(tm) copy on the root volume cannot be deleted, and corrective actions typically involve ensuring the required configuration and resources are in place.
