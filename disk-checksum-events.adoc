...
[.lead]
disk.checksum events are reported when multiple errors are detected during checksum verification, and corrective actions typically involve following the documented corrective action guidance.
