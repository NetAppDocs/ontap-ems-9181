...
[.lead]
vifmgr.reach events are reported when the node has completed its initial scan of reachability for all ports, and corrective actions typically involve following the documented corrective action guidance.
