...
[.lead]
fp.est events are reported when the volume footprint estimator scan fails to update the catalog file, and corrective actions typically involve checking the reported configuration and connectivity.
