...
[.lead]
sis.vol events are reported when deprioritized volume gets auto promoted, and corrective actions typically involve following the documented corrective action guidance.
