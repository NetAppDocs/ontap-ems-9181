...
[.lead]
fg.unconfig events are reported when a FlexGroup detects constituents that are not properly configured and have not been removed after a sufficient timeout, and corrective actions typically involve contacting NetApp technical support.
