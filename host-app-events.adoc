...
[.lead]
host.app events are reported when a host encounters an error specific to an application component, and corrective actions typically involve following the documented corrective action guidance.
