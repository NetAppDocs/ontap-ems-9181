...
[.lead]
nvdimm.excessive events are reported when excessive correctable error-correcting code (ECC) memory errors are reported by the NVDIMM controller, and corrective actions typically involve following the documented corrective action guidance.
