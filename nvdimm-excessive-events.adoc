...
[.lead]
Learn about nvdimm.excessive EMS events, which report when excessive correctable error-correcting code (ECC) memory errors are reported by the NVDIMM controller.
