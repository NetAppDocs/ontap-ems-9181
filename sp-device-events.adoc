...
[.lead]
sp.device events are reported when the service processor (SP) detects a firmware version mismatch among the devices managed by the SP, and corrective actions typically involve contacting NetApp technical support.
