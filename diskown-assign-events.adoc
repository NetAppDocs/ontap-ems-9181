...
[.lead]
Learn about diskown.assign EMS events, which report when the "storage disk assign" command fail to assign a disk to a different owner from the other disks within the carrier.
