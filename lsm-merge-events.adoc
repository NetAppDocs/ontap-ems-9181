...
[.lead]
lsm.merge events are reported when a block store encounters an error while merging an append log, and corrective actions typically involve following the documented corrective action guidance.
