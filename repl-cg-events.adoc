...
[.lead]
repl.cg events are reported when the number of Consistency Group Items involved in a SnapMirror(R) Granular Sync relationship exceeds its limit in the system, and corrective actions typically involve following the documented corrective action guidance.
