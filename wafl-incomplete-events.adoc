...
[.lead]
wafl.incomplete events are reported when the WAFL(R) kernel detects incomplete inode to path information for an inode on disk, and corrective actions typically involve following the documented corrective action guidance.
