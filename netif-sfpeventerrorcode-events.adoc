...
[.lead]
netif.sfpeventerrorcode events are reported when the installed Small Form-factor Pluggable (SFP+ or QSFP+) module is either not supported or faulty, and corrective actions typically involve following the documented corrective action guidance.
