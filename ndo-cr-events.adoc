...
[.lead]
ndo.cr events are reported when a controller replacement operation is canceled by the operator, and corrective actions typically involve following the documented corrective action guidance.
