...
[.lead]
shm.threshold events are reported when the system detects a disk that exceeds the threshold count of high aggressive IO latencies, and corrective actions typically involve following the documented corrective action guidance.
