...
[.lead]
dfu.clustertakeover events are reported when firmware download is attempted while in takeover mode, and corrective actions typically involve following the documented corrective action guidance.
