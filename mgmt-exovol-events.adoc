...
[.lead]
mgmt.exovol events are reported when the replication engine fails to transfer exo-volume data, and corrective actions typically involve following the documented corrective action guidance.
