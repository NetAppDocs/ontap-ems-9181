...
[.lead]
air.fc events are reported when inconsistencies are detected in the origin of this FlexCache(R) volume, and corrective actions typically involve following the documented corrective action guidance.
