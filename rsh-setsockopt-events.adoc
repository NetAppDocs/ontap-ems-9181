...
[.lead]
rsh.setsockopt events are reported when the setsockopt option on the RemoteShell(RSH) socket fails; RSH is not available, and corrective actions typically involve following the documented corrective action guidance.
