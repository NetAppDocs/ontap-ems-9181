...
[.lead]
vifmgr.portdeg events are reported when an administrative action adds a port with a degraded health status to an interface group, and corrective actions typically involve following the documented corrective action guidance.
