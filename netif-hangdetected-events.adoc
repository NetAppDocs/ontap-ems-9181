...
[.lead]
netif.hangdetected events are reported when a network interface driver detects that an interface is hung, and corrective actions typically involve following the documented corrective action guidance.
