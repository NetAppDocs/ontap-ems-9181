...
[.lead]
km.volume events are reported when this message occurs during the recovery of the key manager when a volume is placed online, but fails to mount, and corrective actions typically involve following the documented corrective action guidance.
