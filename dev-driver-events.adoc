...
[.lead]
dev.driver events are reported when an I/O driver is throttling I/O requests because the underlying controller is overloaded with I/O requests, and corrective actions typically involve following the documented corrective action guidance.
