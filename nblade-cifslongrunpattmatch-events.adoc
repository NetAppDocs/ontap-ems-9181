...
[.lead]
Learn about nblade.cifslongrunpattmatch EMS events, which report when a CIFS query directory command that includes wildcard characters exceeds the reporting time threshold for completion.
