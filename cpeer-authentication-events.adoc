...
[.lead]
cpeer.authentication events are reported when authentication is successfully established with a peer cluster, and corrective actions typically involve following the documented corrective action guidance.
