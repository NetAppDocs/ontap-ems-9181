...
[.lead]
upgrademgr.node events are reported when a cluster node takes more than 30 minutes to reach giveback ready state during automated nondisruptive upgrade, and corrective actions typically involve following the documented corrective action guidance.
