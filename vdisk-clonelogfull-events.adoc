...
[.lead]
Learn about vdisk.clonelogfull EMS events, which report when LUN clone creation has failed because the limit on the maximum supported entries(32705) has been exceeded.
