...
[.lead]
Learn about rdb.node EMS events, which report when the replicated database (RDB) detects CPU starvation on this node, potentially causing it to leave cluster quorum.
