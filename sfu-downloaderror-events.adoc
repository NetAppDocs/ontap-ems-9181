...
[.lead]
sfu.downloaderror events are reported when a disk shelf firmware update fails to successfully download firmware to a disk shelf or shelves in the system, and corrective actions typically involve following the documented corrective action guidance.
