...
[.lead]
Learn about sfu.downloaderror EMS events, which report when a disk shelf firmware update fails to successfully download firmware to a disk shelf or shelves in the system.
