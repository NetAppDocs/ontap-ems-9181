...
[.lead]
callhome.user events are reported when a SNMP (Simple Network Management Protocol) has been configured to cause an SNMP trap, and corrective actions typically involve following the documented corrective action guidance.
