...
[.lead]
dfu.nomemory events are reported when the disk firmware update routine cannot allocate memory to update the disk firmware, and corrective actions typically involve following the documented corrective action guidance.
