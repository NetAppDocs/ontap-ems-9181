...
[.lead]
vifmgr.porthealthy events are reported when port health status changes from degraded to healthy, and corrective actions typically involve following the documented corrective action guidance.
