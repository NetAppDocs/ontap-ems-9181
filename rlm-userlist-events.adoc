...
[.lead]
rlm.userlist events are reported when there was an error while updating user information for the Remote Lan Module (RLM), and corrective actions typically involve following the documented corrective action guidance.
