...
[.lead]
Learn about sp.postupd EMS events, which report when This message occurs after a scheduled firmware update, when the servprocd daemon detects that the Service Processor(SP) firmware version changed to an unexpected value.
