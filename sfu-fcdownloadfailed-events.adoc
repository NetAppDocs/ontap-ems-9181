...
[.lead]
sfu.fcdownloadfailed events are reported when a disk shelf firmware update fails to download shelf firmware to an FC or an ATA shelf successfully, and corrective actions typically involve following the documented corrective action guidance.
