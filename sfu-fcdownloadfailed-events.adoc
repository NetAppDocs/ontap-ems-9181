...
[.lead]
Learn about sfu.fcdownloadfailed EMS events, which report when a disk shelf firmware update fails to download shelf firmware to an FC or an ATA shelf successfully.
