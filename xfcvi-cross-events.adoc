...
[.lead]
xfcvi.cross events are reported when the xfcvi driver detects a cross connection, and corrective actions typically involve checking the reported configuration and connectivity.
