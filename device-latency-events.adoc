...
[.lead]
device.latency events are reported when a device exceeds the latency threshold for the 30- second monitoring period, and corrective actions typically involve contacting NetApp technical support.
