...
[.lead]
Learn about zapi.snapshot EMS events, which report when This event occurs when an asynchronous Snapshot(tm) copy is created successfully through the Zephyr API (ZAPI) interface.
