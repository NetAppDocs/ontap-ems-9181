...
[.lead]
zapi.snapshot events are reported when an asynchronous Snapshot(tm) copy is created successfully through the Zephyr API (ZAPI) interface, and corrective actions typically involve following the documented corrective action guidance.
