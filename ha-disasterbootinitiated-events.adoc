...
[.lead]
ha.disasterbootinitiated events are reported when an HA disaster recovery boot is initiated, and corrective actions typically involve following the documented corrective action guidance.
