...
[.lead]
lmgr.notify events are reported when the volume lock manager cannot write to the notify hosts file due to an error, for example, insufficient space, and corrective actions typically involve following the documented corrective action guidance.
