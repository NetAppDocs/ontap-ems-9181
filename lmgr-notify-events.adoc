...
[.lead]
Learn about lmgr.notify EMS events, which report when the volume lock manager cannot write to the notify hosts file due to an error, for example, insufficient space.
