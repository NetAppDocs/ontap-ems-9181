...
[.lead]
callhome.wafliron events are reported when wAFL(R) Iron (wafliron) Optional Commit changes are pending, and corrective actions typically involve following the documented corrective action guidance.
