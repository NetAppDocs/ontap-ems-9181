...
[.lead]
sas.link events are reported when the SAS adapter was unable to recover the link and is going offline, and corrective actions typically involve following the documented corrective action guidance.
