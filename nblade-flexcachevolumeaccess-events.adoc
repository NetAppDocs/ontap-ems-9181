...
[.lead]
nblade.flexcachevolumeaccess events are reported when a client tries to access a FlexCache volume through an unsupported protocol, and corrective actions typically involve following the documented corrective action guidance.
