...
[.lead]
hotplug.insert events are reported when the module type does not match the system's record for this slot, and corrective actions typically involve following the documented corrective action guidance.
