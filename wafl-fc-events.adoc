...
[.lead]
Learn about wafl.fc EMS events, which report when a FlexCache(R) origin node detects that its FlexCache volume has disconnected while a lock reclaim operation is in progress.
