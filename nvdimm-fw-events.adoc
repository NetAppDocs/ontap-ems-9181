...
[.lead]
nvdimm.fw events are reported when nVDIMM controller firmware failed to upgrade, and corrective actions typically involve following the documented corrective action guidance.
