...
[.lead]
disk.writeverifyerror events are reported when a write verify error occurs, and corrective actions typically involve following the documented corrective action guidance.
