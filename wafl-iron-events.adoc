...
[.lead]
wafl.iron events are reported when wafliron is running on a transitioned aggregate in precommit phase and there are 7-Mode volumes present, and corrective actions typically involve following the documented corrective action guidance.
