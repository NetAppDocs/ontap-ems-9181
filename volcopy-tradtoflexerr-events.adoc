...
[.lead]
Learn about volcopy.tradtoflexerr EMS events, which report when the user attempts to copy a traditional volume into a flexible volume using the command 'vol copy'.
