...
[.lead]
command.complex events are reported when a custom role associated with a Storage Virtual Machine has a command directory with complex query, and corrective actions typically involve following the documented corrective action guidance.
