...
[.lead]
arw.new events are reported when a new file extension is observed in anti-ransomware enabled volume, and corrective actions typically involve following the documented corrective action guidance.
