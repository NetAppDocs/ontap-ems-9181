...
[.lead]
ctran.group events are reported when an attempt to reset a group by Kernel Cluster Services (KCS) Cluster Transaction Manager (CTRAN) fails, and corrective actions typically involve following the documented corrective action guidance.
