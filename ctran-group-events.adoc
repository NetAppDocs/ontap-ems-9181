...
[.lead]
Learn about ctran.group EMS events, which report when an attempt to reset a group by Kernel Cluster Services (KCS) Cluster Transaction Manager (CTRAN) fails.
