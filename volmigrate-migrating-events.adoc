...
[.lead]
volmigrate.migrating events are reported when a volume is being migrated from the filer by means of a SAN ownership change, and corrective actions typically involve following the documented corrective action guidance.
