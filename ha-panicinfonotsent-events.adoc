...
[.lead]
Learn about ha.panicinfonotsent EMS events, which report when a node cannot send panic information to its high-availability (HA) partner over the HA interconnect.
