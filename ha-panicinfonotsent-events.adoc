...
[.lead]
ha.panicinfonotsent events are reported when a node cannot send panic information to its high-availability (HA) partner over the HA interconnect, and corrective actions typically involve following the documented corrective action guidance.
