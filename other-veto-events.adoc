...
[.lead]
other.veto events are reported when a giveback or aggregate relocation operation fails but ONTAP(R) software cannot determine the specific operation type, and corrective actions typically involve following the documented corrective action guidance.
