...
[.lead]
qtree.delete events are reported when the delete operation on a qtree fails, and corrective actions typically involve checking the reported configuration and connectivity.
