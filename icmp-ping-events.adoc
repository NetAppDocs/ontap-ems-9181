...
[.lead]
icmp.ping events are reported when the system receives a burst of ICMP ping packet within a one-second interval, and corrective actions typically involve following the documented corrective action guidance.
