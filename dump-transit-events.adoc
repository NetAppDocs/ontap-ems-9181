...
[.lead]
Learn about dump.transit EMS events, which report when This event is generated when the failover is still in transit while waiting for the dump to be initialized.
