...
[.lead]
dcs.framework events are reported when the DCS framework has been disabled on this node, and corrective actions typically involve following the documented corrective action guidance.
