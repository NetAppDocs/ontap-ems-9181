...
[.lead]
secd.unixlookupfailure events are reported when an UNIXi(R) user or group lookup fails, and corrective actions typically involve following the documented corrective action guidance.
