...
[.lead]
mgmtgwd.configbr events are reported when a scheduled configuration backup is successfully created, and corrective actions typically involve following the documented corrective action guidance.
