...
[.lead]
disk.lun events are reported when this message occurs to confirm that enough memory is present to successfully allocate command blocks for all of the disks in the system and for additional LUNS, and corrective actions typically involve following the documented corrective action guidance.
