...
[.lead]
dfu.firmwaredownrev events are reported when the system finds disks with a downrev version of firmware, as defined by the installed version of Data ONTAP(R), and corrective actions typically involve following the documented corrective action guidance.
