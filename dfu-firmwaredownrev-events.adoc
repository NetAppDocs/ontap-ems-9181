...
[.lead]
Learn about dfu.firmwaredownrev EMS events, which report when the system finds disks with a downrev version of firmware, as defined by the installed version of Data ONTAP(R).
