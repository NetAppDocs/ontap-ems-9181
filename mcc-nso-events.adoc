...
[.lead]
mcc.nso events are reported when dump/restore is aborted during a MetroCluster switch-over operation, and corrective actions typically involve following the documented corrective action guidance.
