...
[.lead]
scsi.cmd events are reported when the aborted event is issued if an I/O request is aborted by a class driver, and corrective actions typically involve following the documented corrective action guidance.
