...
[.lead]
gpo.sec events are reported when applying group policy object (GPO) event audit policy settings succeeds, and corrective actions typically involve following the documented corrective action guidance.
