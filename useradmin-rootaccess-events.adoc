...
[.lead]
Learn about useradmin.rootaccess EMS events, which report when The root account has been enabled or disabled due to the option security.rootaccess.enable.
