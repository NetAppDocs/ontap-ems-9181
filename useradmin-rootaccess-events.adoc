...
[.lead]
useradmin.rootaccess events are reported when the root account has been enabled or disabled because of the option security, and corrective actions typically involve following the documented corrective action guidance.
