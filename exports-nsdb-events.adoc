...
[.lead]
Learn about exports.nsdb EMS events, which report when a user string cannot be mapped to a user id when evaluating the "-anon" portion of an export-policy rule.
