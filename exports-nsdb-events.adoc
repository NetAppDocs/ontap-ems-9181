...
[.lead]
exports.nsdb events are reported when a user string cannot be mapped to a user id when evaluating the "-anon" portion of an export-policy rule, and corrective actions typically involve following the documented corrective action guidance.
