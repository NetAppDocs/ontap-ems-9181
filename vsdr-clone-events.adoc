...
[.lead]
vsdr.clone events are reported when a clone create job fails prematurely, and corrective actions typically involve following the documented corrective action guidance.
