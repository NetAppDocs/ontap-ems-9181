...
[.lead]
fci.fabric events are reported when a switch in the fabric attached to the Fibre Channel adapter exceeds the maximum number of ports allowed on a switch, and corrective actions typically involve following the documented corrective action guidance.
