...
[.lead]
Learn about cs.create EMS events, which report when there is an attempt to release SnapMirror resources for a volume as a result of volume delete while a Cloud Snapshot create operation is in progress.
