...
[.lead]
fci.flash events are reported when there is a failure updating the Fibre Channel adapter flash preload table, and corrective actions typically involve following the documented corrective action guidance.
