...
[.lead]
smbc.aufo events are reported when the SnapMirror(R) active sync automatic unplanned failover operation completes, and corrective actions typically involve following the documented corrective action guidance.
