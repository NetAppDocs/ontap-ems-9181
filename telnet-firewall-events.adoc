...
[.lead]
telnet.firewall events are reported when telnet is automatically removed from firewall policies during a revert operation from Data ONTAP(R) 9, and corrective actions typically involve following the documented corrective action guidance.
