...
[.lead]
Learn about nblade.flexgroupstatefulprotocolaccess EMS events, which report when the system detects an attempt to use Network Lock Manager (NLM) shared locks on a FlexGroup volume.
