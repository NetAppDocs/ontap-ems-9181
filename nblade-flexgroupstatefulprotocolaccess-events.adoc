...
[.lead]
nblade.flexgroupstatefulprotocolaccess events are reported when the system detects an attempt to use Network Lock Manager (NLM) shared locks on a FlexGroup volume, and corrective actions typically involve following the documented corrective action guidance.
