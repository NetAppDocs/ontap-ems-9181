...
[.lead]
wafl.inconsistent events are reported when the ONTAP(R) kernel detects an inconsistent WAFL(R) Access Control List (ACL) on disk, and corrective actions typically involve contacting NetApp technical support.
