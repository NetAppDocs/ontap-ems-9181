...
[.lead]
air.corrected events are reported when the Automated Incremental Repair (AIR) subsystem repairs an inode having a corrupted qtree ID, and corrective actions typically involve following the documented corrective action guidance.
