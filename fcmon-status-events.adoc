...
[.lead]
fcmon.status events are reported when fCMON starts up, halts or is requested to print it's current state, and no corrective action is typically required.
