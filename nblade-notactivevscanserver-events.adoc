...
[.lead]
Learn about nblade.notactivevscanserver EMS events, which report when a connection from a remote IP is not found in the Vscan scanner pool belonging to the storage virtual machine (SVM).
