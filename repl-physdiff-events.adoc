...
[.lead]
repl.physdiff events are reported when a block to replicate was found to be inconsistent in the source volume, and corrective actions typically involve following the documented corrective action guidance.
