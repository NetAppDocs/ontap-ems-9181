...
[.lead]
connectx.cmdinterface events are reported when the command interface of ConnectX HA interconnect hardware is temporarily hung, and corrective actions typically involve following the documented corrective action guidance.
