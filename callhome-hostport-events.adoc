...
[.lead]
callhome.hostport events are reported when an Embedded Switched Hub (ESH) bypasses a host port due to excessive errors on the port, and corrective actions typically involve following the documented corrective action guidance.
