...
[.lead]
Learn about ndmp.password EMS events, which report when This message occurs on NDMP service startup, when the password for the NDMP user account is still the default password.
