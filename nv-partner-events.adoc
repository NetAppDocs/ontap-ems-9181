...
[.lead]
nv.partner events are reported when checking the partner nonvolatile RAM (NVRAM) and the partner NVRAM is disabled, and corrective actions typically involve following the documented corrective action guidance.
