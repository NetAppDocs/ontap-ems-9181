...
[.lead]
lmgr.enable events are reported when the enabling of the remote lock functionality is unsuccessful due to insufficient storage space, and corrective actions typically involve following the documented corrective action guidance.
