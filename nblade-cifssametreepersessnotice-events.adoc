...
[.lead]
Learn about nblade.cifssametreepersessnotice EMS events, which report when the number of connections to the same share allowed per session nears the configured limit.
