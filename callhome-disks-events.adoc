...
[.lead]
callhome.disks events are reported when the system detected simultaneously that multiple disk drives were missing from the system, and corrective actions typically involve following the documented corrective action guidance.
