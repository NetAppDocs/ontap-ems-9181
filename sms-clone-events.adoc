...
[.lead]
Learn about sms.clone EMS events, which report when SnapMirror(R) Synchronous fails a clone request because the relation is temporarily in a state that does not permit clone replication.
