...
[.lead]
Learn about config.sas2domain EMS events, which report when a disk is multipathed to one SAS domain; that is, both ports of the disk are visible from the same HBA port.
