...
[.lead]
coredump.dump events are reported when there is an unsaved core on the dump device, and corrective actions typically involve following the documented corrective action guidance.
