...
[.lead]
pubsub.kernel events are reported when this message will not be published as flow control is enabled on kernel pubsub, and corrective actions typically involve checking the reported configuration and connectivity.
