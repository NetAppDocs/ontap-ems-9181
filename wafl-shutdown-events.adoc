...
[.lead]
wafl.shutdown events are reported when this message occurs during shutdown, to indicate that a volume has not been marked clean, and corrective actions typically involve following the documented corrective action guidance.
