...
[.lead]
Learn about cifs.lug EMS events, which report when the job to import CIFS local users and groups is completed successfully only at a primary site within a MetroCluster(R) configuration or Vserver DR setup.
