...
[.lead]
flexcache.softevict events are reported when soft evicting a cache volume fails, and corrective actions typically involve following the documented corrective action guidance.
