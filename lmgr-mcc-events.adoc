...
[.lead]
Learn about lmgr.mcc EMS events, which report when the system vetoes MetroCluster(TM) switchback or negotiated switchover because CIFS oplock recall fails.
