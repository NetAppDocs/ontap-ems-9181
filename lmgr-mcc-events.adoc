...
[.lead]
lmgr.mcc events are reported when the system vetoes MetroCluster(TM) switchback or negotiated switchover because CIFS oplock recall fails, and corrective actions typically involve following the documented corrective action guidance.
