...
[.lead]
dfu.disksizechanged events are reported when a size change is detected after a firmware update, and corrective actions typically involve following the documented corrective action guidance.
