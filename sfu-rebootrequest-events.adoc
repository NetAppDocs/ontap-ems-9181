...
[.lead]
Learn about sfu.rebootrequest EMS events, which report when the disk shelf firmware update is complete and the disk shelf will be rebooted to run the new code.
