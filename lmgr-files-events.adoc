...
[.lead]
Learn about lmgr.files EMS events, which report when a lock manager file object cannot be allocated due to reaching the limit for file objects in the associated pool.
