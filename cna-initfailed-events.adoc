...
[.lead]
cna.initfailed events are reported when the converged network adapter (CNA) fails to initialize, and corrective actions typically involve following the documented corrective action guidance.
