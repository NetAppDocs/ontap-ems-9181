...
[.lead]
coredump.mcc events are reported when the coredump subsystem vetoes MetroCluster(tm) negotiated switchover because a coredump save is in progress, and corrective actions typically involve following the documented corrective action guidance.
