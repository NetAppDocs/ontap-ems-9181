...
[.lead]
Learn about coredump.mcc EMS events, which report when the coredump subsystem vetoes MetroCluster(tm) negotiated switchover because a coredump save is in progress.
