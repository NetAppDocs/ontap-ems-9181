...
[.lead]
Learn about adt.max EMS events, which report when a management command or file operation attempts to generate an audit record larger than the max_audit_record_size value.
