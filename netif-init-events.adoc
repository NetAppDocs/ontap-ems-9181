...
[.lead]
netif.init events are reported when initialization of a network interface failed due to an unexpected software error, and corrective actions typically involve contacting NetApp technical support.
