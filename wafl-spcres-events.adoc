...
[.lead]
Learn about wafl.spcres EMS events, which report when This event indicates that the new space reservation guarantee was unabled to be obtained, so the old reservation type was kept unchanged.
