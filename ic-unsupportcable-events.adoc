...
[.lead]
ic.unsupportcable events are reported when an unsupported cable is detected on the high-availability interconnect port, and corrective actions typically involve following the documented corrective action guidance.
