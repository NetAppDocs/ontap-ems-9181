...
[.lead]
snapmirror.log events are reported when this event is issued when an error is encountered when opening the SnapMirror log file for writing, and corrective actions typically involve following the documented corrective action guidance.
