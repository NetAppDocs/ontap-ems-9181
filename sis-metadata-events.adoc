...
[.lead]
sis.metadata events are reported when inconsistencies are found in deduplication metadata, and corrective actions typically involve following the documented corrective action guidance.
