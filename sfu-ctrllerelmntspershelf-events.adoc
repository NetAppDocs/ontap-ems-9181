...
[.lead]
Learn about sfu.ctrllerelmntspershelf EMS events, which report when a disk shelf firmware download determines the number of controller elements per shelf that can be downloaded.
