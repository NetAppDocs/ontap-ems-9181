...
[.lead]
ses.status events are reported when a failure has been detected in ACP processor that provides alternate control path capability, and corrective actions typically involve following the documented corrective action guidance.
