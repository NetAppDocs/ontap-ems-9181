...
[.lead]
Learn about fg.provision EMS events, which report when a user provisions a FlexGroup on unmirrored aggregates on nodes in a MetroCluster(tm) configuration.
