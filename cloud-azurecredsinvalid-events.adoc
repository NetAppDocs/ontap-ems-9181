...
[.lead]
cloud.azurecredsinvalid events are reported when the system acquires Azure Managed Service Identity (MSI) credentials that are not valid, and corrective actions typically involve following the documented corrective action guidance.
