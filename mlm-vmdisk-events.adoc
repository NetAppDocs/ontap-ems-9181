...
[.lead]
mlm.vmdisk events are reported when the system discovers a new virtual disk in a virtual machine (VM), and corrective actions typically involve following the documented corrective action guidance.
