...
[.lead]
air.vplus events are reported when an inconsistency is discovered inside an indexed storage tree, and corrective actions typically involve following the documented corrective action guidance.
