...
[.lead]
cpeer.xcm events are reported when address discovery fails for a peer cluster, and corrective actions typically involve verifying the reported configuration and health state.
