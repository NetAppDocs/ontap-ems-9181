...
[.lead]
fci.loop events are reported when the Fibre Channel loop generates too many loop initialization events, and corrective actions typically involve following the documented corrective action guidance.
