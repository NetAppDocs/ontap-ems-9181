...
[.lead]
nblade.vscanconnreqonsmb1 events are reported when this message occurs during a client attempt to establish a vscan connection over SMB1, which is not supported, and corrective actions typically involve verifying the reported configuration and health state.
