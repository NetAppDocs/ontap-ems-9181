...
[.lead]
Learn about nblade.vscanconnreqonsmb1 EMS events, which report when This message occurs during a client attempt to establish a vscan connection over SMB1, which is not supported.
