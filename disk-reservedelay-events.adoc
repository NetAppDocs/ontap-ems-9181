...
[.lead]
disk.reservedelay events are reported when a SCSI reservation command has a longer latency than expected during takeover, and corrective actions typically involve following the documented corrective action guidance.
