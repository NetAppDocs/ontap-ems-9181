...
[.lead]
callhome.nvmem events are reported when the sensor for the Non-Volatile memory (NVMEM) card lithium battery has an excessively high voltage, and corrective actions typically involve following the documented corrective action guidance.
