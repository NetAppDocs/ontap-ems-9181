...
[.lead]
Learn about snapmirror.sockstrreaderr EMS events, which report when This event is issued when SnapMirror attempts to read a large string from the socket.
