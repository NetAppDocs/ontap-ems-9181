...
[.lead]
scsiblade.vs events are reported when the local node fails to purge the SAN configuration cache for a Vserver, and corrective actions typically involve rebooting the node or cluster component.
