...
[.lead]
lic.lm events are reported when oNTAP(R) software is running in the capacity pools licensing model and there is no License Manager configuration available, and corrective actions typically involve following the documented corrective action guidance.
