...
[.lead]
Learn about lic.lm EMS events, which report when ONTAP(R) software is running in the capacity pools licensing model and there is no License Manager configuration available.
