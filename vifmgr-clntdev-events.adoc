...
[.lead]
vifmgr.clntdev events are reported when a remote device is removed from the cluster or storage network, and corrective actions typically involve following the documented corrective action guidance.
