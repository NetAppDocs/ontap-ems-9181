...
[.lead]
security.invalid events are reported when an attempt is made to access the system by using invalid authentication credentials, and corrective actions typically involve verifying the reported configuration and health state.
