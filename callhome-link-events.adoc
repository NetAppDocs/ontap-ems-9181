...
[.lead]
Learn about callhome.link EMS events, which report when a network port link state change cannot be confirmed for more than 5 minutes because another configuration task is still in progress.
