...
[.lead]
nblade.nfs4trunkmaxlimit events are reported when a session trunking group created by the NFSv41 client exceeds the maximum number of supported trunk connections, and corrective actions typically involve following the documented corrective action guidance.
