...
[.lead]
vserver.config events are reported when the Vserver create operation cannot create the Vserver-specific configuration directory, and corrective actions typically involve ensuring the required configuration and resources are in place.
