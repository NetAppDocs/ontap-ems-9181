...
[.lead]
net.cg events are reported when the current connection group experiences backpressure, and corrective actions typically involve following the documented corrective action guidance.
