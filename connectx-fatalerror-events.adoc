...
[.lead]
connectx.fatalerror events are reported when a fatal error is polled from the ConnectX(tm) InfiniBand(R) adapter, and corrective actions typically involve contacting NetApp technical support.
