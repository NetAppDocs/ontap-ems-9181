...
[.lead]
snapvault.dst events are reported when snapVault(R) creates a backup snapshot for a given backup schedule, and corrective actions typically involve following the documented corrective action guidance.
