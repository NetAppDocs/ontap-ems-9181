...
[.lead]
platform.nopartnerpresent events are reported when the HA partner's presence cannot be read via the GPIO ports on the controller, and corrective actions typically involve following the documented corrective action guidance.
