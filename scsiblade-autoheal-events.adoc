...
[.lead]
Learn about scsiblade.autoheal EMS events, which report when the node loses connectivity with the majority of the cluster and autoheal has been explicitly disabled by the user.
