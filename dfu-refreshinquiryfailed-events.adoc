...
[.lead]
Learn about dfu.refreshinquiryfailed EMS events, which report when This message occurs after a successful disk firmware update, when the 'SCSI inquiry' command, which is issued to all disks as part of the disk firmware download process, fails to finish.
