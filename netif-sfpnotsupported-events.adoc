...
[.lead]
netif.sfpnotsupported events are reported when the installed Small Form-factor Pluggable (SFP+ or QSFP+) module is not supported, and corrective actions typically involve following the documented corrective action guidance.
