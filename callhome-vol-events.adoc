...
[.lead]
callhome.vol events are reported when the system detects an inconsistent volume and takes it offline, and corrective actions typically involve following the documented corrective action guidance.
