...
[.lead]
mpt.busreg events are reported when physical disk bus registration fails in the message processing technology (MPT) adapter driver, and corrective actions typically involve checking the reported configuration and connectivity.
