...
[.lead]
lun.create events are reported when a LUN is created in a volume that is in the nvfailed state, and corrective actions typically involve following the documented corrective action guidance.
