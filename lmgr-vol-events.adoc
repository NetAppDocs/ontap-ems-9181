...
[.lead]
lmgr.vol events are reported when a volume cannot reclaim certain file locks when the system attempts to bring it online, and corrective actions typically involve following the documented corrective action guidance.
