...
[.lead]
tsse.scan events are reported when inactive data compression scan related information failed to be updated on the catalog file, and corrective actions typically involve following the documented corrective action guidance.
