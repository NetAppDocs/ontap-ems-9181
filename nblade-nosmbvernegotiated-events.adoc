...
[.lead]
Learn about nblade.nosmbvernegotiated EMS events, which report when Data ONTAP(R) does not support any of the SMB protocol versions sent by the client for negotiation.
