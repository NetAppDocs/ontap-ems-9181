...
[.lead]
nblade.nosmbvernegotiated events are reported when data ONTAP(R) does not support any of the SMB protocol versions sent by the client for negotiation, and corrective actions typically involve ensuring the required configuration and resources are in place.
