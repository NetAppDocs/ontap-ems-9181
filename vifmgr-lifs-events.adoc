...
[.lead]
vifmgr.lifs events are reported when the total number of logical interfaces (LIFs) exceeds the supported per-cluster limit, and corrective actions typically involve following the documented corrective action guidance.
