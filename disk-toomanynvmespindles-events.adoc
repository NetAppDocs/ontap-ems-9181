...
[.lead]
disk.toomanynvmespindles events are reported when data ONTAP(R) finds more NVMe disks present on a platform than the platform actually supports, and corrective actions typically involve following the documented corrective action guidance.
