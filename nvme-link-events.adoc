...
[.lead]
nvme.link events are reported when the NVMe driver disables the PCIe link due to excessive errors, and corrective actions typically involve following the documented corrective action guidance.
