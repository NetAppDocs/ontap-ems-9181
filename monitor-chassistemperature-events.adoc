...
[.lead]
monitor.chassistemperature events are reported when the chassis temperature is too cool, and corrective actions typically involve following the documented corrective action guidance.
