...
[.lead]
spm.pipd events are reported when the post-ingest processing daemon (pipd) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
