...
[.lead]
ses.fw events are reported when a firmware file is found to be empty during a disk shelf firmware update, and corrective actions typically involve following the documented corrective action guidance.
