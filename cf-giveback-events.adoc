...
[.lead]
cf.giveback events are reported when giveback of a partner node is delayed due to the cleanup of a previous giveback event, and corrective actions typically involve following the documented corrective action guidance.
