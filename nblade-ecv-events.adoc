...
[.lead]
nblade.ecv events are reported when oNTAP(R) software uses a default Effective Cluster Version (ECV) before the actual ECV has been conclusively determined, and corrective actions typically involve following the documented corrective action guidance.
