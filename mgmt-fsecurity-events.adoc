...
[.lead]
mgmt.fsecurity events are reported when applying configuration of fsecurity fails, and corrective actions typically involve following the documented corrective action guidance.
