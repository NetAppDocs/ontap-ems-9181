...
[.lead]
wafl.voltrans events are reported when a volume transition clears the noi2p option on a volume, and corrective actions typically involve following the documented corrective action guidance.
