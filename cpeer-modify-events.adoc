...
[.lead]
cpeer.modify events are reported when the address family for a peering relationship is modified, and corrective actions typically involve following the documented corrective action guidance.
