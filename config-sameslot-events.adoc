...
[.lead]
config.sameslot events are reported when a SAS disk is multipathed to host adapters in the same controller slot, and corrective actions typically involve following the documented corrective action guidance.
