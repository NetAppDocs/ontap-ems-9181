...
[.lead]
Learn about dfu.mallocfailed EMS events, which report when Data ONTAP(R) cannot allocate memory to read the disk firmware file and aborts the disk firmware update.
