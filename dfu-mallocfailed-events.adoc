...
[.lead]
dfu.mallocfailed events are reported when data ONTAP(R) cannot allocate memory to read the disk firmware file and aborts the disk firmware update, and corrective actions typically involve following the documented corrective action guidance.
