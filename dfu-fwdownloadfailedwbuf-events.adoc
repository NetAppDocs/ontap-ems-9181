...
[.lead]
Learn about dfu.fwdownloadfailedwbuf EMS events, which report when retries are exhausted on the write buffer command that is used to download firmware to a disk.
