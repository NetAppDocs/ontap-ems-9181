...
[.lead]
Learn about ha.noprogrammaticto EMS events, which report when a takeover is initiated programmatically by Data ONTAP(R) and the takeover request fails because giveback or aggregate relocation cleanup is still in progress.
