...
[.lead]
nis.server events are reported when the Storage Virtual Machine (SVM, formerly Vserver) binds to any of the configured NIS servers, and corrective actions typically involve following the documented corrective action guidance.
