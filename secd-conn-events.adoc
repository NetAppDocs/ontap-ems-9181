...
[.lead]
Learn about secd.conn EMS events, which report when the Vserver cannot establish a TCP/UDP connection to or be authenticated by an outside server such as NIS, LSA, LDAP and KDC.
