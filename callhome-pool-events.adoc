...
[.lead]
Learn about callhome.pool EMS events, which report when an aggregate does not comply with the current Capacity Pool entitlement, as determined by the Licensing Manager.
