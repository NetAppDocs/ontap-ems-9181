...
[.lead]
dfu.readtestfailedstatus events are reported when a read test failure occurs after a firmware download, and corrective actions typically involve following the documented corrective action guidance.
