...
[.lead]
callhome.bcom events are reported when multiple attempts to initialize the SAN Kernel Agent for a Vserver have failed, and corrective actions typically involve following the documented corrective action guidance.
