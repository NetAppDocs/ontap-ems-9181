...
[.lead]
monitor.rtchighpower events are reported when the real-time clock (RTC) battery voltage is above normal level, and corrective actions typically involve following the documented corrective action guidance.
