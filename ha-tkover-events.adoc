...
[.lead]
ha.tkover events are reported when a pending takeover is waiting for an in-progress aggregate relocation (ARL) operation to complete or abort before proceeding with the takeover, and corrective actions typically involve following the documented corrective action guidance.
