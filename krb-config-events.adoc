...
[.lead]
krb.config events are reported when the CIFS server's security settings could not be written to the configuration file on this node, and corrective actions typically involve following the documented corrective action guidance.
