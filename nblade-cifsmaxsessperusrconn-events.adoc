...
[.lead]
nblade.cifsmaxsessperusrconn events are reported when the number of sessions allowed per user over a TCP connection is exceeded, and corrective actions typically involve following the documented corrective action guidance.
