...
[.lead]
esh.element events are reported when the filer cannot communicate with the ESH module, and corrective actions typically involve checking the reported configuration and connectivity.
