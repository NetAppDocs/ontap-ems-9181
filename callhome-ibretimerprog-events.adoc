...
[.lead]
Learn about callhome.ibretimerprog EMS events, which report when InfiniBand (IB) retimer programming of the high- availability (HA) interconnect link failed after multiple retry attempts.
