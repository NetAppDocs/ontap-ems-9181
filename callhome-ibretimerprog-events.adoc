...
[.lead]
callhome.ibretimerprog events are reported when infiniBand (IB) retimer programming of the high- availability (HA) interconnect link failed after multiple retry attempts, and corrective actions typically involve following the documented corrective action guidance.
