...
[.lead]
kern.vm events are reported when an attempt to create a new mapping in the virtual address space of a process has failed, and corrective actions typically involve following the documented corrective action guidance.
