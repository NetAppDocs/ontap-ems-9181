...
[.lead]
sfu.download events are reported when a disk shelf firmware update completes download firmware to a disk shelf or shelves in the system, and corrective actions typically involve following the documented corrective action guidance.
