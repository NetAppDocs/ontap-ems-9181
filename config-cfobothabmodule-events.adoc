...
[.lead]
config.cfobothabmodule events are reported when a disk shelf in a node is cabled for multipathing and the configuration does not support it, and corrective actions typically involve following the documented corrective action guidance.
