...
[.lead]
vol.phys events are reported when the volume or aggregate is running dangerously low on free blocks to write to, and corrective actions typically involve following the documented corrective action guidance.
