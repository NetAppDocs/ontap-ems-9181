...
[.lead]
pcie.errors events are reported when correctable PCI Express errors are detected, and corrective actions typically involve following the documented corrective action guidance.
