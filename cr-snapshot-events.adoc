...
[.lead]
cr.snapshot events are reported when a temporary Snapshot(tm) copy created by the 'volume check' command could not be deleted, and corrective actions typically involve following the documented corrective action guidance.
