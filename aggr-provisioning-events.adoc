...
[.lead]
aggr.provisioning events are reported when this message is issued when the aggregate provisioning recommendation generated for the cluster is found to be incomplete due to the presence of unassigned disks, and corrective actions typically involve following the documented corrective action guidance.
