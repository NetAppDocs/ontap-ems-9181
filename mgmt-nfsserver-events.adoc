...
[.lead]
mgmt.nfsserver events are reported when a NFS server fails to be configured and, therefore, NFS access might not be available, and corrective actions typically involve checking the reported configuration and connectivity.
