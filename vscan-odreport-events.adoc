...
[.lead]
vscan.odreport events are reported when the On-Demand job fails to create report file, and corrective actions typically involve ensuring the required configuration and resources are in place.
