...
[.lead]
wafl.ondemand events are reported when data ONTAP(R) fails to reserve space for a file operation due to lack of space on the aggregate, and corrective actions typically involve following the documented corrective action guidance.
