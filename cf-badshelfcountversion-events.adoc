...
[.lead]
Learn about cf.badshelfcountversion EMS events, which report when This event occurs if we are sent a negotiated failover shelf count message with a version which we don't support.
