...
[.lead]
raid.partition events are reported when this message indicates a disk was successfully partitioned, and corrective actions typically involve following the documented corrective action guidance.
