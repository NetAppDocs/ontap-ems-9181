...
[.lead]
nblade.cifssametreepersess events are reported when the number of connections to the same share allowed per session is exceeded, and corrective actions typically involve following the documented corrective action guidance.
