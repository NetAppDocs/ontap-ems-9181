...
[.lead]
Learn about raid.olm EMS events, which report when a disk which is under online label maintenance(OLM) is prepared for ownership change by administrator forcibly.
