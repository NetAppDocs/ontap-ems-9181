...
[.lead]
raid.olm events are reported when a disk which is under online label maintenance(OLM) is prepared for ownership change by administrator forcibly, and corrective actions typically involve following the documented corrective action guidance.
