...
[.lead]
multi.dsk events are reported when multiple errors are detected during checksum verification, and the adapter is not taken offline or the "disk, and corrective actions typically involve contacting NetApp technical support.
