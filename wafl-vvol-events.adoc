...
[.lead]
wafl.vvol events are reported when an encrypted flexible volume is created, and corrective actions typically involve following the documented corrective action guidance.
