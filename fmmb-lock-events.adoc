...
[.lead]
fmmb.lock events are reported when this event is issued when a disk is removed from the HA mailbox disk lock set, and corrective actions typically involve following the documented corrective action guidance.
