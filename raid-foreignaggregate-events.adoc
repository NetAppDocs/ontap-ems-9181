...
[.lead]
Learn about raid.foreignaggregate EMS events, which report when the system changes the RAID tree ID of a foreign aggregate that is being brought online.
