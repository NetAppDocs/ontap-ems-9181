...
[.lead]
raid.foreignaggregate events are reported when the system changes the RAID tree ID of a foreign aggregate that is being brought online, and corrective actions typically involve following the documented corrective action guidance.
