...
[.lead]
cpeer.receiver events are reported when an incoming cluster peer request using the system-generated passphrase, and corrective actions typically involve verifying the reported configuration and health state.
