...
[.lead]
callhome.corefile events are reported when you invoke an AutoSupport for corefile upload, and corrective actions typically involve following the documented corrective action guidance.
