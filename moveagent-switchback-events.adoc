...
[.lead]
Learn about moveagent.switchback EMS events, which report when the volume move operation vetoes a MetroCluster(tm) switchback because the operations are mutually exclusive.
