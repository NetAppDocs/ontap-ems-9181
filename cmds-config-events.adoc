...
[.lead]
cmds.config events are reported when there is an error in deleting the specified file, and corrective actions typically involve following the documented corrective action guidance.
