...
[.lead]
cf.sysid events are reported when a node sends its system ID and its HA partner's system ID successfully across the HA interconnect, and corrective actions typically involve following the documented corrective action guidance.
