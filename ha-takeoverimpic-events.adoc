...
[.lead]
Learn about ha.takeoverimpic EMS events, which report when the partner node is down and the local node cannot perform a takeover due to interconnect errors.
