...
[.lead]
ha.takeoverimpic events are reported when the partner node is down and the local node cannot perform a takeover because of interconnect errors, and corrective actions typically involve verifying the reported configuration and health state.
