...
[.lead]
cam.dev events are reported when the disk does not support the Forced Unit Access (FUA) feature bit, and corrective actions typically involve following the documented corrective action guidance.
