...
[.lead]
wafl.repl events are reported when a replication operation receives a timestamp with an invalid nanoseconds portion, and clears it, and corrective actions typically involve following the documented corrective action guidance.
