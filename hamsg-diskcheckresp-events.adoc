...
[.lead]
hamsg.diskcheckresp events are reported when a node receives a disk inventory check response from its high-availability (HA) partner, and corrective actions typically involve following the documented corrective action guidance.
