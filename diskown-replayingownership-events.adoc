...
[.lead]
diskown.replayingownership events are reported when this event occurs during a boot or takeover when a disk ownership request is replayed from NVRAM, and corrective actions typically involve following the documented corrective action guidance.
