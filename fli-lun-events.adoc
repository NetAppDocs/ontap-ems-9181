...
[.lead]
fli.lun events are reported when a checkpoint record delete fails, and corrective actions typically involve following the documented corrective action guidance.
