...
[.lead]
migrate.root events are reported when the migration of a root aggregate has completed successfully, and corrective actions typically involve following the documented corrective action guidance.
