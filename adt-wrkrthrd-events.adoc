...
[.lead]
adt.wrkrthrd events are reported when audit initialization fails because the necessary execution threads cannot be created, and corrective actions typically involve restoring available system resources.
