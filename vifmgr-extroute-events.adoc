...
[.lead]
vifmgr.extroute events are reported when a new external route table is added successfully, and corrective actions typically involve following the documented corrective action guidance.
