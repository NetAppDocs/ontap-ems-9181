...
[.lead]
ktls.health events are reported when the depth of the action queue in the ktlsd subsystem is increasing in the majority of time intervals, and corrective actions typically involve following the documented corrective action guidance.
