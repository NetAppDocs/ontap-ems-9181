...
[.lead]
audit.cap events are reported when the system fails to generate an audit staging event as a part of the Central Access Policy (CAP) evaluation during access checks, and corrective actions typically involve following the documented corrective action guidance.
