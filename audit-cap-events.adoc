...
[.lead]
Learn about audit.cap EMS events, which report when the system fails to generate an audit staging event as a part of the Central Access Policy (CAP) evaluation during access checks.
