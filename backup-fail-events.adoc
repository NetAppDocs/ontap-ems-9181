...
[.lead]
backup.fail events are reported when this message occurs during a giveback operation, when there are active dump or restore processes running on root aggregates of the partner node, and corrective actions typically involve following the documented corrective action guidance.
