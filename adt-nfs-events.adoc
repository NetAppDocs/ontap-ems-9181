...
[.lead]
adt.nfs events are reported when this message occurs in the auditing subsytem, when the NFS root user is accessing the file without a valid CIFS credential, and corrective actions typically involve following the documented corrective action guidance.
