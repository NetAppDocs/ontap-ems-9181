...
[.lead]
Learn about adt.nfs EMS events, which report when This message occurs in the auditing subsytem, when the NFS root user is accessing the file without a valid CIFS credential.
