...
[.lead]
Learn about monitor.extcache EMS events, which report when the monitor detects the WAFL(R) external cache subsystem (FlexScale) has failed and is no longer available for use.
