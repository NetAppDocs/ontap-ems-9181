...
[.lead]
Learn about rdb.corruption EMS events, which report when the cluster management Data Replication Module determines that the node's local replica set is corrupted.
