...
[.lead]
xfcvi.attr events are reported when any of the xfcvi attributes changes, and corrective actions typically involve following the documented corrective action guidance.
