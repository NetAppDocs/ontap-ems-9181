...
[.lead]
spm.upgrademgr events are reported when the upgrade manager server (upgrademgr) involuntarily terminates, and corrective actions typically involve following the documented corrective action guidance.
