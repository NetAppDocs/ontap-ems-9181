...
[.lead]
mcc.forced events are reported when the node triggers a forced automatic unplanned switchover because the "allow-auto-forced-switchover" option is true, and corrective actions typically involve following the documented corrective action guidance.
