...
[.lead]
Learn about mcc.forced EMS events, which report when the node triggers a forced automatic unplanned switchover because the "allow-auto-forced-switchover" option is true.
