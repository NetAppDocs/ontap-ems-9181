...
[.lead]
disk.timeout events are reported when the disk driver stops flushing aggressive timeout I/Os, and corrective actions typically involve following the documented corrective action guidance.
