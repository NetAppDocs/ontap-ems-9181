...
[.lead]
rdma.rlib events are reported when the system fails to start the advertisement service for the high-availability (HA) interconnect, and corrective actions typically involve contacting NetApp technical support.
