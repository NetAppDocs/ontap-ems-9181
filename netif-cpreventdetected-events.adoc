...
[.lead]
netif.cpreventdetected events are reported when a CPR Event (core PCI resiliency) is detected, and corrective actions typically involve following the documented corrective action guidance.
