...
[.lead]
useradmin.name events are reported when an administrative name in the cluster is longer than the maximum allowed 255 characters, and corrective actions typically involve following the documented corrective action guidance.
