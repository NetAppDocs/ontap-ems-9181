...
[.lead]
netinet6.nd6 events are reported when the port MTU (Maximum Transmission Unit) is set to a smaller value than the IPv6 minimum MTU of 1280, and corrective actions typically involve following the documented corrective action guidance.
