...
[.lead]
Learn about netinet6.nd6 EMS events, which report when the port MTU (Maximum Transmission Unit) is set to a smaller value than the IPv6 minimum MTU of 1280.
