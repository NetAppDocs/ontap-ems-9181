...
[.lead]
snapmirror.migrate events are reported when this event is issued when a migrate completes successfully, and corrective actions typically involve following the documented corrective action guidance.
