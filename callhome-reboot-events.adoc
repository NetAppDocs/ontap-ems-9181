...
[.lead]
callhome.reboot events are reported when this message occurs after an appliance reboot--the appliance reports this event after the reboot is complete, and corrective actions typically involve following the documented corrective action guidance.
