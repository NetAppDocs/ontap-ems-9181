...
[.lead]
mgmt.keymgr events are reported when the system cannot delete the key ID associated with the encrypted aggregate from the key management server, and corrective actions typically involve following the documented corrective action guidance.
