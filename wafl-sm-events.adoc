...
[.lead]
wafl.sm events are reported when snapMirror(R) fails to read a block from the container file of a FlexVol(R) SnapMirror source volume, and corrective actions typically involve contacting NetApp technical support.
