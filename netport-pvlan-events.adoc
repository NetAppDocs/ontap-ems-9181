...
[.lead]
netport.pvlan events are reported when a pseudo-VLAN port has been created, and corrective actions typically involve following the documented corrective action guidance.
