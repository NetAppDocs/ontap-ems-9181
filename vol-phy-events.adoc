...
[.lead]
vol.phy events are reported when the volume is running dangerously low on free blocks to write to, and corrective actions typically involve following the documented corrective action guidance.
