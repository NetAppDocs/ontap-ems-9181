...
[.lead]
arl.aggrstart events are reported when relocation of a storage failover aggregate starts, and corrective actions typically involve following the documented corrective action guidance.
