...
[.lead]
cecc_log.masked events are reported when the ECC error logger stops reporting the occurrence of correctable ECC errors because the frequency of their occurrence is too high, and corrective actions typically involve following the documented corrective action guidance.
