...
[.lead]
scsiblade.tiered events are reported when a LUN is brought offline by Data ONTAP (R) because of too many consecutive failures to access object storage or no response from object storage, and corrective actions typically involve following the documented corrective action guidance.
