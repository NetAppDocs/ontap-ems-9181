...
[.lead]
vifmgr.portdown events are reported when a link down event was received on a network port, and corrective actions typically involve following the documented corrective action guidance.
