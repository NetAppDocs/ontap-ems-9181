...
[.lead]
cpeer.addr events are reported when a stable address for the peer cluster cannot be resolved because of a bad name-server, and corrective actions typically involve following the documented corrective action guidance.
