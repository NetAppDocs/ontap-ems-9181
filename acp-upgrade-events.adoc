...
[.lead]
acp.upgrade events are reported when the Alternate Control Path (ACP) Administrator determines that the ACP Processor has successfully upgraded the firmware, and corrective actions typically involve following the documented corrective action guidance.
