...
[.lead]
Learn about acp.upgrade EMS events, which report when the Alternate Control Path (ACP) Administrator determines that the ACP Processor has successfully upgraded the firmware.
