...
[.lead]
callhome.vdom events are reported when the virtual disk infrastructure (vdom) unsuccessfully reconciles the Out Of Volume Container (OOVC) and the Vdisk Table Of Contents (VTOC), and corrective actions typically involve following the documented corrective action guidance.
