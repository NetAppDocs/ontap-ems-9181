...
[.lead]
Learn about callhome.vdom EMS events, which report when the virtual disk infrastructure (vdom) unsuccessfully reconciles the Out Of Volume Container (OOVC) and the Vdisk Table Of Contents (VTOC).
