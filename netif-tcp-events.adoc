...
[.lead]
netif.tcp events are reported when a bad checksum is detected in the incoming TCP packets, and corrective actions typically involve following the documented corrective action guidance.
