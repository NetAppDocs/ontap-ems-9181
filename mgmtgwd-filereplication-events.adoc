...
[.lead]
mgmtgwd.filereplication events are reported when the startup scan of the file replication publishing root directory fails to verify packages, and corrective actions typically involve contacting NetApp technical support.
