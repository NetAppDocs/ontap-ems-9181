...
[.lead]
perfstatd.disk events are reported when the perfstat daemon (perfstatd) startup fails due to a full disk, and corrective actions typically involve verifying the reported configuration and health state.
