...
[.lead]
netif.fwupdatefailed events are reported when there is an error during a network interface firmware update, and corrective actions typically involve following the documented corrective action guidance.
