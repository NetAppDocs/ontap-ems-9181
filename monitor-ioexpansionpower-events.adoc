...
[.lead]
monitor.ioexpansionpower events are reported when power on the I/O expansion module is degraded, and corrective actions typically involve following the documented corrective action guidance.
