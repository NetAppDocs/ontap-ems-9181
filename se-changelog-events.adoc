...
[.lead]
se.changelog events are reported when single Instance Storage (SIS) change logging metafile is full during migration workflow through Snapmirror, and corrective actions typically involve following the documented corrective action guidance.
