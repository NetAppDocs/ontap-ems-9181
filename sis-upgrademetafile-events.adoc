...
[.lead]
sis.upgrademetafile events are reported when single Instance Storage (SIS) metafiles cannot be created during a Data ONTAP(R) upgrade, and corrective actions typically involve following the documented corrective action guidance.
