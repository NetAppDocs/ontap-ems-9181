...
[.lead]
mgmtgwd.volcreatedrestricted events are reported when a volume is created in the restricted state, and corrective actions typically involve following the documented corrective action guidance.
