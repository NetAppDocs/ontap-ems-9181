...
[.lead]
air.qtm events are reported when the state of a scanner used to rebuild the qtree metafile changes, and corrective actions typically involve following the documented corrective action guidance.
