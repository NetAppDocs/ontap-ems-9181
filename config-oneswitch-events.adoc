...
[.lead]
config.oneswitch events are reported when the disk is only connected to one switch, and corrective actions typically involve following the documented corrective action guidance.
