...
[.lead]
Learn about wafliron.summary EMS events, which report when This message occurs periodically when wafliron is running and its state is "starting" or "scanning".
