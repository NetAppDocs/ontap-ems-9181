...
[.lead]
nblade.exportaccesschkfailed events are reported when the network blade denies access to an exported share when a connection attempt violates an export policy, and corrective actions typically involve ensuring the required configuration and resources are in place.
