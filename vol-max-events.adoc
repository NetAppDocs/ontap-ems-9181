...
[.lead]
Learn about vol.max EMS events, which report when This message occurs as a reminder that the maximum volume size limit is increased from the default value defined in the Platform Specific Module (PSM) table.
