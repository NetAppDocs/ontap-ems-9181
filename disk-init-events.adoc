...
[.lead]
disk.init events are reported when a disk reports a sector size that does not match the drive qualification table, and corrective actions typically involve following the documented corrective action guidance.
