...
[.lead]
rlib.remote events are reported when this event is generated to print information about remote node such as IP address and sysid along with the event that occurred, and corrective actions typically involve following the documented corrective action guidance.
