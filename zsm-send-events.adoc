...
[.lead]
Learn about zsm.send EMS events, which report when a socket timeout occurs on an intracluster Manage ONTAP(R) API request to an internal ONTAPI(R) server.
