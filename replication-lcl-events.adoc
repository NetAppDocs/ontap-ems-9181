...
[.lead]
replication.lcl events are reported when a SnapMirror(R) or SnapVault(R) transfer is started on a system without a host name, and corrective actions typically involve following the documented corrective action guidance.
