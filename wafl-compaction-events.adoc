...
[.lead]
wafl.compaction events are reported when the aggregates compaction CP value is changed, and corrective actions typically involve following the documented corrective action guidance.
