...
[.lead]
raid.sp events are reported when one or more aggregate's capacity is not increased as part of the storage pool add job, and corrective actions typically involve following the documented corrective action guidance.
