...
[.lead]
vifmgr.bcastdomain events are reported when a network port is added to a broadcast domain, and corrective actions typically involve following the documented corrective action guidance.
