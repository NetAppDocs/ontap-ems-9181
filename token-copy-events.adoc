...
[.lead]
token.copy events are reported when a 'copy complete' request fails to free the reference on a remote node, and corrective actions typically involve following the documented corrective action guidance.
