...
[.lead]
wafl.access events are reported when the user attempts to access a fenced file, and corrective actions typically involve following the documented corrective action guidance.
