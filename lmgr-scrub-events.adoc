...
[.lead]
lmgr.scrub events are reported when the internal scrubbing of Remote Lock Entry Metafile (RLEM) fails due to insufficient storage space, and corrective actions typically involve following the documented corrective action guidance.
