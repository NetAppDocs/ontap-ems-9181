...
[.lead]
nblade.cifswitnessfonotify events are reported when the Witness system has requested its CIFS clients to move their Continuously Available connections to the local node, due to a failure of the partner node, and corrective actions typically involve following the documented corrective action guidance.
