...
[.lead]
Learn about nblade.cifswitnessfonotify EMS events, which report when the Witness system has requested its CIFS clients to move their Continuously Available connections to the local node, due to a failure of the partner node.
