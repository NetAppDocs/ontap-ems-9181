...
[.lead]
raid.flexvol events are reported when a configuration operation on an aggregate (for example, adding disks, relocating aggregate disks, etc, and corrective actions typically involve following the documented corrective action guidance.
