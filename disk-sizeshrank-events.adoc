...
[.lead]
disk.sizeshrank events are reported when the controller detects a decrease in the capacity of a virtual disk, and corrective actions typically involve following the documented corrective action guidance.
