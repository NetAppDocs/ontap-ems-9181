...
[.lead]
callhome.cpu events are reported when a CPU fan failed or the fan is spinning too slowly or too fast, and corrective actions typically involve following the documented corrective action guidance.
