...
[.lead]
hashd.maxstore events are reported when the size of hashes in the hash store is greater than the maximum size configured, and corrective actions typically involve following the documented corrective action guidance.
