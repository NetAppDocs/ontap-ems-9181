...
[.lead]
config.habadremote events are reported when a remote host adapter is connected to the wrong switch bank, and corrective actions typically involve following the documented corrective action guidance.
