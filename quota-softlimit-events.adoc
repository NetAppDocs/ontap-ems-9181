...
[.lead]
quota.softlimit events are reported when a user exceeds the soft quota limit (file and/or block limit), and corrective actions typically involve following the documented corrective action guidance.
