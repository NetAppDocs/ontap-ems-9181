...
[.lead]
scsitarget.fcp events are reported when a small form-factor pluggable (SFP) is inserted into the Fibre Channel (FC) target adapter, and corrective actions typically involve following the documented corrective action guidance.
