...
[.lead]
license.ontapi events are reported when oNTAPI enablement evaluation license is installed successfully, and corrective actions typically involve contacting NetApp technical support.
