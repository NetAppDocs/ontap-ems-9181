...
[.lead]
Learn about diskown.generated EMS events, which report when the software disk ownership module notifies other layers that it has completed the process of updating its view of the disks attached to the system.
