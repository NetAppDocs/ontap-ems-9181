...
[.lead]
callhome.bridge events are reported when a bridge reboots unexpectedly, and corrective actions typically involve following the documented corrective action guidance.
