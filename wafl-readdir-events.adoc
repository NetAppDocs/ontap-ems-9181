...
[.lead]
wafl.readdir events are reported when a READDIR file operation has exceeded the timeout that it is allowed to run in WAFL, and corrective actions typically involve following the documented corrective action guidance.
