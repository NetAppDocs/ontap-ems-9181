...
[.lead]
Learn about wackiron.panic EMS events, which report when the bootarg 'wackiron_enforce_panic' will cause the system to panic after the next boot if you do not run wafliron on the affected volume before the completion of the next boot.
