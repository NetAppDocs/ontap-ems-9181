...
[.lead]
Learn about nblade.fpolpassthrudisconn EMS events, which report when the pass-through read channel between the node and the FPolicy server is disconnected.
