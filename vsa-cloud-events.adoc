...
[.lead]
vsa.cloud events are reported when cluster LIF route update succeeds upon node switchover, and corrective actions typically involve following the documented corrective action guidance.
