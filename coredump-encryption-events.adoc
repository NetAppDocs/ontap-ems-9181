...
[.lead]
coredump.encryption events are reported when encryption is configured on the controller, but the coredump subsystem cannot encrypt data, and corrective actions typically involve following the documented corrective action guidance.
