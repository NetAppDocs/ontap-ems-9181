...
[.lead]
Learn about nblade.fpolpassthruonsmb1 EMS events, which report when This message occurs during a client attempt to establish an FPolicy pass-through read channel over SMB1, which is not supported.
