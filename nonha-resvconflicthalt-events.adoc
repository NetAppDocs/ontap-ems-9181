...
[.lead]
nonha.resvconflicthalt events are reported when the controller halts itself after it finds disk with reservation conflicts, and corrective actions typically involve contacting NetApp technical support.
