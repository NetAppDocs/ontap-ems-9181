...
[.lead]
callhome.fc events are reported when a Fibre Channel arbitrated loop (FC-AL) has link failures, and corrective actions typically involve checking the reported configuration and connectivity.
