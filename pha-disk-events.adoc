...
[.lead]
pha.disk events are reported when the backing disk type for an existing disk was changed from the cloud API, and corrective actions typically involve checking the reported configuration and connectivity.
