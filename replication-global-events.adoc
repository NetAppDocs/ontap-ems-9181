...
[.lead]
Learn about replication.global EMS events, which report when This event is issued when the request to change/set the throttling value for a replication association is failed.
