...
[.lead]
callhome.sblade events are reported when lUN import cannot resume after takeover/giveback, and corrective actions typically involve contacting NetApp technical support.
