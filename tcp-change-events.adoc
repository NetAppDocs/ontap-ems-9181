...
[.lead]
tcp.change events are reported when an attempt to change the TCP congestion control algorithm fails, and corrective actions typically involve checking the reported configuration and connectivity.
