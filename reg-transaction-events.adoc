...
[.lead]
reg.transaction events are reported when oNTAP(R) cannot commit a registry transaction, and corrective actions typically involve checking the reported configuration and connectivity.
