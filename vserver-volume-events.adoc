...
[.lead]
Learn about vserver.volume EMS events, which report when a volume is placed on nonhomogeneous aggregates, due to errors on homogeneous aggregates, such as max volumes is reached or aggregate is not home.
