...
[.lead]
ha.localnodeshutdown events are reported when shutdown of the local node is initiated, and corrective actions typically involve following the documented corrective action guidance.
