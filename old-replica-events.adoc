...
[.lead]
Learn about old.replica EMS events, which report when a wafliron operation determines that a volume served as a SnapMirror(R) destination for a previous release of Data ONTAP(R).
