...
[.lead]
old.replica events are reported when a wafliron operation determines that a volume served as a SnapMirror(R) destination for a previous release of Data ONTAP(R), and corrective actions typically involve following the documented corrective action guidance.
