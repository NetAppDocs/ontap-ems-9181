...
[.lead]
Learn about mgmtgwd.replace EMS events, which report when the temporary node management LIF, which is normally deleted automatically, has not been replaced.
