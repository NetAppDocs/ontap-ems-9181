...
[.lead]
mgmtgwd.replace events are reported when the temporary node management LIF, which is normally deleted automatically, has not been replaced, and corrective actions typically involve following the documented corrective action guidance.
