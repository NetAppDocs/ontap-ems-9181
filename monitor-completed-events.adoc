...
[.lead]
Learn about monitor.completed EMS events, which report when wafliron in the optional commit mode has finished on the aggregate but changes have not been committed or rejected.
