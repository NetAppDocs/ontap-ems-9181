...
[.lead]
wafl.failed events are reported when the ONTAP(R) kernel cannot mount a volume because of file system inconsistency, and corrective actions typically involve contacting NetApp technical support.
