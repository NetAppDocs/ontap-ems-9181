...
[.lead]
lun.metadb events are reported when a version mismatch is detected for the metafile containing LUN metadata, and corrective actions typically involve following the documented corrective action guidance.
