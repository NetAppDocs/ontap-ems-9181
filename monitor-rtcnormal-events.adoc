...
[.lead]
monitor.rtcnormal events are reported when the real-time clock (RTC) battery voltage is normal, and corrective actions typically involve following the documented corrective action guidance.
