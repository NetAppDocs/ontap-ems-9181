...
[.lead]
Learn about disk.rewritedatafailed EMS events, which report when the system encounters an error and cannot rewrite data that was difficult to read on ATA drives.
