...
[.lead]
Learn about moveagent.commitdst EMS events, which report when a 'volume move' operation finishes moving the volume to the destination but fails to update the appropriate information on the destination.
