...
[.lead]
monitor.chassisfanfail events are reported when multiple chassis fans have failed, and the system will shut down in a few minutes unless corrected, and corrective actions typically involve following the documented corrective action guidance.
