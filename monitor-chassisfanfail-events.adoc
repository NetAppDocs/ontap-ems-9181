...
[.lead]
Learn about monitor.chassisfanfail EMS events, which report when multiple chassis fans have failed, and the system will shut down in a few minutes unless corrected.
