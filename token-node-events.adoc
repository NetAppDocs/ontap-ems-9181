...
[.lead]
token.node events are reported when the maximum number of tokens per node is reached, and corrective actions typically involve following the documented corrective action guidance.
