...
[.lead]
license.check events are reported when the license checker determines that the Base license has expired, and corrective actions typically involve following the documented corrective action guidance.
