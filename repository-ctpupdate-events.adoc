...
[.lead]
repository.ctpupdate events are reported when an update to the Create Time Placement (CTP) ruleset fails, and corrective actions typically involve following the documented corrective action guidance.
