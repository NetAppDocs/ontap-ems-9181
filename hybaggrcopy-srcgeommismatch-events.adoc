...
[.lead]
hybaggrcopy.srcgeommismatch events are reported when an aggregate cannot be copied, and corrective actions typically involve verifying the reported configuration and health state.
