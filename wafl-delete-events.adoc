...
[.lead]
wafl.delete events are reported when the system encounters a lost indirect block while deleting a file, and corrective actions typically involve following the documented corrective action guidance.
