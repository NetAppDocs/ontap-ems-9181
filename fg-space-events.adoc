...
[.lead]
fg.space events are reported when conditions that led to previous "fg, and corrective actions typically involve following the documented corrective action guidance.
