...
[.lead]
sv.vfiler events are reported when movement of SnapVault(R) configuration from 'from' vFiler to 'to' vFiler fails, and corrective actions typically involve following the documented corrective action guidance.
