...
[.lead]
se.gatherer events are reported when single Instance Storage (SIS) auto gathering scanner completed on the auto adaptive volume, and corrective actions typically involve following the documented corrective action guidance.
