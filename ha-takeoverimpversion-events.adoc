...
[.lead]
Learn about ha.takeoverimpversion EMS events, which report when the partner node is down; however, due to a version mismatch, it is currently impossible to perform a takeover.
