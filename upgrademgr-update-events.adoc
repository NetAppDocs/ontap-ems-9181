...
[.lead]
upgrademgr.update events are reported when the automated update of the cluster is canceled by the operator, and corrective actions typically involve following the documented corrective action guidance.
