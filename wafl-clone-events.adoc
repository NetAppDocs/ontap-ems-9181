...
[.lead]
wafl.clone events are reported when this message alerts about invalid inherited counters for the clone flexible volume, and corrective actions typically involve following the documented corrective action guidance.
