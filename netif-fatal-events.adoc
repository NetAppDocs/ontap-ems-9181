...
[.lead]
netif.fatal events are reported when the network device's driver encounters an error from which it cannot recover, and corrective actions typically involve following the documented corrective action guidance.
