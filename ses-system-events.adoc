...
[.lead]
ses.system events are reported when oNTAP(R) software does not support internal disk drives in this platform, and corrective actions typically involve checking the reported configuration and connectivity.
