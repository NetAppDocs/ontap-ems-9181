...
[.lead]
Learn about wafl.transition EMS events, which report when This message occurs at the completion of a WAFL(R) consistency point (CP) that occurs during a failover transition, such as takeover or giveback.
