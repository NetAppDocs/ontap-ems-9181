...
[.lead]
wafl.transition events are reported when this message occurs at the completion of a WAFL(R) consistency point (CP) that occurs during a failover transition, such as takeover or giveback, and corrective actions typically involve following the documented corrective action guidance.
