...
[.lead]
cifs.static events are reported when a user creates a static home directory without a substitution value (%u or %w) to uniquely identify a home directory share, and corrective actions typically involve ensuring the required configuration and resources are in place.
