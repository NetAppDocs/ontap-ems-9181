...
[.lead]
Learn about cifs.static EMS events, which report when a user creates a static home directory without a substitution value (%u or %w) to uniquely identify a home directory share.
