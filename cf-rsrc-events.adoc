...
[.lead]
cf.rsrc events are reported when a failure is detected during giveback, and corrective actions typically involve checking the reported configuration and connectivity.
