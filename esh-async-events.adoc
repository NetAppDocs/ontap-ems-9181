...
[.lead]
esh.async events are reported when there is an error allocating memory for an asynchronous message during disk shelf discovery processing, and corrective actions typically involve following the documented corrective action guidance.
