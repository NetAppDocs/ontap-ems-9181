...
[.lead]
fg.statechange events are reported when the FlexGroup has transitioned from one state to another, and corrective actions typically involve following the documented corrective action guidance.
