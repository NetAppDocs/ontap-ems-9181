...
[.lead]
fabricpool.lost events are reported when oNTAP has lost contact with the Service Control Unit used with cloud subscription licenses, and corrective actions typically involve ensuring the required configuration and resources are in place.
