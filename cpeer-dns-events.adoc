...
[.lead]
cpeer.dns events are reported when an attempt is made to resolve and insert a stable address that is a Domain Name System (DNS) style host name, and corrective actions typically involve following the documented corrective action guidance.
