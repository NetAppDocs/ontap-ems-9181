...
[.lead]
Learn about cpeer.dns EMS events, which report when an attempt is made to resolve and insert a stable address that is a Domain Name System (DNS) style host name.
