...
[.lead]
Learn about nblade.cifsnonaesnibytesproc EMS events, which report when a system with CPUs that do not support the AES-NI instruction set is performing SMB3 encryption or signing of a large amount of data.
