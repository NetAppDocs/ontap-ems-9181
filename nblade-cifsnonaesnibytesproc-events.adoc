...
[.lead]
nblade.cifsnonaesnibytesproc events are reported when a system with CPUs that do not support the AES-NI instruction set is performing SMB3 encryption or signing of a large amount of data, and corrective actions typically involve following the documented corrective action guidance.
