...
[.lead]
Learn about wafl.spcmgmt EMS events, which report when a space management strategy or an autosize grow threshold for a volume is being configured and the autogrow or autodelete thresholds conflict with the space-mgmt-try-first policy.
