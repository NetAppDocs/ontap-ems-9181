...
[.lead]
lun.online events are reported when a LUN is brought online manually, and corrective actions typically involve following the documented corrective action guidance.
