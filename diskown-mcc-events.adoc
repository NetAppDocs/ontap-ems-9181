...
[.lead]
diskown.mcc events are reported when the number of drives assigned in the MetroCluster(tm) configuration exceeds the supported limit, and corrective actions typically involve following the documented corrective action guidance.
