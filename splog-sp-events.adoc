...
[.lead]
splog.sp events are reported when the local or remote node Service Processor (SP) cannot be accessed, and corrective actions typically involve following the documented corrective action guidance.
