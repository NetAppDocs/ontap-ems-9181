...
[.lead]
Learn about snapmirror.unsupportedchksumtype EMS events, which report when checksum type crc32c_header_only is configured for a SnapMirror(R) relationship and the source for the relationship is not compatible with this checksum type.
