...
[.lead]
bucket.snapshot events are reported when the object server completes a snapshot restore operation, and corrective actions typically involve following the documented corrective action guidance.
