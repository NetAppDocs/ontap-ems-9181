...
[.lead]
netif.uncoreccerror events are reported when the network interface controller reports an unrecoverable ECC error, and corrective actions typically involve rebooting the node or cluster component.
