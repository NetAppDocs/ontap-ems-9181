...
[.lead]
nameserv.config events are reported when a file write for name service configuration fails, and corrective actions typically involve following the documented corrective action guidance.
