...
[.lead]
flexcache.origincleanup events are reported when the origin of a FlexCache(R) volume cleanup job fails to clean up the origin volume, and corrective actions typically involve following the documented corrective action guidance.
