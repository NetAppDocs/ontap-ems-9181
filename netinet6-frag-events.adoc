...
[.lead]
netinet6.frag events are reported when the incoming fragment overlaps some of the existing previous fragment in the reassembly queue, and corrective actions typically involve following the documented corrective action guidance.
