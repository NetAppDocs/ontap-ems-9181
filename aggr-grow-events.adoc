...
[.lead]
aggr.grow events are reported when request to grow an aggregate is completed successfully, and corrective actions typically involve following the documented corrective action guidance.
