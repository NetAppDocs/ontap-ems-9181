...
[.lead]
wafl.snaplock events are reported when the snaplock scan has completed, and corrective actions typically involve following the documented corrective action guidance.
