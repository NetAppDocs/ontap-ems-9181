...
[.lead]
mcc.check events are reported when the MetroCluster (tm) check job has failed to complete all checks for the system, and corrective actions typically involve following the documented corrective action guidance.
