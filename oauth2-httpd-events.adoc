...
[.lead]
oauth2.httpd events are reported when the httpd process fails to restart when the OAuth 2, and corrective actions typically involve contacting NetApp technical support.
