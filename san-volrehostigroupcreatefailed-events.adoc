...
[.lead]
san.volrehostigroupcreatefailed events are reported when this message occurs on clustered Data ONTAP(R) systems, during Volume Rehost operation when Data ONTAP fails to create igroup on the destination Vserver, and corrective actions typically involve following the documented corrective action guidance.
