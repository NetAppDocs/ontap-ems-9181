...
[.lead]
Learn about san.volrehostigroupcreatefailed EMS events, which report when This message occurs on clustered Data ONTAP(R) systems, during Volume Rehost operation when Data ONTAP fails to create igroup on the destination Vserver.
