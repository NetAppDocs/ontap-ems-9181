...
[.lead]
Learn about ctran.net EMS events, which report when the Cluster Transaction Manager (CTRAN) on the local node is unable to reach a peer node that it believes is in CLAM quorum.
