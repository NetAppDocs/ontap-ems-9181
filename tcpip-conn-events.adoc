...
[.lead]
tcpip.conn events are reported when a connection is leaked because it can't be closed, and corrective actions typically involve following the documented corrective action guidance.
