...
[.lead]
api.fileio events are reported when this message occurs after a file I/O error that typically causes a Data ONTAP(R) API to fail, and corrective actions typically involve following the documented corrective action guidance.
