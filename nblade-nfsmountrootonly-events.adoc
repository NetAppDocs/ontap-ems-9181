...
[.lead]
Learn about nblade.nfsmountrootonly EMS events, which report when a non-root user performs MOUNT or NFS operation when the respective options '-mount-rootonly' or 'nfs-rootonly' are enabled.
