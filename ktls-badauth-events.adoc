...
[.lead]
ktls.badauth events are reported when the system receives a TLS message with bad 'authentication' data, and corrective actions typically involve following the documented corrective action guidance.
