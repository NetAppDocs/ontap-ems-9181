...
[.lead]
lmgr.persistent events are reported when this message is triggered when the persistent open lock count for a single file reaches its maximum supported limit, and corrective actions typically involve following the documented corrective action guidance.
