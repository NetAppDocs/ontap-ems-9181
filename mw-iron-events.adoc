...
[.lead]
mw.iron events are reported when this message is used to notify idlog purge at mount after 7 consecutive unsuccessful iron runs, and corrective actions typically involve following the documented corrective action guidance.
