...
[.lead]
Learn about diskown.uprevversion EMS events, which report when disk ownership information has been read and found to be from a version that is higher (newer) than what the current version of Data ONTAP understands.
