...
[.lead]
Learn about usb.port EMS events, which report when the Data ONTAP(R) universal serial bus (USB) adapter driver detects an unrecoverable error on the associated port.
