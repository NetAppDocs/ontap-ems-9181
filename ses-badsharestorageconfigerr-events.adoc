...
[.lead]
Learn about ses.badsharestorageconfigerr EMS events, which report when a disk shelf module that is not supported in a Shared Storage system, such as an LRC module, is detected in a Shared Storage system.
