...
[.lead]
dfu.init events are reported when the disk firmware update initialization routine cannot allocate memory, and corrective actions typically involve following the documented corrective action guidance.
