...
[.lead]
wafl.br events are reported when this event is issued if block reallocation has not been performed on an aggregate but a reallocated block was found that subsequently needs to be redirected, and corrective actions typically involve following the documented corrective action guidance.
