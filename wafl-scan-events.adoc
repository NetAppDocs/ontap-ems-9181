...
[.lead]
wafl.scan events are reported when the system is aborting the WORM clear scan because there is no space available in the volume, and corrective actions typically involve following the documented corrective action guidance.
