...
[.lead]
cf.rv events are reported when an HA connection agent connects on an HA interconnect device, and corrective actions typically involve following the documented corrective action guidance.
