...
[.lead]
disk.healthtrigger events are reported when the disk returns a health trigger event, and corrective actions typically involve following the documented corrective action guidance.
