...
[.lead]
callhome.andu events are reported when the automated update of the cluster has been completed, and corrective actions typically involve following the documented corrective action guidance.
