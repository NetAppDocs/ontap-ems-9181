...
[.lead]
xfcvi.disabled events are reported when the HA interconnect card is disabled by the ic-type environment variable, and corrective actions typically involve following the documented corrective action guidance.
