...
[.lead]
diskown.raid events are reported when a disk assign or disk remove ownership request is rejected at the RAID layer, and corrective actions typically involve following the documented corrective action guidance.
