...
[.lead]
mcc.drdom events are reported when disk ownership changes are made by the disaster recovery disk ownership manager (DRDOM), and corrective actions typically involve following the documented corrective action guidance.
