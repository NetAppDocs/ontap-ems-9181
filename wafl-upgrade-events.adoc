...
[.lead]
Learn about wafl.upgrade EMS events, which report when This event is issued during an upgrade where the system need to use the active filesystem inofile.
