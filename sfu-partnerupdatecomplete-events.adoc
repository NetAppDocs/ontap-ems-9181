...
[.lead]
Learn about sfu.partnerupdatecomplete EMS events, which report when This message occurs in a high-availability (HA) configuration in which an HA partner was downloading disk shelf firmware and the download was completed, at which point this notification is sent and enclosure services are resumed by the partner.
