...
[.lead]
spm.ypbind events are reported when the NIS client binding daemon 'ypbind' involuntarily exits, and corrective actions typically involve following the documented corrective action guidance.
