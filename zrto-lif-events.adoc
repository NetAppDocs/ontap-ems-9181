...
[.lead]
zrto.lif events are reported when oNTAP(R) fails to re-create a previously deleted LIF during an upgrade, and corrective actions typically involve following the documented corrective action guidance.
