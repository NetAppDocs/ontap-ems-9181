...
[.lead]
snmp.link events are reported when a network interface is down, and corrective actions typically involve following the documented corrective action guidance.
