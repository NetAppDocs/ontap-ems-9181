...
[.lead]
netinet.ethr events are reported when a high arrival rate of address resolution protocol (ARP) frames has been detected (possible ARP storm), and corrective actions typically involve following the documented corrective action guidance.
