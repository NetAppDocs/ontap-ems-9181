...
[.lead]
lsm.rangedelete events are reported when a block store encounters an error while performing a range delete operation, and corrective actions typically involve following the documented corrective action guidance.
