...
[.lead]
wafl.gs events are reported when wafl is unsuccessful to check and load Granular Set metafile for the volume, and corrective actions typically involve following the documented corrective action guidance.
