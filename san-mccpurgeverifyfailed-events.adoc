...
[.lead]
Learn about san.mccpurgeverifyfailed EMS events, which report when This message occurs in MetroCluster(TM) configurations on clustered Data ONTAP(R) systems when a SAN cache purge verify operation fails.
